...
__export(index_exports, {
  ...
  ArrowBindingHintOverlayUtil: () => import_ArrowBindingHintOverlayUtil.ArrowBindingHintOverlayUtil,
  ...
  ArrowHintOverlayUtil: () => import_ArrowHintOverlayUtil.ArrowHintOverlayUtil,
  ...
  BookmarkAssetUtil: () => import_BookmarkAssetUtil.BookmarkAssetUtil,
  BookmarkShapeUtil: () => import_BookmarkShapeUtil.BookmarkShapeUtil,
  BreakPointProvider: () => import_breakpoints.BreakPointProvider,
  BrushOverlayUtil: () => import_BrushOverlayUtil.BrushOverlayUtil,
  ...
  CollaboratorBrushOverlayUtil: () => import_CollaboratorBrushOverlayUtil.CollaboratorBrushOverlayUtil,
  CollaboratorCursorOverlayUtil: () => import_CollaboratorCursorOverlayUtil.CollaboratorCursorOverlayUtil,
  CollaboratorHintOverlayUtil: () => import_CollaboratorHintOverlayUtil.CollaboratorHintOverlayUtil,
  CollaboratorScribbleOverlayUtil: () => import_CollaboratorScribbleOverlayUtil.CollaboratorScribbleOverlayUtil,
  CollaboratorShapeIndicatorOverlayUtil: () => import_CollaboratorShapeIndicatorOverlayUtil.CollaboratorShapeIndicatorOverlayUtil,
  ColorSchemeMenu: () => import_ColorSchemeMenu.ColorSchemeMenu,
  CommentToolbarItem: () => import_DefaultToolbarContent.CommentToolbarItem,
  ...
  DefaultPeopleMenu: () => import_DefaultPeopleMenu.DefaultPeopleMenu,
  DefaultPeopleMenuAvatar: () => import_DefaultPeopleMenuAvatar.DefaultPeopleMenuAvatar,
  DefaultPeopleMenuContent: () => import_DefaultPeopleMenuContent.DefaultPeopleMenuContent,
  DefaultPeopleMenuFacePile: () => import_DefaultPeopleMenuFacePile.DefaultPeopleMenuFacePile,
  DefaultPeopleMenuItem: () => import_DefaultPeopleMenuItem.DefaultPeopleMenuItem,
  ...
  DefaultUserPresenceEditor: () => import_DefaultUserPresenceEditor.DefaultUserPresenceEditor,
  ...
  ExportAsMenuGroup: () => import_menu_items.ExportAsMenuGroup,
  ...
  ImageAssetUtil: () => import_ImageAssetUtil.ImageAssetUtil,
  ImageShapeUtil: () => import_ImageShapeUtil.ImageShapeUtil,
  InputModeMenu: () => import_InputModeMenu.InputModeMenu,
  ...
  PeopleMenu: () => import_DefaultPeopleMenu.DefaultPeopleMenu,
  ...
  RTL_LANGUAGES: () => import_translations.RTL_LANGUAGES,
  ...
  ScribbleOverlayUtil: () => import_ScribbleOverlayUtil.ScribbleOverlayUtil,
  ...
  SelectionForegroundOverlayUtil: () => import_SelectionForegroundOverlayUtil.SelectionForegroundOverlayUtil,
  ShapeHandleOverlayUtil: () => import_ShapeHandleOverlayUtil.ShapeHandleOverlayUtil,
  ShapeIndicatorOverlayUtil: () => import_ShapeIndicatorOverlayUtil.ShapeIndicatorOverlayUtil,
  SnapIndicatorOverlayUtil: () => import_SnapIndicatorOverlayUtil.SnapIndicatorOverlayUtil,
  ...
  VideoAssetUtil: () => import_VideoAssetUtil.VideoAssetUtil,
  ...
  ZoomBrushOverlayUtil: () => import_ZoomBrushOverlayUtil.ZoomBrushOverlayUtil,
  ...
  defaultAssetUtils: () => import_defaultAssetUtils.defaultAssetUtils,
  ...
  defaultGeoTypeDefinitions: () => import_getGeoShapePath.defaultGeoTypeDefinitions,
  ...
  defaultHandleExternalFileReplaceContent: () => import_defaultExternalContentHandlers.defaultHandleExternalFileReplaceContent,
  ...
  defaultOverlayUtils: () => import_defaultOverlayUtils.defaultOverlayUtils,
  ...
  getArrowInfo: () => import_getArrowInfo.getArrowInfo,
  ...
  getColorStyleItems: () => import_styles.getColorStyleItems,
  getCropBox: () => import_crop.getCropBox,
  getDefaultCrop: () => import_crop.getDefaultCrop,
  getDisplayValues: () => import_getDisplayValues.getDisplayValues,
  getEmbedInfo: () => import_embeds.getEmbedInfo,
  getFontFamily: () => import_default_shape_constants.getFontFamily,
  getFontStyleItems: () => import_styles.getFontStyleItems,
  getGeoTypeDefinition: () => import_getGeoShapePath.getGeoTypeDefinition,
  ...
  getTipTapDefaultExtensions: () => import_richText.getTipTapDefaultExtensions,
  getUncroppedSize: () => import_crop.getUncroppedSize,
  handleNativeOrMenuCopy: () => import_useClipboardEvents.handleNativeOrMenuCopy,
  ...
  renderHtmlFromRichTextWithExtensions: () => import_richText.renderHtmlFromRichTextWithExtensions,
  ...
  sanitizeSvg: () => import_sanitizeSvg.sanitizeSvg,
  ...
  unknownEmbedShapePermissionOverrides: () => import_defaultEmbedDefinitions.unknownEmbedShapePermissionOverrides,
  ...
  useDirection: () => import_useTranslation2.useDirection,
  ...
  useMaybeCurrentTranslation: () => import_useTranslation2.useMaybeCurrentTranslation,
...
var import_BookmarkAssetUtil = require("./lib/assets/BookmarkAssetUtil");
var import_ImageAssetUtil = require("./lib/assets/ImageAssetUtil");
var import_VideoAssetUtil = require("./lib/assets/VideoAssetUtil");
var import_ArrowBindingHintOverlayUtil = require("./lib/overlays/ArrowBindingHintOverlayUtil");
var import_ArrowBindingUtil = require("./lib/bindings/arrow/ArrowBindingUtil");
var import_ArrowHintOverlayUtil = require("./lib/overlays/ArrowHintOverlayUtil");
var import_BrushOverlayUtil = require("./lib/overlays/BrushOverlayUtil");
var import_ZoomBrushOverlayUtil = require("./lib/overlays/ZoomBrushOverlayUtil");
var import_ScribbleOverlayUtil = require("./lib/overlays/ScribbleOverlayUtil");
var import_CollaboratorHintOverlayUtil = require("./lib/overlays/CollaboratorHintOverlayUtil");
var import_CollaboratorCursorOverlayUtil = require("./lib/overlays/CollaboratorCursorOverlayUtil");
var import_CollaboratorBrushOverlayUtil = require("./lib/overlays/CollaboratorBrushOverlayUtil");
var import_CollaboratorScribbleOverlayUtil = require("./lib/overlays/CollaboratorScribbleOverlayUtil");
var import_CollaboratorShapeIndicatorOverlayUtil = require("./lib/overlays/CollaboratorShapeIndicatorOverlayUtil");
var import_ShapeHandleOverlayUtil = require("./lib/overlays/ShapeHandleOverlayUtil");
var import_ShapeIndicatorOverlayUtil = require("./lib/overlays/ShapeIndicatorOverlayUtil");
var import_SelectionForegroundOverlayUtil = require("./lib/overlays/SelectionForegroundOverlayUtil");
var import_SnapIndicatorOverlayUtil = require("./lib/overlays/SnapIndicatorOverlayUtil");
var import_defaultAssetUtils = require("./lib/defaultAssetUtils");
var import_defaultBindingUtils = require("./lib/defaultBindingUtils");
var import_defaultOverlayUtils = require("./lib/defaultOverlayUtils");
...
var import_getArrowInfo = require("./lib/shapes/arrow/getArrowInfo");
...
var import_getGeoShapePath = require("./lib/shapes/geo/getGeoShapePath");
...
var import_getDisplayValues = require("./lib/shapes/shared/getDisplayValues");
...
var import_styles = require("./lib/styles");
...
var import_InputModeMenu = require("./lib/ui/components/InputModeMenu");
...
var import_DefaultPeopleMenu = require("./lib/ui/components/SharePanel/DefaultPeopleMenu");
var import_DefaultPeopleMenuAvatar = require("./lib/ui/components/SharePanel/DefaultPeopleMenuAvatar");
var import_DefaultPeopleMenuContent = require("./lib/ui/components/SharePanel/DefaultPeopleMenuContent");
var import_DefaultPeopleMenuFacePile = require("./lib/ui/components/SharePanel/DefaultPeopleMenuFacePile");
var import_DefaultPeopleMenuItem = require("./lib/ui/components/SharePanel/DefaultPeopleMenuItem");
var import_DefaultSharePanel = require("./lib/ui/components/SharePanel/DefaultSharePanel");
var import_DefaultUserPresenceEditor = require("./lib/ui/components/SharePanel/DefaultUserPresenceEditor");
...
var import_translations = require("./lib/ui/hooks/useTranslation/translations");
...
var import_sanitizeSvg = require("./lib/utils/svg/sanitizeSvg");
