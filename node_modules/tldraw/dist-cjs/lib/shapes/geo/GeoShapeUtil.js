...
var import_flip = require("../shared/flip");
  ...
  onResize(shape, { handle, newPoint, scaleX, scaleY, initialShape }) {
    ...
    return {
      ...
      props: {
        ...
        growY: 0,
        ...(0, import_flip.getFlipForResize)(initialShape.props, { scaleX, scaleY })
      }
    };
  }
