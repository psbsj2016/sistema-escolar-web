...
const RichTextLabel = import_react.default.memo(function RichTextLabel2({
  ...
  const legacyAlign = (0, import_legacyProps.isLegacyAlign)(textAlign);
  ...
  const handlePointerDown = (e) => {
    ...
    if (e.target instanceof HTMLElementCtor && (e.target.tagName === "A" || e.target.closest("a"))) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...
      style: {
        fontFamily,
        textAlign,
        justifyContent: textAlign === "center" || legacyAlign ? "center" : textAlign === "end" ? "flex-end" : "flex-start",
        alignItems: verticalAlign === "middle" ? "center" : verticalAlign === "end" ? "flex-end" : "flex-start",
        padding,
        ...style
      },
...
function RichTextSVG({
  ...
  const legacyAlign = (0, import_legacyProps.isLegacyAlign)(textAlign);
  const justifyContent = textAlign === "center" || legacyAlign ? "center" : textAlign === "start" ? "flex-start" : "flex-end";
