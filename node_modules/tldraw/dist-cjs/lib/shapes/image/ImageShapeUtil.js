...
var import_crop = require("../shared/crop");
...
var import_ImageAlphaGeometry = require("./ImageAlphaGeometry");
...
const imageSvgExportCache = new import_editor.WeakCache();
class ImageShapeUtil extends import_editor.BaseBoxShapeUtil {
  ...
  createShapeForAsset(asset, position) {
  ...
  getGeometry(shape) {
    ...
    const supportsTransparency = mimeType != null && import_ImageAlphaCache.TRANSPARENT_IMAGE_MIMETYPES.includes(mimeType);
    const assetSrc = asset && "src" in asset.props ? asset.props.src : null;
    if (shape.props.crop?.isCircle) {
      if (supportsTransparency && assetSrc) {
        const src = assetSrc;
        return new import_ImageAlphaGeometry.ImageEllipse2d({
          width: shape.props.w,
          height: shape.props.h,
          isFilled: true,
          alphaDataGetter: () => (0, import_ImageAlphaCache.getAlphaData)(src),
          crop: shape.props.crop,
          flipX: shape.props.flipX,
          flipY: shape.props.flipY
        });
      }
      return new import_editor.Ellipse2d({
        width: shape.props.w,
        height: shape.props.h,
        isFilled: true
      });
    ...
    if (supportsTransparency && assetSrc) {
      const src = assetSrc;
      return new import_ImageAlphaGeometry.ImageRectangle2d({
        width: shape.props.w,
        height: shape.props.h,
        isFilled: true,
        alphaDataGetter: () => (0, import_ImageAlphaCache.getAlphaData)(src),
  ...
  onResize(shape, info) {
    ...
    resized = {
      ...
      props: {
        ...resized.props,
        ...(0, import_flip.getFlipForResize)(info.initialShape.props, info)
      }
    };
  ...
  async toSvg(shape, ctx) {
    ...
    const { w } = (0, import_crop.getUncroppedSize)(shape.props, props.crop);
  ...
  onDoubleClickEdge(shape) {
    ...
    const { w, h } = (0, import_crop.getUncroppedSize)(shape.props, crop);
...
const ImageShape = (0, import_react.memo)(function ImageShape2({ shape }) {
  ...
  const { w } = (0, import_crop.getUncroppedSize)(shape.props, shape.props.crop);
  ...
  (0, import_react.useEffect)(() => {
    if (url && supportsTransparency) {
      (0, import_ImageAlphaCache.preloadAlphaData)(url, assetSrc ?? void 0);
    }
...
function getFlipStyle(shape, size) {
  ...
  if (crop) {
    ...
    cropOffsetX = (0, import_editor.modulate)(crop.topLeft.x, [0, 1 - cropWidth], [0, w - shape.props.w]);
    cropOffsetY = (0, import_editor.modulate)(crop.topLeft.y, [0, 1 - cropHeight], [0, h - shape.props.h]);
  }
...
function SvgImage({ shape, src }) {
  ...
  if (containerStyle.transform && crop) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("defs", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("clipPath", { id: cropClipId, children: crop.isCircle ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "ellipse",
        {
          cx: croppedWidth / 2,
          cy: croppedHeight / 2,
      ...
      ) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("polygon", { points: points.map((p) => `${p.x},${p.y}`).join(" ") }) }) }),
