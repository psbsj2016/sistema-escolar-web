...
var import_TldrawUiTooltip = require("../../ui/components/primitives/TldrawUiTooltip");
...
class NoteShapeUtil extends import_editor.ShapeUtil {
  ...
  options = {
    ...
    getDefaultDisplayValues(_editor, shape, theme, colorMode) {
      ...
      return {
        noteWidth: 200,
        noteHeight: 200,
        noteBackgroundColor: (0, import_editor.getColorValue)(colors, color, "noteFill"),
        borderColor: colors.noteBorder,
        borderWidth: 2,
        labelColor: labelColor === "black" ? (0, import_editor.getColorValue)(colors, color, "noteText") : (0, import_editor.getColorValue)(colors, labelColor, "fill"),
        ...
        labelFontWeight: import_default_shape_constants.TEXT_PROPS.fontWeight,
        labelFontVariant: import_default_shape_constants.TEXT_PROPS.fontVariant,
        labelFontStyle: import_default_shape_constants.TEXT_PROPS.fontStyle,
  ...
  getFontFaces(shape) {
    const fonts = (0, import_richText.isEmptyRichText)(shape.props.richText) ? [] : (0, import_editor.getFontsFromRichText)(this.editor, shape.props.richText, {
      family: `tldraw_${shape.props.font}`,
      weight: "normal",
      style: "normal"
    });
    if (shape.props.textLastEditedBy && !(0, import_richText.isEmptyRichText)(shape.props.richText)) {
      return [...fonts, import_defaultFonts.DefaultFontFaces.tldraw_sans.normal.normal];
    }
    ...
    return fonts.length ? fonts : import_editor.EMPTY_ARRAY;
  }
  component(shape) {
    ...
    const nw = dv.noteWidth * scale;
    const nh = getNoteHeight(shape, dv.noteHeight);
    const hideShadows = (0, import_useEfficientZoomThreshold.useEfficientZoomThreshold)(0.25 / scale);
    ...
    const attribution = (0, import_editor.useValue)(
      "attribution",
      () => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "div",
        {
          ...
          children: [
            attribution && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_TldrawUiTooltip.TldrawUiTooltip, { content: attribution.full, side: "bottom", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "div",
              {
            ...
            (isSelected || isReadyForEditing || !isEmpty) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
  ...
  toSvg(shape, ctx) {
    ...
    const bounds = new import_editor.Box(0, 0, dv.noteWidth, dv.noteHeight + shape.props.growY);
    const filterId = `note-shadow-${shape.id.replace(/:/g, "_")}`;
    ctx.addExportDef({
      key: filterId,
      getElement: () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("filter", { id: filterId, x: "-10%", y: "-10%", width: "130%", height: "150%", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feMorphology", { in: "SourceAlpha", operator: "erode", radius: "3", result: "erode1" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feGaussianBlur", { in: "erode1", stdDeviation: "3", result: "blur1" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feOffset", { in: "blur1", dy: "3", result: "offsetBlur1" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feComponentTransfer", { in: "offsetBlur1", result: "shadow1", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feFuncA", { type: "linear", slope: "0.5" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feMorphology", { in: "SourceAlpha", operator: "erode", radius: "10", result: "erode2" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feGaussianBlur", { in: "erode2", stdDeviation: "6", result: "blur2" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feOffset", { in: "blur2", dy: "6", result: "offsetBlur2" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feComponentTransfer", { in: "offsetBlur2", result: "shadow2", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feFuncA", { type: "linear", slope: "0.5" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("feMerge", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feMergeNode", { in: "shadow1" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feMergeNode", { in: "shadow2" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feMergeNode", { in: "SourceGraphic" })
        ] })
      ] })
    });
    const { textLastEditedBy } = shape.props;
    const attributionName = textLastEditedBy && !(0, import_richText.isEmptyRichText)(shape.props.richText) ? this.editor.getAttributionDisplayName(textLastEditedBy)?.split(" ")[0] ?? null : null;
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      ctx.isDarkMode ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "rect",
        {
          rx: 1,
          width: dv.noteWidth,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", { rx: 1, width: dv.noteWidth, height: bounds.h, fill: dv.noteBackgroundColor }),
      ...
      attributionName && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "foreignObject",
        {
          x: 0,
          y: 0,
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { position: "relative", width: "100%", height: "100%" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "div",
            {
              className: "tl-note__attribution",
              style: {
  ...
  onBeforeDuplicate(_source, duplicate) {
    if ((0, import_richText.isEmptyRichText)(duplicate.props.richText)) return;
    return {
      ...duplicate,
  ...
  onBeforeUpdate(prev, next) {
    const richTextChanged = !(0, import_editor.isEqual)(prev.props.richText, next.props.richText);
    if (!richTextChanged && prev.props.font === next.props.font && prev.props.size === next.props.size) {
      return;
    }
    let shape = next;
    if (richTextChanged) {
      if ((0, import_richText.isEmptyRichText)(next.props.richText)) {
        shape = {
          ...shape,
  ...
  _labelSizesForNoteCache = new import_editor.WeakCache();
  /**
  ...
  measureNoteLabelSize(shape) {
    ...
    if ((0, import_richText.isEmptyRichText)(richText)) {
      const minHeight = (0, import_editor.resolveLineHeightPx)(dv.labelFontSize, dv.labelLineHeight) + dv.labelPadding * 2;
    ...
    do {
      ...
      const html = (0, import_richText.renderHtmlFromRichTextForMeasurement)(this.editor, richText);
      ...
      if (fontSizeAdjustment <= 14) {
        const html2 = (0, import_richText.renderHtmlFromRichTextForMeasurement)(this.editor, richText);
  ...
  return (0, import_react.useCallback)(
    (e) => {
      ...
      if (isTab || isCmdEnter) {
        ...
        const dv = (0, import_getDisplayValues.getDisplayValues)(noteUtil, shape);
        ...
        ).mul(offsetLength).add(new import_editor.Vec(dv.noteWidth / 2, dv.noteHeight / 2).mul(shape.props.scale)).rot(pageRotation).add(pageTransform.point());
        const newNote = (0, import_noteHelpers.getNoteShapeForAdjacentPosition)(editor, {
          shape,
