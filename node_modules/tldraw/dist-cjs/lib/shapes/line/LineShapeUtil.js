...
class LineShapeUtil extends import_editor.ShapeUtil {
  ...
  options = {
    getDefaultDisplayValues(_editor, shape, theme, colorMode) {
      ...
      return {
        strokeColor: (0, import_editor.getColorValue)(theme.colors[colorMode], color, "solid"),
  ...
  component(shape) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_editor.SVGContainer, { style: { minWidth: 50, minHeight: 50 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LineShapeSvg, { shape, strokeColor: dv.strokeColor, strokeWidth: dv.strokeWidth }) });
  }
  getIndicatorPath(shape) {
    const strokeWidth = (0, import_getDisplayValues.getDisplayValues)(this, shape).strokeWidth * shape.props.scale;
