...
__export(defaultEmbedDefinitions_exports, {
  ...
  unknownEmbedShapePermissionOverrides: () => unknownEmbedShapePermissionOverrides
});
...
const DEFAULT_EMBED_DEFINITIONS = [
  ...
  },
  {
    ...
    toEmbedUrl: (url) => {
      const urlObj = (0, import_editor.safeParseUrl)(url);
      if (urlObj && urlObj.pathname.match(/^\/design\/([^/]+)\/.+/) && !urlObj.searchParams.has("embed")) {
...
const unknownEmbedShapePermissionOverrides = {
