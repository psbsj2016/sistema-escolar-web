...
__export(richText_exports, {
  ...
  getTipTapDefaultExtensions: () => getTipTapDefaultExtensions,
  isEditingRichTextList: () => isEditingRichTextList,
  ...
  renderHtmlFromRichTextWithExtensions: () => renderHtmlFromRichTextWithExtensions,
...
function getTipTapDefaultExtensions(starterKitOptions) {
  return [
...
const tipTapDefaultExtensions = getTipTapDefaultExtensions();
const htmlCache = new import_editor.WeakCache();
function renderHtmlFromRichTextWithExtensions(richText, extensions2) {
  const html = (0, import_core.generateHTML)(richText, extensions2);
...
function isEditingRichTextList(editor) {
