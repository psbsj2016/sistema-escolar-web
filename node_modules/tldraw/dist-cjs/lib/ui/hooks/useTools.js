        ...
        onDragStart(source, info) {
          ...
          onDragFromToolbarToCreateShape(editor, info, {
            createShape: (id) => editor.createShape({
              id,
              type: "text",
              props: { richText: (0, import_editor.toRichText)("Text"), scale }
            }),
            onDragEnd: (id) => {
              (0, import_selectHelpers.startEditingShapeWithRichText)(editor, id, { selectAll: true });
            }
          });
...
function onDragFromToolbarToCreateShape(editor, info, opts) {
  ...
  if (!shape) {
    (0, import_editor.warnOnce)("onDragFromToolbarToCreateShape: createShape did not create a shape, ignoring drag.");
