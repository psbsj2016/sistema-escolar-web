...
__export(menu_hooks_exports, {
  ...
  useCanApplySelectionAction: () => useCanApplySelectionAction,
  useCanRedo: () => useCanRedo,
  useCanUndo: () => useCanUndo,
  useHasLinkShapeSelected: () => useHasLinkShapeSelected,
  useHasShapesOnPage: () => useHasShapesOnPage,
...
function useOnlyFlippableShape() {
  ...
  return (0, import_editor.useValue)(
    ...
    () => {
      ...
      return shape && (editor.isShapeOfType(shape, "group") || editor.isShapeOfType(shape, "image") || editor.isShapeOfType(shape, "arrow") || editor.isShapeOfType(shape, "line") || editor.isShapeOfType(shape, "draw") || editor.isShapeOfType(shape, "geo"));
    },
    [editor]
  );
}
...
function useHasShapesOnPage() {
  const editor = (0, import_editor.useEditor)();
  return (0, import_editor.useValue)("hasShapesOnPage", () => editor.getCurrentPageShapeIds().size > 0, [editor]);
}
