...
var import_useCommentingEnabled = require("../../hooks/useCommentingEnabled");
...
function DefaultQuickActionsContent() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CommentQuickAction, {})
  ] });
}
...
function CommentQuickAction() {
  const editor = (0, import_editor.useEditor)();
  const commentingEnabled = (0, import_useCommentingEnabled.useCommentingEnabled)();
  const isCommentToolSelected = (0, import_editor.useValue)(
    "is comment tool selected",
    () => editor.getCurrentToolId() === "comment",
    [editor]
  );
  if (!commentingEnabled) return null;
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_TldrawUiMenuToolItem.TldrawUiMenuToolItem, { toolId: "comment", isSelected: isCommentToolSelected });
}
