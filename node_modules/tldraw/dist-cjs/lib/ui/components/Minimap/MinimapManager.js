...
class MinimapManager {
  ...
  render() {
    ...
    for (const presence of editor.getVisibleCollaboratorsOnCurrentPage()) {
      ...
      ctx.beginPath();
      ctx.arc(presence.cursor.x, presence.cursor.y, dotRadius, 0, import_editor.PI2);
