...
var import_getGeoShapePath = require("../../../shapes/geo/getGeoShapePath");
...
function StylePanelColorPicker() {
  ...
  const items = (0, import_editor.useValue)(
    "style panel color items",
    () => (0, import_styles.getColorStyleItems)(editor.getCurrentTheme().colors[editor.getColorMode()]),
    [editor]
  );
...
function StylePanelOpacityPicker() {
  const editor = (0, import_editor.useEditor)();
  const { onHistoryMark, onOpacityChange, enhancedA11yMode } = (0, import_StylePanelContext.useStylePanelContext)();
...
function StylePanelFontPicker() {
  ...
  const items = (0, import_editor.useValue)(
    ...
    () => (0, import_styles.getFontStyleItems)(editor.getCurrentTheme()),
    [editor]
  );
...
function StylePanelGeoShapePicker() {
  ...
  const merged = {
    ...import_getGeoShapePath.defaultGeoTypeDefinitions,
    ...customGeoTypes
  };
