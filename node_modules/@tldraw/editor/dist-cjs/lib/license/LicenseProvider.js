...
__export(LicenseProvider_exports, {
  ...
  useMaybeLicenseManager: () => useMaybeLicenseManager
});
...
const import_meta = {};
const LicenseContext = (0, import_react.createContext)(null);
...
function useMaybeLicenseManager() {
  const licenseManager = (0, import_react.useContext)(LicenseContext);
