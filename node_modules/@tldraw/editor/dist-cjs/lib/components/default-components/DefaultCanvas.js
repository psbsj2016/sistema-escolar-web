...
var import_getHtmlLayerTransform = require("../../utils/getHtmlLayerTransform");
...
function DefaultCanvas({ className }) {
  ...
  (0, import_state_react.useQuickReactor)(
    ...
    function positionLayersWhenCameraMoves() {
      (0, import_dom.setStyleProperty)(rHtmlLayer.current, "transform", (0, import_getHtmlLayerTransform.getHtmlLayerTransform)(editor));
    },
    [editor, container]
  );
