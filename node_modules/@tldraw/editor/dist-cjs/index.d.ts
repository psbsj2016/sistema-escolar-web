 ...
 * @public
 */
export declare abstract class EditorManager {
 ...
 * @react
 */
export declare function EditorPortal({ children }: EditorPortalProps): ReactPortal | null;

/** @public */
export declare interface EditorPortalProps {
    children: ReactNode;
}
 ...
 * @public
 */
export declare function isCursorInViewport(cursor: VecLike, viewport: {
    maxX: number;
    maxY: number;
    minX: number;
    minY: number;
...
/* Excluded from this release type: LicenseFeatureName */
...
/** @public */
export declare class TextManager extends EditorManager {
    private elm;
    private poolElms;
    constructor(editor: Editor);
 ...
 * @public
 */
export declare function useEditorPortalHost(): HTMLElement | null;
...
/* Excluded from this release type: useLicenseContext */

/* Excluded from this release type: useLicenseFeatureFlag */
