...
import { EditorPortalProvider } from "./components/EditorPortal.mjs";
...
import { LicenseProvider, useLicenseContext } from "./license/LicenseProvider.mjs";
        ...
        children: [
          /* @__PURE__ */ jsx(
            OptionalErrorBoundary,
            {
              ...
              children: container && /* @__PURE__ */ jsx(LicenseProvider, { licenseKey: rest.licenseKey, children: /* @__PURE__ */ jsx(ContainerProvider, { container, children: /* @__PURE__ */ jsx(EditorPortalProvider, { host: portalHost, children: /* @__PURE__ */ jsx(EditorComponentsProvider, { overrides: components, children: store ? store instanceof Store ? (
          ...
          /* @__PURE__ */ jsx("div", { className: "tl-portal-host", ref: setPortalHost })
        ]
      }
    )
  );
...
function TldrawEditorWithReadyStore({
  ...
  useLayoutEffect(
    () => {
      ...
      editor2.licenseManager = licenseManager;
...
function useOnMount(onMount) {
  ...
  const onMountEvent = useEvent((editor2) => {
    ...
    return () => {
      teardown?.();
      if (editor2.getIsMounted() && !editor2.isDisposed) {
        editor2.run(() => editor2.emit("unmount"), { history: "ignore" });
      }
    };
  });
