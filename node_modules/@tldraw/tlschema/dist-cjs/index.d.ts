 ...
 * @public
 */
export declare interface TLComment extends BaseRecord<'comment', TLCommentId> {
 ...
 * @public
 */
export declare type TLCommentAnchor = {
...
/** @public */
export declare type TLCommentId = RecordId<TLComment>;
 ...
 * @public
 */
export declare interface TLCommentReaction extends BaseRecord<'comment-reaction', TLCommentReactionId> {
...
/** @public */
export declare type TLCommentReactionId = RecordId<TLCommentReaction>;
 ...
 * @public
 */
export declare interface TLCommentThread extends BaseRecord<'comment-thread', TLCommentThreadId> {
...
/** @public */
export declare type TLCommentThreadId = RecordId<TLCommentThread>;
