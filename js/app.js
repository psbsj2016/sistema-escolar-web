...
window.LISTA_FUNCIONALIDADES = [
    ...
    // 👇 O BOTÃO DO WORKSPACE FICA AQUI NO FINAL DO MENU (Abaixo dos documentos/contratos)
...
validarCadastroInst: async () => {
   ...
   // Adicionamos o parâmetro 'veioDoHistorico'
    ...
    abrirModalVenda: async (idAluno, nomeAluno) => {
        ...
        document.getElementById('modal-form-content').innerHTML = '<p style="text-align:center; padding:20px; color:#666;">Carregando estoque... ⏳</p>';
