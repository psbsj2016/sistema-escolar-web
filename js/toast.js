...
window.Toast = {
    init: () => {
        ...
        // 🎨 1. Injeta o Design Elegante e Animações Dinamicamente
        ...
        // 📦 2. Cria o Recipiente Invisível na Tela
    ...
    show: (mensagem, tipo = 'info') => {
        ...
        // O aluno pode clicar para fechar antes do tempo
