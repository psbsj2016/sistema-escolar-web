...
Workspace.Feed = {
 ...
 carregarPosts: async () => {
   ...
   filtrarFeed: (tipoFiltro) => {
        ...
        sentinela.innerHTML = '<div style="text-align:center; padding:20px; color:#249; font-size:13px;"><strong><h2>📢 Se você está lendo esta mensagem é porque ficou muitos dias sem acessar o WorkSpace! Por favor, saia do WorkSpace e entre novamente para que tudo seja atualizado e este aviso deixe de aparecer. <div style="text-align:left; padding:20px;> — Desenvolvedor.</div></h2></strong></div>';
