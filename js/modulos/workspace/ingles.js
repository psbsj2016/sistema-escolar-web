                ...
                <div id="ig-mainIlha" style="position:relative;min-height:calc(100vh - 60px);background:linear-gradient(180deg,#1e3a8a 0%,#0f172a 100%)">
                    ...
                    <div id="ig-missoesDiarias" style="position:absolute;top:220px;right:16px;z-index:15;width:260px;background:linear-gradient(180deg,rgba(15,23,42,0.95),rgba(10,15,35,0.95));border:1.5px solid #334155;border-radius:16px;padding:14px;backdrop-filter:blur(12px);box-shadow:0 6px 20px rgba(0,0,0,0.4);display:none">
                        ...
                        <div style="display:flex;flex-direction:column;gap:10px">
                            ...
                            <div style="display:flex;gap:10px;align-items:center"><div style="width:28px;height:28px;background:#fff;border-radius:6px;display:flex;align-items:center;justify-content:center;font-size:16px">🎯</div><div style="flex:1"><div style="color:#fff;font-size:11px">Acertar 10 questões</div><div style="display:flex;align-items:center;gap:6px;margin-top:4px"><div style="flex:1;background:rgba(0,0,0,0.5);height:6px;border-radius:6px;overflow:hidden"><div style="width:60%;height:100%;background:#3b82f6"></div></div><span style="color:#93c5fd;font-size:10px">6/10</span><span style="background:#1e3a8a;color:#93c5fd;padding:2px 6px;border-radius:6px;font-size:8px">XP 50</span></div></div></div>
                            <div style="display:flex;gap:10px;align-items:center"><div style="width:28px;height:28px;background:#fff;border-radius:6px;display:flex;align-items:center;justify-content:center;font-size:16px">🪙</div><div style="flex:1"><div style="color:#fff;font-size:11px">Jogar 1 mini game</div><div style="display:flex;align-items:center;gap:6px;margin-top:4px"><div style="flex:1;background:rgba(0,0,0,0.5);height:6px;border-radius:6px;overflow:hidden"><div style="width:100%;height:100%;background:#22c55e"></div></div><span style="color:#22c55e">✓</span><span style="background:#14532d;color:#86efac;padding:2px 6px;border-radius:6px;font-size:8px">XP 50</span></div></div></div>
                        </div>
...
// ================= 🏝️ HUB V2 - ORGANIZADO =================
   ...
   sucessoGenerico: async function(bonus){
        ...
        toast.innerHTML=`🪙 +${bonusCoins} BZ • Próxima em ${srs?.interval||1}d`;
        document.body.appendChild(toast);
        setTimeout(()=>toast.remove(),1500);
