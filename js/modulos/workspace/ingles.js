...
// ============================================================================
    ...
    loadDados: async () => {
        try {
            ...
            // 2. XP e Streak continuam armazenados no telemóvel do aluno para leitura visual super-rápida
    ...
    saveDados: async () => {
        ...
        try {
            ...
            // 🚀 A MÁGICA DA PISCINA GLOBAL: Envia todas as novidades do Professor e Envios dos Alunos para a Nuvem
