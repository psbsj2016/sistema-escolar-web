...
Workspace.Ingles = {
  ...
  construirHTML: () => {
        ...
        container.innerHTML = `
            ...
            <div class="ig-header">
                <div class="ig-title">
                    <!-- 🚀 TRUQUE DE ROTAS: Tenta /assets/, se falhar tenta /public/assets/ -->
                    <img id="ig-header-chest" src="/assets/bau_roxo_pixel.jpg" onerror="this.onerror=null; this.src='/public/assets/bau_roxo_pixel.jpg';" alt="Baú" style="width: 55px; height: auto; mix-blend-mode: screen; transition: 0.3s; filter: drop-shadow(0 0 10px #f1c40f);" />
            ...
            <div id="ig-guardian-screen" class="ig-guardian-container" style="display:none; transition: opacity 0.5s ease-out;">
                ...
                <!-- 🚀 TRUQUE DE ROTAS: O Mago -->
                <img src="/assets/mago_bau_ingles.jpg" onerror="this.onerror=null; this.src='/public/assets/mago_bau_ingles.jpg';" class="ig-guardian-avatar" alt="Mago" />
            ...
            <div id="ig-alunoView" style="display:none; padding: 30px 30px 40px 30px;">
                <div class="ig-hub-banner">
                    ...
                    <!-- 🚀 TRUQUE DE ROTAS: O Mago no Hub de Jogos -->
                    <img src="/assets/mago_bau_ingles.jpg" onerror="this.onerror=null; this.src='/public/assets/mago_bau_ingles.jpg';" class="ig-hub-mago-img" alt="Mago" />
            ...
            <div id="ig-timeout-screen" style="display:none; flex-direction:column; align-items:center; justify-content:center; min-height:60vh; background:#F8FAFC; text-align:center;">
                <!-- 🚀 TRUQUE DE ROTAS: O Baú Fechado -->
                <img src="/assets/bau_roxo_pixel.jpg" onerror="this.onerror=null; this.src='/public/assets/bau_roxo_pixel.jpg';" alt="Baú Fechado" style="width: 140px; mix-blend-mode: screen; filter: grayscale(100%) opacity(0.6); margin-bottom: 20px;" />
