...
`,M=async()=>{k.verificarNotificacoes(),k.setTitulo(`Visão Geral`);let e=document.getElementById(`app-content`);try{let[t,n,r,i]=await Promise.all([k.api(`/alunos`),k.api(`/financeiro`),k.api(`/turmas`),k.api(`/cursos`)]),a=(Array.isArray(t)?t:[]).filter(e=>!e.status||e.status===`Ativo`),o=Array.isArray(n)?n:[],s=Array.isArray(r)?r:[],c=Array.isArray(i)?i:[],l=new Date,u=l.getMonth()+1,d=l.getFullYear(),f=a.map(e=>e.id),p=o.filter(e=>{if(!e.vencimento)return!1;let t=e.vencimento.split(`-`);return parseInt(t[1])===u&&parseInt(t[0])===d}),m=p.filter(e=>e.status===`Pago`).reduce((e,t)=>e+parseFloat(t.valor),0),h=p.filter(e=>e.status!==`Pago`&&f.includes(e.idAluno)).reduce((e,t)=>e+parseFloat(t.valor),0),g=o.filter(e=>e.status===`Pendente`&&new Date(e.vencimento+`T00:00:00`)<l&&f.includes(e.idAluno)).sort((e,t)=>new Date(e.vencimento)-new Date(t.vencimento)),_=e=>e.toLocaleString(`pt-BR`,{minimumFractionDigits:2,maximumFractionDigits:2}),v=k.usuario?k.usuario.tipo:`Gestor`,y=v!==`Professor`,b=g.length===0?`<div style="text-align:center; padding:20px; color:#27ae60; font-weight:bold; font-size:14px;">🎉 Excelente! Nenhum título em atraso.</div>`:g.map(e=>{let t=(a.find(t=>t.id===e.idAluno)||{}).whatsapp||``,n=e.vencimento.split(`-`).reverse().join(`/`),r=_(parseFloat(e.valor));return j(e.alunoNome||`Desconhecido`,n,r,t)}).join(``),x=JSON.parse(localStorage.getItem(k.getTenantKey(`escola_atalhos`)));(!x||!Array.isArray(x)||x.length===0)&&(x=[`novo_aluno`,`fin_carne`,`ped_chamada`,`ped_notas`,`ped_plan`,`ped_bol`]);let S=x.map(e=>{let t=(window.LISTA_FUNCIONALIDADES||[]).find(t=>t.id===e);return t&&t.roles.includes(v)?`<div class="shortcut-btn" onclick="${t.acao}"><div>${t.icon}</div><span>${t.nome}</span></div>`:``}).join(``);if(e.innerHTML=`
    ...
    `;if(a&&(a.innerHTML=s),o){o.innerText=`SIM, EXCLUIR 🗑️`,o.style.background=`#c0392b`;let r=o.cloneNode(!0);o.parentNode.replaceChild(r,o),r.onclick=async()=>{let i=r.innerText;r.innerText=`A excluir... ⏳`,r.disabled=!0,document.body.style.cursor=`wait`;try{let r=Array.from(t).map(e=>z.api(`/${n}/${e.value}`,`DELETE`));await Promise.all(r),z.showToast(`Registos excluídos com sucesso!`,`success`),z.fecharModal();let i=document.getElementById(`app-content`);i&&(i.innerHTML=`<p style="text-align:center; color:#666; padding:20px;">Atualizando lista... ⏳</p>`),await z.renderizarLista(e)}catch{z.showToast(`Erro ao processar exclusão.`,`error`),r.innerText=i,r.disabled=!1}finally{document.body.style.cursor=`default`,setTimeout(()=>{r&&(r.style.background=``)},500)}}}},window.App=window.App||{};var H=window.App;Object.assign(H,{renderizarWorkspaceAdmin:()=>{H.setTitulo(`Gestão do Workspace`);let e=document.getElementById(`app-content`);e.innerHTML=`
        ...
        `,await H.atualizarDadosRadar(),H.radarMonitoramentoInterval&&clearInterval(H.radarMonitoramentoInterval),H.radarMonitoramentoInterval=setInterval(()=>{if(document.getElementById(`titulo-pagina`)?.innerText!==`Monitoramento Online`){clearInterval(H.radarMonitoramentoInterval);return}H.atualizarDadosRadar(!0)},1e4)},atualizarDadosRadar:async(e=!1)=>{try{let t=await H.api(`/workspace/monitoramento/status`,`GET`,null,e),n=document.getElementById(`lista-monitoramento`);if(!n)return;if(!t||t.error||t.length===0){n.innerHTML=`<p style="text-align:center; padding: 40px; color:#7f8c8d; font-size: 14px;">Nenhum aluno registado ou histórico de navegação encontrado.</p>`;return}let r=`<div class="table-responsive-wrapper"><table style="width:100%; border-collapse:collapse; text-align:left;">`;r+=`<thead><tr style="background: #fff; border-bottom: 2px solid #eee; color:#64748b; font-size: 13px; text-transform: uppercase;">`,r+=`<th style="padding:15px 20px;">Identificação do Aluno</th>`,r+=`<th style="padding:15px 20px; text-align:center;">Status Atual</th>`,r+=`<th style="padding:15px 20px; text-align:right;">Última Interação Registada</th>`,r+=`</tr></thead><tbody>`,t.sort((e,t)=>t.isOnline===e.isOnline?0:t.isOnline?1:-1),t.forEach(e=>{let t=e.isOnline,n=t?`#27ae60`:`#e74c3c`,i=t?`Online Agora`:`Offline`,a=t?`#eafaf1`:`#fdedec`,o=t?`animation: pulseDot 2s infinite;`:``,s=e.ultimoAcesso?new Date(e.ultimoAcesso).toLocaleString(`pt-BR`,{day:`2-digit`,month:`2-digit`,year:`numeric`,hour:`2-digit`,minute:`2-digit`}):`Nunca acessou`;r+=`
