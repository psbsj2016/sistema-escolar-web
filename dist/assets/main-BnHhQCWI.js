import"./site-CuorVS2D.js";var e=Object.defineProperty,t=(t,n)=>{let r={};for(var i in t)e(r,i,{get:t[i],enumerable:!0});return n||e(r,Symbol.toStringTag,{value:`Module`}),r};window.CONFIG=window.CONFIG||{},window.App=window.App||{},window.Admin=window.Admin||{};var n=window.CONFIG,r=window.App;n.API_URL,window.LISTA_FUNCIONALIDADES=[{id:`novo_aluno`,nome:`Novo Aluno`,icon:`👨‍🎓`,acao:`App.abrirModalCadastro('aluno')`,roles:[`Gestor`,`Secretaria`]},{id:`fin_carne`,nome:`Gerar Carnê`,icon:`💸`,acao:`App.renderizarTela('mensalidades')`,roles:[`Gestor`,`Secretaria`]},{id:`ped_chamada`,nome:`Fazer Chamada`,icon:`📋`,acao:`App.renderizarTela('chamada')`,roles:[`Gestor`,`Secretaria`,`Professor`]},{id:`ped_notas`,nome:`Lançar Nota`,icon:`📝`,acao:`App.renderizarTela('avaliacoes')`,roles:[`Gestor`,`Secretaria`,`Professor`]},{id:`ped_plan`,nome:`Planejamento`,icon:`📅`,acao:`App.renderizarTela('planejamento')`,roles:[`Gestor`,`Secretaria`,`Professor`]},{id:`ped_bol`,nome:`Boletins`,icon:`🖨️`,acao:`App.renderizarTela('boletins')`,roles:[`Gestor`,`Secretaria`,`Professor`]},{id:`gerir_workspace`,nome:`Workspace`,icon:`🎓`,acao:`App.renderizarWorkspaceAdmin()`,roles:[`Gestor`,`Secretaria`]},{id:`fin_inad`,nome:`Inadimplência`,icon:`⚠️`,acao:`App.renderizarTela('inadimplencia')`,roles:[`Gestor`,`Secretaria`]},{id:`fin_rel`,nome:`Rel. Financeiro`,icon:`📊`,acao:`App.renderizarRelatorio('financeiro')`,roles:[`Gestor`,`Secretaria`]},{id:`doc_ficha`,nome:`Ficha Matrícula`,icon:`📄`,acao:`App.renderizarRelatorio('ficha')`,roles:[`Gestor`,`Secretaria`]},{id:`doc_dossie`,nome:`Dossiê Executivo`,icon:`📁`,acao:`App.renderizarRelatorio('dossie')`,roles:[`Gestor`]},{id:`doc_gerador`,nome:`Documentos`,icon:`🎓`,acao:`App.renderizarRelatorio('documentos')`,roles:[`Gestor`,`Secretaria`]}],Object.assign(r,{usuario:null,entidadeAtual:null,idEdicao:null,idEdicaoUsuario:null,listaCache:[],sanitizeHTML:e=>e?typeof DOMPurify>`u`?(console.warn(`DOMPurify não carregado. Usando escapeHTML como fallback.`),r.escapeHTML(e)):DOMPurify.sanitize(e,{USE_PROFILES:{html:!0},ALLOWED_TAGS:[`p`,`br`,`strong`,`b`,`em`,`i`,`u`,`h1`,`h2`,`h3`,`h4`,`ul`,`ol`,`li`,`div`,`span`,`table`,`thead`,`tbody`,`tr`,`td`,`th`,`blockquote`],ALLOWED_ATTR:[`style`,`class`]}):``,motorTempoRealLigado:!1,calendarState:{month:new Date().getMonth(),year:new Date().getFullYear()},escapeHTML:e=>e==null?``:String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`),unescapeHTML:e=>e==null?``:String(e).replace(/&amp;/g,`&`).replace(/&lt;/g,`<`).replace(/&gt;/g,`>`).replace(/&quot;/g,`"`).replace(/&#039;/g,`'`),criarElemento:(e,t=[],n={},r=``)=>{let i=document.createElement(e);t.length>0&&i.classList.add(...t);for(let e in n)if(e.startsWith(`on`)&&typeof n[e]==`function`){let t=e.substring(2).toLowerCase();i.addEventListener(t,n[e])}else i.setAttribute(e,n[e]);return r!==``&&(i.textContent=r),i},getTenantKey:e=>`${e}_${r.usuario&&r.usuario.id?r.usuario.id:`convidado`}`,getPlanoAtual:()=>localStorage.getItem(r.getTenantKey(`escola_plano`))||`Teste`,getDeviceId:()=>{let e=localStorage.getItem(`ptt_device_id`);return e||(e=`dev_`+window.crypto.randomUUID(),localStorage.setItem(`ptt_device_id`,e)),e},aplicarPermissoesDeUsuario:()=>{if(!r.usuario)return;let e=r.usuario.tipo||`Gestor`;document.querySelectorAll(`.sidebar button, .sidebar .menu-item`).forEach(t=>{let n=t.getAttribute(`onclick`)||``,r=!0;e===`Professor`?(n.includes(`mensalidade`)||n.includes(`financeiro`)||n.includes(`inadimplencia`)||n.includes(`relatorio`)||n.includes(`configuracoes`)||n.includes(`aparencia`)||n.includes(`backup`)||n.includes(`plano`)||n.includes(`conta`))&&(r=!1):e===`Secretaria`&&(n.includes(`configuracoes`)||n.includes(`aparencia`)||n.includes(`backup`)||n.includes(`plano`)||n.includes(`dossie`)||n.includes(`conta`))&&(r=!1),t.style.display=r?``:`none`})},verificarBloqueioGeral:e=>{if(!e)return!1;let t=e.plano||`Teste`;if(t===`Bloqueado`)return!0;let n=new Date;if(t===`Teste`){let t=e.dataCriacao?new Date(e.dataCriacao):n;return Math.floor(Math.abs(n-t)/(1e3*60*60*24))>=7}if(e.dataExpiracao)return n>=new Date(e.dataExpiracao);{let r=e.dataCriacao?new Date(e.dataCriacao):n,i=Math.floor(Math.abs(n-r)/(1e3*60*60*24));if(t!==`Premium`&&i>=30)return!0}return!1},verificarLimites:async e=>{let t=r.getPlanoAtual();if(t===`Premium`||t===`Teste`)return!0;try{if(e===`aluno`){let e=await r.api(`/alunos`),n=t===`Essencial`?20:t===`Profissional`?80:0;if(e.length>=n)return r.showToast(`⚠️ Limite de ${n} alunos atingido no plano ${t}. Faça o upgrade para continuar a crescer!`,`warning`),setTimeout(()=>r.renderizarMeuPlano(),2e3),!1}else if(e===`usuario`){let e=await r.api(`/usuarios`),n=t===`Essencial`?2:t===`Profissional`?4:0;if(e.length>=n)return r.showToast(`⚠️ Limite de ${n} acessos atingido no plano ${t}. Faça o upgrade para adicionar mais equipe!`,`warning`),setTimeout(()=>r.renderizarMeuPlano(),2e3),!1}return!0}catch{return!1}},verificarPermissao:e=>{let t=r.getPlanoAtual();return t===`Premium`||t===`Teste`?!0:e===`whatsapp`&&t===`Essencial`?(r.showToast(`💎 Funcionalidade disponível a partir do Plano Profissional. Faça o upgrade!`,`warning`),setTimeout(()=>r.renderizarMeuPlano(),1500),!1):e===`dossie`&&t!==`Premium`?(r.showToast(`💎 Exclusivo do Plano Premium. Faça o upgrade para aceder ao Dossiê Executivo!`,`warning`),setTimeout(()=>r.renderizarMeuPlano(),1500),!1):!0},api:async(e,t=`GET`,n=null,i=!1)=>{let a={method:t,headers:{"Content-Type":`application/json`},credentials:`include`,cache:`no-store`};n&&(a.body=JSON.stringify(n));let o=e.replace(/^\/api/,``),s=o.startsWith(`/`)?o:`/${o}`,c=`/api${s}`;(window.location.hostname===`localhost`||window.location.hostname===`127.0.0.1`)&&window.location.port!==`5173`&&(c=`http://localhost:3000${s}`);try{let e=await fetch(c,a);if(!e.ok){let t=(await e.json().catch(()=>({}))).error||`Erro no servidor (${e.status})`;return!i&&document.visibilityState===`visible`&&r.showToast(t,`error`),{error:t}}let n=await e.json();return t!==`GET`&&r.usuario&&typeof r.verificarNotificacoes==`function`&&setTimeout(r.verificarNotificacoes,800),n}catch(e){if(console.error(`❌ Falha na API [${t} ${c}]:`,e.message),document.visibilityState===`hidden`||i)return t===`GET`?[]:{error:`Rejeitado silenciosamente em background`};let n=e.message===`Failed to fetch`||e.message.includes(`NetworkError`)?`Sem ligação ao servidor Backend (Porta 3000 desligada?)`:e.message;return r.showToast(n,`error`),t===`GET`?[]:{error:n}}},setTitulo:e=>{let t=document.getElementById(`titulo-pagina`);t&&(t.innerText=e)},toggleSub:e=>{document.querySelectorAll(`.submenu`).forEach(t=>{t.id!==e&&(t.style.display=`none`)});let t=document.getElementById(e);t&&(t.style.display=t.style.display===`block`?`none`:`block`)},fecharModal:()=>{document.getElementById(`modal-overlay`).style.display=`none`;let e=document.querySelector(`.btn-confirm`);e&&(e.style.display=`inline-flex`,e.setAttribute(`onclick`,`App.salvarCadastro()`),e.innerHTML=`💾 Salvar Registro`)},abrirTelaCadastroInst:()=>{document.getElementById(`modal-cadastro-inst`).style.display=`flex`,r.voltarEtapa1()},fecharModalInst:()=>{document.getElementById(`modal-cadastro-inst`).style.display=`none`},voltarEtapa1:()=>{document.getElementById(`etapa-1-email`).style.display=`block`,document.getElementById(`etapa-2-validacao`).style.display=`none`,document.getElementById(`etapa-3-sucesso`).style.display=`none`},enviarCodigoInst:async()=>{console.log(`🔥 Clique recebido no botão de Cadastro!`);let e=document.getElementById(`novo-inst-email`).value,t=document.querySelector(`#etapa-1-email button`);if(!e||!e.includes(`@`))return r.showToast(`Digite um e-mail válido.`,`error`);let n=t.innerText;t.innerText=`Enviando... ⏳`,t.disabled=!0;try{let t=await r.api(`/auth/enviar-codigo`,`POST`,{email:e});t&&t.success?(r.showToast(`Código enviado!`,`success`),document.getElementById(`etapa-1-email`).style.display=`none`,document.getElementById(`etapa-2-validacao`).style.display=`block`):r.showToast(`Erro ao enviar e-mail.`,`error`)}catch{r.showToast(`Erro de servidor.`,`error`)}finally{t.innerText=n,t.disabled=!1}},validarCadastroInst:async()=>{let e=document.getElementById(`novo-inst-email`).value,t=document.getElementById(`novo-inst-codigo`).value.trim(),n=document.getElementById(`novo-inst-pin`).value.trim(),i=document.querySelector(`#etapa-2-validacao button`);if(!t||!n)return r.showToast(`Preencha Código e PIN.`,`error`);let a=i.innerText;i.innerText=`A Validar... ⏳`,i.disabled=!0;try{let i=await r.api(`/auth/validar-cadastro`,`POST`,{email:e,codigo:t,pin:n});i&&i.success?(document.getElementById(`etapa-2-validacao`).style.display=`none`,document.getElementById(`etapa-3-sucesso`).style.display=`block`,typeof confetti==`function`&&confetti(),typeof gtag==`function`&&gtag(`event`,`generate_lead`,{currency:`BRL`,value:0,tipo_conta:`App Gestão PTT`})):r.showToast(i.error||`Dados incorretos.`,`error`)}catch{r.showToast(`Erro de servidor.`,`error`)}finally{i.innerText=a,i.disabled=!1}},renderizarTela:async(e,t=!1)=>{if(!r.usuario&&e!==`login`){r.showToast(`Sessão expirada. Faça login novamente.`,`error`),r.logout();return}document.querySelector(`.sidebar`)&&document.querySelector(`.sidebar`).classList.remove(`active`),document.querySelector(`.mobile-overlay`)&&document.querySelector(`.mobile-overlay`).classList.remove(`active`);let n=r.usuario?r.usuario.tipo:`Gestor`,i=[`mensalidades`,`inadimplencia`,`configuracoes`,`aparencia`,`backup`,`plano`,`financeiro`,`dossie`,`documentos`,`ficha`,`conta`],a=[`configuracoes`,`aparencia`,`backup`,`plano`,`dossie`,`conta`];if(n===`Professor`&&i.includes(e))return r.showToast(`🚫 Acesso restrito. Perfil de Professor não tem permissão para esta área.`,`error`),r.renderizarInicio();if(n===`Secretaria`&&a.includes(e))return r.showToast(`🚫 Acesso restrito. Perfil de Secretaria não tem permissão para esta área.`,`error`),r.renderizarInicio();!t&&e!==`login`&&e!==`inicio`?window.history.pushState({tela:e},``,`#${e}`):!t&&e===`inicio`&&window.history.pushState({tela:`inicio`},``,window.location.pathname),typeof gtag==`function`&&gtag(`event`,`page_view`,{page_title:`Tela: `+e,page_location:window.location.href+`#`+e,page_path:`/`+e}),e===`chamada`?(r.setTitulo(`Chamada`),r.renderizarChamadaPro()):e===`avaliacoes`?(r.setTitulo(`Notas`),r.renderizarAvaliacoesPro()):e===`calendario`?(r.setTitulo(`Calendário`),r.renderizarCalendarioPro()):e===`planejamento`?(r.setTitulo(`Planejamento`),r.renderizarPlanejamentoPro()):e===`boletins`?(r.setTitulo(`Boletim`),r.renderizarBoletimVisual()):e===`mensalidades`?(r.setTitulo(`Financeiro`),r.renderizarFinanceiroPro()):e===`inadimplencia`?(r.setTitulo(`Inadimplência`),r.renderizarInadimplencia()):e===`configuracoes`?(r.setTitulo(`Configurações`),r.renderizarConfiguracoes()):e===`aparencia`?r.renderizarConfiguracoesAparencia():e===`backup`?r.renderizarBackup():e===`plano`?r.renderizarMeuPlano():r.renderizarInicio()},renderizarConfig:e=>{e===`perfil`?r.renderizarTela(`configuracoes`):e===`aparencia`?r.renderizarTela(`aparencia`):e===`conta`?r.renderizarMinhaConta():e===`backup`&&r.renderizarTela(`backup`)},renderizarRelatorio:e=>{e===`dossie`&&!r.verificarPermissao(`dossie`)||typeof r.renderizarRelatorioModulo==`function`&&r.renderizarRelatorioModulo(e)},renderizarMeuPlano:()=>{r.setTitulo(`Gerenciar Assinatura`);let e=document.getElementById(`app-content`),t=r.getPlanoAtual(),n=0,i=JSON.parse(localStorage.getItem(r.getTenantKey(`escola_perfil`)))||{},a=new Date().getTime();if(t===`Teste`){let e=i.dataCriacao?new Date(i.dataCriacao).getTime():a,t=Math.abs(a-e);n=7-Math.floor(t/(1e3*60*60*24))}else if(i.dataExpiracao){let e=new Date(i.dataExpiracao).getTime()-a;n=Math.ceil(e/(1e3*60*60*24))}else if(i.dataCriacao){let e=Math.abs(a-new Date(i.dataCriacao).getTime());n=30-Math.floor(e/(1e3*60*60*24))}n<0&&(n=0);let o=t===`Premium`?`#f39c12`:t===`Profissional`?`#3498db`:`#27ae60`;e.innerHTML=`
        ...
        `},sairDaTelaDeBloqueio:()=>{l.logout()},ativarPinLogin:async e=>{e&&e.preventDefault();let t=document.getElementById(`input-pin-login`);if(!t)return;let n=t.value.trim().toUpperCase();if(!n)return l.showToast(`Por favor, insira o PIN recebido no e-mail.`,`warning`);let r=e.target,i=r.innerText;r&&(r.innerText=`A validar... ⏳`,r.disabled=!0);try{let e=await l.api(`/escola/validar-pin`,`POST`,{pin:n}),t=e&&e.success?e.plano:null;if(!t)if(n.includes(`PRE`))t=`Premium`;else if(n.includes(`ESS`))t=`Essencial`;else if(n.includes(`PRO`))t=`Profissional`;else{l.showToast(e.error||`PIN inválido ou formato incorreto.`,`error`),r&&(r.innerText=i,r.disabled=!1);return}let a=await l.api(`/escola`)||{},o=new Date;o.setDate(o.getDate()+30),await l.api(`/escola`,`PUT`,{...a,plano:t,pinUsado:n,dataExpiracao:o.toISOString()}),localStorage.setItem(l.getTenantKey(`escola_plano`),t);let s=JSON.parse(localStorage.getItem(l.getTenantKey(`escola_perfil`)))||{};s.plano=t,s.dataExpiracao=o.toISOString(),localStorage.setItem(l.getTenantKey(`escola_perfil`),JSON.stringify(s)),typeof l.atualizarUIHeader==`function`&&l.atualizarUIHeader(s),l.showToast(`🎉 PIN validado! Sistema desbloqueado por mais 30 dias.`,`success`);let c=document.getElementById(`box-bloqueio-conta`);c&&(c.style.display=`none`),l.entrarNoSistema()}catch{l.showToast(`Erro ao comunicar com a base de dados.`,`error`)}finally{r&&(r.innerText=i,r.disabled=!1)}},init:async()=>{localStorage.removeItem(`escola_tema`),localStorage.removeItem(`escola_atalhos`),localStorage.removeItem(`escola_perfil`);let e=new URLSearchParams(window.location.search).get(`reset`);if(e){document.documentElement.removeAttribute(`style`),document.getElementById(`tela-login`).style.display=`flex`,document.getElementById(`tela-sistema`).style.display=`none`,setTimeout(()=>{l.abrirModalNovaSenha(e)},300);return}let t=localStorage.getItem(`usuario_logado`),n=localStorage.getItem(`escola_bio_id`);if(t){l.usuario=JSON.parse(t),typeof l.aplicarTemaSalvo==`function`&&l.aplicarTemaSalvo();let e=l.getTenantKey(`escola_atalhos`);if(localStorage.getItem(e)||localStorage.setItem(e,JSON.stringify([`novo_aluno`,`fin_carne`,`ped_chamada`,`ped_notas`,`ped_plan`,`ped_bol`])),n&&window.PublicKeyCredential)document.getElementById(`tela-login`).style.display=`none`,document.getElementById(`tela-sistema`).style.display=`none`,l.exibirTelaTouchBiometria();else{document.getElementById(`tela-login`)?.style.setProperty(`display`,`none`),document.getElementById(`tela-sistema`)?.style.setProperty(`display`,`flex`);let e=document.getElementById(`user-name`);e&&l.usuario&&(e.innerText=l.usuario.nome||l.usuario.login),typeof l.aplicarPermissoesDeUsuario==`function`&&l.aplicarPermissoesDeUsuario(),typeof l.setupMobileMenu==`function`&&l.setupMobileMenu();let t=window.location.hash.replace(`#`,``);t&&t!==`login`?setTimeout(()=>{typeof l.renderizarTela==`function`&&l.renderizarTela(t,!0)},10):typeof l.renderizarInicio==`function`&&l.renderizarInicio()}setTimeout(async()=>{let e=await l.api(`/escola`,`GET`,null,!0);if(!e||e.error){if(e?.error===`Sessão não encontrada.`||e?.error===`Sessão expirada.`){l.showToast(`Sessão expirada por segurança. Faça login novamente.`,`warning`),await l.logout();return}}else localStorage.setItem(l.getTenantKey(`escola_plano`),e.plano),localStorage.setItem(l.getTenantKey(`escola_perfil`),JSON.stringify(e)),typeof l.atualizarUIHeader==`function`&&l.atualizarUIHeader(e),typeof l.verificarBloqueioGeral==`function`&&l.verificarBloqueioGeral(e)&&(document.documentElement.removeAttribute(`style`),l.mostrarTelaBloqueioLogin(e))},1e3)}else document.documentElement.removeAttribute(`style`),document.getElementById(`tela-login`).style.display=`flex`,document.getElementById(`tela-sistema`).style.display=`none`;let r=document.getElementById(`data-hoje`);r&&(r.innerText=new Date().toLocaleDateString(`pt-BR`));let i=document.getElementById(`login-pass`);if(i&&i.addEventListener(`keypress`,function(e){e.key===`Enter`&&l.fazerLogin()}),!l.motorTempoRealLigado){let e=()=>{let e=document.getElementById(`tela-sistema`);l.usuario&&e&&e.style.display!==`none`&&document.visibilityState===`visible`&&(typeof l.verificarNovidadesSilenciosamente==`function`&&l.verificarNovidadesSilenciosamente(),typeof l.carregarDadosEscola==`function`&&l.carregarDadosEscola(!0))};setTimeout(e,2e3),setInterval(e,1e4),l.motorTempoRealLigado=!0}},fazerLogin:async()=>{let e=document.getElementById(`login-user`).value.trim(),t=document.getElementById(`login-pass`).value.trim();if(!e||!t)return l.showToast(`Preencha utilizador e senha`,`warning`);let n=document.querySelector(`#tela-login button[type="submit"]`),r=n.innerText;n.innerText=`Autenticando... ⏳`,n.disabled=!0;try{let n=l.getDeviceId?l.getDeviceId():`dev_web`,r=await l.api(`/auth/login`,`POST`,{login:e,senha:t,deviceId:n});if(r&&r.success){l.usuario=r.usuario,localStorage.setItem(`usuario_logado`,JSON.stringify(r.usuario)),typeof gtag==`function`&&gtag(`event`,`login`,{method:`Sistema PTT`}),typeof l.aplicarTemaSalvo==`function`&&l.aplicarTemaSalvo();let e=l.getTenantKey(`escola_atalhos`);localStorage.getItem(e)||localStorage.setItem(e,JSON.stringify([`novo_aluno`,`fin_carne`,`ped_chamada`,`ped_notas`,`ped_plan`,`ped_bol`]));let t=await l.api(`/escola`);if(!t||t.error){if(t?.error===`Sessão não encontrada.`||t?.error===`Sessão expirada.`){await l.logout();return}t=JSON.parse(localStorage.getItem(l.getTenantKey(`escola_perfil`)))||{}}if(typeof l.verificarBloqueioGeral==`function`&&l.verificarBloqueioGeral(t))l.mostrarTelaBloqueioLogin(t);else{l.entrarNoSistema();let e=window.location.hash.replace(`#`,``);e&&e!==`login`&&setTimeout(()=>{typeof l.renderizarTela==`function`&&l.renderizarTela(e,!0)},100),l.showToast(`Bem-vindo ao sistema!`,`success`)}}else l.showToast(r.error||`Login ou senha incorretos`,`error`)}catch{l.showToast(`Erro ao conectar no servidor`,`error`)}finally{n.innerText=r,n.disabled=!1}},entrarNoSistema:async()=>{document.getElementById(`tela-login`)?.style.setProperty(`display`,`none`),document.getElementById(`tela-sistema`)?.style.setProperty(`display`,`flex`);let e=document.getElementById(`user-name`);e&&l.usuario&&(e.innerText=l.usuario.nome||l.usuario.login),typeof l.aplicarPermissoesDeUsuario==`function`&&l.aplicarPermissoesDeUsuario(),typeof l.setupMobileMenu==`function`&&l.setupMobileMenu(),typeof l.carregarDadosEscola==`function`&&await l.carregarDadosEscola(!0);let t=document.getElementById(`tela-sistema`);t&&t.style.display!==`none`&&!window.location.hash&&typeof l.renderizarInicio==`function`&&l.renderizarInicio()},logout:async()=>{l.radarAtivo&&clearInterval(l.radarAtivo);try{typeof l.api==`function`?await l.api(`/auth/logout`,`POST`):await fetch(`/api/auth/logout`,{method:`POST`,credentials:`include`})}catch{console.warn(`Logout silencioso.`)}localStorage.clear(),sessionStorage.clear(),l.usuario=null,l.listaCache=[],window.location.href=window.location.pathname},toggleSenhaLogin:()=>{let e=document.getElementById(`login-pass`);e&&(e.type=e.type===`password`?`text`:`password`)},abrirModalRecuperacao:e=>{e&&e.preventDefault();let t=document.getElementById(`modal-recuperacao-senha`);t||(t=document.createElement(`div`),t.id=`modal-recuperacao-senha`,t.style.cssText=`position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.8); display:flex; justify-content:center; align-items:center; z-index:9999;`,t.innerHTML=`
            ...
            `,document.body.appendChild(t)),l.tokenResetSenha=e,t.style.display=`flex`},confirmarNovaSenhaReset:async()=>{let e=document.getElementById(`nova-senha-reset`)?.value||``,t=document.getElementById(`confirma-senha-reset`)?.value||``;if(e.length<6)return l.showToast(`Mínimo de 6 caracteres.`,`warning`);if(e!==t)return l.showToast(`As senhas não conferem.`,`warning`);let n=document.querySelector(`#modal-nova-senha .btn-primary`),r=n.innerText;n.innerText=`Salvando... ⏳`,n.disabled=!0;try{let t=await l.api(`/auth/redefinir-senha`,`POST`,{token:l.tokenResetSenha,novaSenha:e});if(t&&t.success){l.showToast(`Senha redefinida! Faça login agora.`,`success`),document.getElementById(`modal-nova-senha`).style.display=`none`,l.tokenResetSenha=null;let e=window.location.origin+window.location.pathname;window.history.replaceState({},document.title,e)}else l.showToast(t.error||`Erro ao redefinir.`,`error`)}catch{l.showToast(`Erro de comunicação.`,`error`)}finally{n.innerText=r,n.disabled=!1}},bufferToBase64:function(e){for(var t=new Uint8Array(e),n=``,r=0;r<t.byteLength;r++)n+=String.fromCharCode(t[r]);return btoa(n)},base64ToBuffer:function(e){for(var t=atob(e),n=t.length,r=new Uint8Array(n),i=0;i<n;i++)r[i]=t.charCodeAt(i);return r},renderizarMinhaConta:async()=>{typeof l.setTitulo==`function`&&l.setTitulo(`Gestão de Usuários`);let e=document.getElementById(`app-content`);l.idEdicaoUsuario=null;let t=l.usuario?l.usuario.login:``,n=l.usuario&&l.usuario.email?l.usuario.email:``,r=(e,t)=>`<div class="input-group" style="position:relative;"><label>${t}</label><input type="password" id="${e}" style="width:100%; padding-right:40px;"><span onclick="App.toggleSenhaVisibilidade('${e}')" style="position:absolute; right:12px; top:32px; cursor:pointer; font-size:16px; opacity:0.6; user-select:none;" title="Mostrar/Ocultar Senha">👁️</span></div>`;try{let i=await l.api(`/usuarios`),a=(Array.isArray(i)?i:[]).filter(e=>e.id===l.usuario.id||String(e.donoId)===String(l.usuario.id)),o=localStorage.getItem(`escola_bio_id`)?`<div style="background: #eafaf1; border: 1px solid #27ae60; color: #27ae60; padding: 10px; border-radius: 8px; margin-bottom: 15px; font-weight: bold; text-align: center; font-size:13px;">✅ Biometria Ativada neste Aparelho</div>
                ...
                <div style="display:flex; gap:30px; flex-wrap:wrap;">
                    <div class="card" style="flex:1; height:fit-content; min-width:300px;">
                        <h3>Meus Dados de Acesso</h3>
                        <p style="font-size:12px; color:#666; margin-bottom:15px;">A senha atual é sempre obrigatória para salvar as alterações.</p>
                        <div class="input-group"><label>E-mail Dono da Conta</label><input type="email" id="user-novo-email" value="${l.escapeHTML(n)}" placeholder="Ex: gestor@escola.com" style="width:100%; border-left: 4px solid #f39c12;"></div>
                        <div class="input-group"><label>Login de Acesso</label><input type="text" id="user-novo-login" value="${l.escapeHTML(t)}" style="width:100%; border-left: 4px solid #3498db;"></div>
                    ...
                    <div class="card" style="flex:2; min-width:300px;">
                        ...
                        <div class="table-responsive-wrapper">
                            <table style="width:100%; text-align:left; border-collapse:collapse;">
                                <thead><tr><th style="padding-bottom:10px;">Nome</th><th style="padding-bottom:10px;">Login</th><th style="padding-bottom:10px;">Tipo</th><th style="text-align:right;">Ações</th></tr></thead>
                                <tbody>${a.map(e=>`<tr><td style="padding:10px 0; border-top:1px solid #eee;">${l.escapeHTML(e.nome)} ${e.isDono?`👑`:``}</td><td style="padding:10px 0; border-top:1px solid #eee;">${l.escapeHTML(e.login)}</td><td style="padding:10px 0; border-top:1px solid #eee;"><span style="background:#eee; padding:2px 6px; border-radius:4px; font-size:11px;">${l.escapeHTML(e.tipo)}</span></td><td style="text-align:right; border-top:1px solid #eee;"><button class="btn-edit" onclick="App.preencherEdicaoUsuario('${e.id}', '${l.escapeHTML(e.nome)}', '${l.escapeHTML(e.login)}', '${l.escapeHTML(e.tipo)}')">✏️</button>${e.isDono?``:`<button class="btn-del" onclick="App.excluirUsuario('${e.id}')">🗑️</button>`}</td></tr>`).join(``)}</tbody>
                            </table>
                        </div>
                    </div>
                </div>`}catch{e.innerHTML=`Erro ao carregar usuários.`}},desativarBiometria:()=>{localStorage.removeItem(`escola_bio_id`),l.showToast(`Acesso biométrico removido deste aparelho.`,`success`),typeof l.renderizarMinhaConta==`function`&&l.renderizarMinhaConta()},configurarBiometria:async()=>{if(!window.PublicKeyCredential)return l.showToast(`Biometria não suportada neste aparelho.`,`error`);try{l.exibirOverlayBiometria(`Configurar Acesso`,`Use o sensor digital para registrar este aparelho.`);let e=window.crypto.getRandomValues(new Uint8Array(32)),t=window.crypto.getRandomValues(new Uint8Array(16)),n=await navigator.credentials.create({publicKey:{challenge:e,rp:{name:`Sistema PTT`,id:window.location.hostname},user:{id:t,name:l.usuario.login,displayName:l.usuario.nome},pubKeyCredParams:[{type:`public-key`,alg:-7},{type:`public-key`,alg:-257}],authenticatorSelection:{authenticatorAttachment:`platform`,userVerification:`required`},timeout:6e4}});n&&(localStorage.setItem(`escola_bio_id`,l.bufferToBase64(n.rawId)),l.removerOverlayBiometria(),l.showToast(`✅ Biometria ativada com sucesso!`,`success`),typeof l.renderizarMinhaConta==`function`&&l.renderizarMinhaConta())}catch{l.removerOverlayBiometria(),l.showToast(`Configuração cancelada ou bloqueada.`,`warning`)}},exibirTelaTouchBiometria:()=>{let e=document.getElementById(`bio-touch-screen`);e||(e=document.createElement(`div`),e.id=`bio-touch-screen`,e.style.cssText=`position:fixed; top:0; left:0; width:100%; height:100%; background:#2c3e50; display:flex; flex-direction:column; justify-content:center; align-items:center; z-index:99999; cursor:pointer; color:white; transition: opacity 0.3s;`,e.innerHTML=`
            ...
            `,document.body.appendChild(e)),e.style.display=`flex`,e.onclick=e=>{e.target.tagName!==`BUTTON`&&l.entrarComBiometria()}},cancelarTouchBiometria:e=>{e&&e.stopPropagation();let t=document.getElementById(`bio-touch-screen`);t&&(t.style.display=`none`),document.documentElement.removeAttribute(`style`),document.getElementById(`tela-login`).style.display=`flex`,document.getElementById(`tela-sistema`).style.display=`none`},entrarComBiometria:async()=>{let e=localStorage.getItem(`escola_bio_id`);if(e)try{l.exibirOverlayBiometria(`Autenticação`,`Aguardando leitura do sensor...`);let t=window.crypto.getRandomValues(new Uint8Array(32)),n=l.base64ToBuffer(e);if(await navigator.credentials.get({publicKey:{challenge:t,rpId:window.location.hostname,allowCredentials:[{type:`public-key`,id:n}],userVerification:`required`,timeout:6e4}})){l.removerOverlayBiometria();let e=document.getElementById(`bio-touch-screen`);e&&(e.style.display=`none`),l.showToast(`🔓 Bem-vindo de volta!`,`success`),l.entrarNoSistema()}}catch(e){l.removerOverlayBiometria(),e.name===`NotAllowedError`?l.showToast(`Toque no botão para entrar com Biometria.`,`info`):l.showToast(`A leitura falhou. Use a sua senha.`,`info`)}},exibirOverlayBiometria:(e,t)=>{let n=document.getElementById(`bio-overlay-premium`);n||(n=document.createElement(`div`),n.id=`bio-overlay-premium`,n.style.cssText=`position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.85); backdrop-filter:blur(8px); display:flex; justify-content:center; align-items:center; z-index:100000;`,document.body.appendChild(n)),n.innerHTML=`
        ...
        `,n.style.display=`flex`},removerOverlayBiometria:()=>{let e=document.getElementById(`bio-overlay-premium`);e&&(e.style.display=`none`)},atualizarMeusDados:async()=>{let e=document.getElementById(`user-novo-login`).value.trim(),t=document.getElementById(`user-novo-email`).value.trim(),n=document.getElementById(`user-senha-atual`).value,r=document.getElementById(`user-nova-senha`).value,i=document.getElementById(`user-conf-senha`).value;if(!e)return l.showToast(`O login não pode ficar em branco.`,`error`);if(!n)return l.showToast(`Digite sua senha atual para autorizar as alterações.`,`error`);if(r&&r!==i)return l.showToast(`A nova senha e a confirmação não conferem.`,`error`);let a=document.querySelector(`button[onclick="App.atualizarMeusDados()"]`),o=a.innerText;a.innerText=`Atualizando... ⏳`,a.disabled=!0;try{let i={novoLogin:e,novoEmail:t,senhaAtual:n};r&&(i.novaSenha=r);let a=await l.api(`/usuarios/atualizar-conta`,`PUT`,i);a&&a.success?(l.showToast(`Dados atualizados com sucesso! Faça login novamente.`,`success`),setTimeout(()=>l.logout(),2500)):l.showToast(a.error||`Erro ao atualizar os dados.`,`error`)}catch{l.showToast(`Erro de conexão.`,`error`)}finally{a.innerText=o,a.disabled=!1}},salvarNovoUsuario:async()=>{let e=document.getElementById(`new-nome`).value,t=document.getElementById(`new-login`).value,n=document.getElementById(`new-senha`).value,r=document.getElementById(`new-tipo`).value;if(!e||!t)return l.showToast(`Preencha nome e login.`,`error`);if(!l.idEdicaoUsuario&&!n)return l.showToast(`Digite uma senha.`,`error`);let i={nome:e,login:t,tipo:r};if(n&&(i.senha=n),!l.idEdicaoUsuario){if(!await l.verificarLimites(`usuario`))return;i.donoId=l.usuario.id}let a=document.getElementById(`btn-save-user`),o=a?a.innerText:`CRIAR USUÁRIO`;a&&(a.innerText=`Salvando... ⏳`,a.disabled=!0),document.body.style.cursor=`wait`;try{let e;e=l.idEdicaoUsuario?await l.api(`/usuarios/${l.idEdicaoUsuario}`,`PUT`,i):await l.api(`/usuarios`,`POST`,i),e&&e.error?l.showToast(e.error,`error`):(l.showToast(l.idEdicaoUsuario?`Atualizado com sucesso!`:`Criado com sucesso!`,`success`),l.renderizarMinhaConta())}catch{l.showToast(`Erro crítico ao salvar.`,`error`)}finally{a&&(a.innerText=o,a.disabled=!1),document.body.style.cursor=`default`}},preencherEdicaoUsuario:(e,t,n,r)=>{l.idEdicaoUsuario=e,document.getElementById(`new-nome`).value=t,document.getElementById(`new-login`).value=n,document.getElementById(`new-senha`).value=``,document.getElementById(`new-tipo`).value=r,document.getElementById(`titulo-form-user`).innerText=`Editar Usuário`,document.getElementById(`btn-save-user`).innerText=`ATUALIZAR`,document.getElementById(`btn-cancel-user`).style.display=`inline-flex`},cancelarEdicaoUsuario:()=>{l.idEdicaoUsuario=null,document.getElementById(`new-nome`).value=``,document.getElementById(`new-login`).value=``,document.getElementById(`new-senha`).value=``,document.getElementById(`new-tipo`).value=`Gestor`,document.getElementById(`titulo-form-user`).innerText=`Novo Usuário`,document.getElementById(`btn-save-user`).innerText=`CRIAR USUÁRIO`,document.getElementById(`btn-cancel-user`).style.display=`none`},excluirUsuario:e=>{l.abrirModalConfirmacao(`Apagar Utilizador?`,`Deseja remover o acesso deste membro da equipe? A ação não pode ser desfeita.`,async t=>{document.body.style.cursor=`wait`;try{let t=await l.api(`/usuarios/${e}`,`DELETE`);t&&t.error?l.showToast(t.error,`error`):(l.showToast(`Utilizador excluído.`,`success`),l.renderizarMinhaConta())}catch{l.showToast(`Erro ao excluir.`,`error`)}finally{document.body.style.cursor=`default`,t.style.opacity=`0`,setTimeout(()=>t.style.display=`none`,300)}})}});var u=t({cobrarWhatsAppDashboard:()=>h,renderizarInicio:()=>m});window.App=window.App||{};var d=window.App,f=(e,t,n)=>`
...
`,m=async()=>{d.verificarNotificacoes(),d.setTitulo(`Visão Geral`);let e=document.getElementById(`app-content`);e.innerHTML=`<p style="padding:20px; text-align:center; color:#666;">Carregando painel de métricas...</p>`;try{let[t,n,r,i]=await Promise.all([d.api(`/alunos`),d.api(`/financeiro`),d.api(`/turmas`),d.api(`/cursos`)]),a=(Array.isArray(t)?t:[]).filter(e=>!e.status||e.status===`Ativo`),o=Array.isArray(n)?n:[],s=Array.isArray(r)?r:[],c=Array.isArray(i)?i:[],l=new Date,u=l.getMonth()+1,m=l.getFullYear(),h=a.map(e=>e.id),g=o.filter(e=>{if(!e.vencimento)return!1;let t=e.vencimento.split(`-`);return parseInt(t[1])===u&&parseInt(t[0])===m}),_=g.filter(e=>e.status===`Pago`).reduce((e,t)=>e+parseFloat(t.valor),0),v=g.filter(e=>e.status!==`Pago`&&h.includes(e.idAluno)).reduce((e,t)=>e+parseFloat(t.valor),0),y=o.filter(e=>e.status===`Pendente`&&new Date(e.vencimento+`T00:00:00`)<l&&h.includes(e.idAluno)).sort((e,t)=>new Date(e.vencimento)-new Date(t.vencimento)),b=e=>e.toLocaleString(`pt-BR`,{minimumFractionDigits:2,maximumFractionDigits:2}),x=d.usuario?d.usuario.tipo:`Gestor`,S=x!==`Professor`,C=y.length===0?`<div style="text-align:center; padding:20px; color:#27ae60; font-weight:bold; font-size:14px;">🎉 Excelente! Nenhum título em atraso.</div>`:y.map(e=>{let t=(a.find(t=>t.id===e.idAluno)||{}).whatsapp||``,n=e.vencimento.split(`-`).reverse().join(`/`),r=b(parseFloat(e.valor));return p(e.alunoNome||`Desconhecido`,n,r,t)}).join(``),w=JSON.parse(localStorage.getItem(d.getTenantKey(`escola_atalhos`)));(!w||!Array.isArray(w)||w.length===0)&&(w=[`novo_aluno`,`fin_carne`,`ped_chamada`,`ped_notas`,`ped_plan`,`ped_bol`]);let T=w.map(e=>{let t=(window.LISTA_FUNCIONALIDADES||[]).find(t=>t.id===e);return t&&t.roles.includes(x)?`<div class="shortcut-btn" onclick="${t.acao}"><div>${t.icon}</div><span>${t.nome}</span></div>`:``}).join(``);if(e.innerHTML=`
    ...
    `;if(a&&(a.innerHTML=s),o){o.innerText=`SIM, EXCLUIR 🗑️`,o.style.background=`#c0392b`;let r=o.cloneNode(!0);o.parentNode.replaceChild(r,o),r.onclick=async()=>{let i=r.innerText;r.innerText=`A excluir... ⏳`,r.disabled=!0,document.body.style.cursor=`wait`;try{let r=Array.from(t).map(e=>x.api(`/${n}/${e.value}`,`DELETE`));await Promise.all(r),x.showToast(`Registos excluídos com sucesso!`,`success`),x.fecharModal();let i=document.getElementById(`app-content`);i&&(i.innerHTML=`<p style="text-align:center; color:#666; padding:20px;">Atualizando lista... ⏳</p>`),await x.renderizarLista(e)}catch{x.showToast(`Erro ao processar exclusão.`,`error`),r.innerText=i,r.disabled=!1}finally{document.body.style.cursor=`default`,setTimeout(()=>{r&&(r.style.background=``)},500)}}}},window.App=window.App||{};var w=window.App;Object.assign(w,{renderizarWorkspaceAdmin:async()=>{w.setTitulo(`Gestão do Workspace`);let e=document.getElementById(`app-content`);e.innerHTML=`<p style="text-align:center; padding:40px; color:#666;">A carregar alunos e acessos... ⏳</p>`;try{let[t,n]=await Promise.all([w.api(`/alunos`),w.api(`/usuarios`)]),r=t.filter(e=>!e.status||e.status===`Ativo`),i=n.filter(e=>e.tipo===`Aluno`||e.alunoRefId),a=`
                <div class="card" style="animation: fadeIn 0.3s ease;">
                    ...
                    <div class="table-responsive-wrapper">
                        <table style="width:100%; text-align:left; border-collapse:collapse;">
                            ...
                            <tbody>
            `;r.forEach(e=>{let t=i.find(t=>t.alunoRefId===e.id),n=t?`<span style="background:#eafaf1; color:#27ae60; padding:4px 8px; border-radius:6px; font-size:12px; font-weight:bold; border:1px solid #2ecc71;">✅ ${w.escapeHTML(t.login)}</span>`:`<span style="background:#fdf2f2; color:#e74c3c; padding:4px 8px; border-radius:6px; font-size:12px; font-weight:bold; border:1px solid #e74c3c;">❌ Sem Acesso</span>`,r=t?`<button class="btn-cancel" style="padding:6px 12px; font-size:12px; width:auto;" onclick="App.excluirAcessoWorkspace('${t.id}')">Revogar Acesso</button>`:`<button class="btn-primary" style="padding:6px 12px; font-size:12px; width:auto;" onclick="App.abrirModalAcessoWorkspace('${e.id}', '${w.escapeHTML(e.nome)}')">Gerar Acesso</button>`;a+=`
                    <tr style="border-bottom:1px solid #f9f9f9;">
                        <td style="padding:12px 10px; font-size:14px; font-weight:500;">${w.escapeHTML(e.nome)}</td>
                        <td style="padding:12px 10px;">${n}</td>
                        <td style="padding:12px 10px; text-align:right;">${r}</td>
                    </tr>
                `}),a+=`</tbody></table></div></div>`,e.innerHTML=a}catch{e.innerHTML=`<p style="color:#e74c3c; text-align:center; padding:40px;">Erro ao carregar a lista de alunos.</p>`}},abrirModalAcessoWorkspace:(e,t)=>{let n=document.getElementById(`modal-acesso-ws`);n||(n=document.createElement(`div`),n.id=`modal-acesso-ws`,n.style.cssText=`position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.8); display:flex; justify-content:center; align-items:center; z-index:9999;`,document.body.appendChild(n));let r=t.split(` `),i=(r[0]+(r.length>1?r[r.length-1]:``)).toLowerCase().replace(/[^a-z0-9]/g,``)+Math.floor(100+Math.random()*900);n.innerHTML=`
            <div style="background:#fff; padding:30px; border-radius:12px; max-width:400px; width:90%; box-shadow:0 10px 25px rgba(0,0,0,0.2);">
                ...
                <p style="font-size:13px; color:#666; text-align:center; margin-bottom:20px;">Crie as credenciais para:<br><strong style="color:#3498db; font-size:15px;">${t}</strong></p>
                
                <div class="input-group" style="margin-bottom:15px;">
                    <label>Login de Acesso</label>
                    <input type="text" id="ws-input-login" value="${i}" style="width:100%; padding:10px; border:1px solid #ccc; border-radius:6px;">
                </div>
                ...
                <div style="display:flex; gap:10px;">
                    ...
                    <button class="btn-primary" id="ws-btn-salvar-acesso" style="flex:1; justify-content:center;" onclick="App.salvarAcessoWorkspace('${e}', '${t}')">💾 Guardar</button>
                </div>
            </div>
        `,n.style.display=`flex`},salvarAcessoWorkspace:async(e,t)=>{let n=document.getElementById(`ws-input-login`).value.trim(),r=document.getElementById(`ws-input-senha`).value.trim();if(!n||r.length<6)return w.showToast(`Preencha o login e uma senha (mín. 6 caracteres).`,`warning`);let i=document.getElementById(`ws-btn-salvar-acesso`),a=i.innerHTML;i.innerHTML=`A salvar... ⏳`,i.disabled=!0;try{let i={nome:t,login:n,senha:r,tipo:`Aluno`,alunoRefId:e},a=await w.api(`/usuarios`,`POST`,i);a&&a.error?w.showToast(a.error,`error`):(w.showToast(`✅ Acesso criado com sucesso!`,`success`),document.getElementById(`modal-acesso-ws`).style.display=`none`,w.renderizarWorkspaceAdmin())}catch{w.showToast(`Erro de ligação.`,`error`)}finally{i.innerHTML=a,i.disabled=!1}},excluirAcessoWorkspace:e=>{w.abrirModalConfirmacao(`Revogar Acesso?`,`O aluno perderá o acesso ao Workspace. Esta ação não apaga os dados escolares do aluno, apenas o login.`,async t=>{document.body.style.cursor=`wait`;try{await w.api(`/usuarios/${e}`,`DELETE`),w.showToast(`Acesso revogado.`,`success`),w.renderizarWorkspaceAdmin()}catch{w.showToast(`Erro ao revogar.`,`error`)}finally{document.body.style.cursor=`default`,t.style.display=`none`}})}});var T=t({});window.App=window.App||{};var E=window.App;if(E.renderizarFinanceiroPro=async()=>{E.setTitulo(`Financeiro`);let e=document.getElementById(`app-content`);e.innerHTML=`<p style="text-align:center; color:#666; padding:20px;">Carregando dados financeiros...</p>`;try{let[t,n,r]=await Promise.all([E.api(`/turmas`),E.api(`/financeiro`),E.api(`/alunos`)]),i=r.filter(e=>!e.status||e.status===`Ativo`).map(e=>e.id),a=n.filter(e=>!(e.status===`Pendente`&&!i.includes(e.idAluno)));E.financeiroCache=a.sort((e,t)=>e.status===t.status?new Date(e.vencimento)-new Date(t.vencimento):e.status===`Pendente`?-1:1),E.UI.input;let o=E.UI.botao,s=(e,t,n)=>`
            ...
            <div style="display:flex; gap:20px; align-items:flex-end; flex-wrap:wrap;">
                <div style="flex:2; min-width:250px;">
                    ...
                    <select id="fin-aluno" style="width:100%; padding:10px; border:1px solid #ccc; border-radius:5px;">${`<option value="">-- Selecione --</option>`+r.filter(e=>!e.status||e.status===`Ativo`).map(e=>`<option value="${e.id}">${E.escapeHTML(e.nome)}</option>`).join(``)}</select>
                </div>
        ...
        `,u=new Set,d=new Date().getFullYear();u.add(d),a.forEach(e=>{e.vencimento&&u.add(parseInt(e.vencimento.split(`-`)[0]))});let f=`<option value="" selected>Todos os Anos</option>`+Array.from(u).sort((e,t)=>t-e).map(e=>`<option value="${e}">${e}</option>`).join(``),p=`<option value="" selected>Todos os Meses</option>`+[`Janeiro`,`Fevereiro`,`Março`,`Abril`,`Maio`,`Junho`,`Julho`,`Agosto`,`Setembro`,`Outubro`,`Novembro`,`Dezembro`].map((e,t)=>`<option value="${(t+1).toString().padStart(2,`0`)}">${e}</option>`).join(``),m=`
          <div style="display:flex; gap:10px; flex-wrap:wrap; margin-top:5px;">
            ...
            <div id="fin-lista-area" class="table-responsive-wrapper" style="overflow-x:auto;">
                ${E.gerarTabelaFinanceira(E.financeiroCache)}
            </div>
        `;e.innerHTML=`
            ...
            ${E.UI.card(``,``,m)}
        `}catch{e.innerHTML=`Erro ao carregar dados financeiros.`}},E.gerarTabelaFinanceira=e=>{if(!e||e.length===0)return`<p style="text-align:center; padding:20px; color:#999;">Nenhum lançamento encontrado.</p>`;let t=(e,t=`center`)=>`<th style="padding:12px; text-align:${t}; border-bottom:2px solid #eee;">${e}</th>`,n=`<tr style="background:#f4f6f7; color:#7f8c8d; text-transform:uppercase; font-size:12px;">
        ...
        <tr style="border-bottom:1px solid #eee; ${s} transition:background 0.2s;">
            ...
            <td style="padding:12px; font-weight:bold;">${E.escapeHTML(e.alunoNome)}</td>
            <td style="padding:12px; text-align:center;">${E.escapeHTML(u)}</td>
        ...
        </tr>`}).join(``)}</tbody></table>`},E.filtrarFinanceiro=()=>{let e=document.getElementById(`fin-busca`),t=document.getElementById(`fin-filtro-mes`),n=document.getElementById(`fin-filtro-ano`),r=document.getElementById(`fin-filtro-status`),i=e?e.value.toLowerCase():``,a=t?t.value:``,o=n?n.value:``,s=r?r.value:``,c=E.financeiroCache.filter(e=>{let t=!i||e.alunoNome&&e.alunoNome.toLowerCase().includes(i)||e.descricao&&e.descricao.toLowerCase().includes(i),n=e.vencimento||``,r=n.substring(0,4),c=n.substring(5,7),l=!o||r===o,u=!a||c===a,d=!s||e.status===s;return t&&l&&u&&d});a||o||s?c.sort((e,t)=>new Date(t.vencimento)-new Date(e.vencimento)):c.sort((e,t)=>e.status===t.status?new Date(e.vencimento)-new Date(t.vencimento):e.status===`Pendente`?-1:1),document.getElementById(`fin-lista-area`).innerHTML=E.gerarTabelaFinanceira(c)},E.filaBaixa={modo:``,itens:[],index:0},E.abrirModalBaixa=()=>{let e=document.querySelectorAll(`.fin-check:checked`);if(e.length===0)return E.showToast(`Selecione pelo menos um lançamento para dar baixa.`,`warning`);let t=Array.from(e).map(e=>E.financeiroCache.find(t=>t.id==e.value)).filter(e=>e);if(t.length===1)E.filaBaixa={modo:`single`,itens:t,index:0},E.montarTelaBaixa();else{E.filaBaixa={modo:`escolha`,itens:t,index:0};let e=document.getElementById(`modal-overlay`);e&&(e.style.display=`flex`),document.getElementById(`modal-titulo`).innerText=`Múltiplas Baixas (${t.length} itens)`,document.getElementById(`modal-form-content`).innerHTML=`
        ...
        `;let n=document.querySelector(`.btn-confirm`);n&&(n.style.display=`none`)}},E.definirModoBaixa=e=>{E.filaBaixa.modo=e,E.filaBaixa.index=0,E.montarTelaBaixa()},E.montarTelaBaixa=()=>{let{modo:e,itens:t,index:n}=E.filaBaixa,r=document.getElementById(`modal-overlay`);r&&(r.style.display=`flex`);let i=document.querySelector(`.btn-confirm`);i&&(i.style.display=`inline-block`);let a=0,o=``,s=``,c=!0;if(e===`batch`){s=`Pagamento em Lote (${t.length} itens)`;let e=0;t.forEach(t=>e+=Math.round(parseFloat(t.valor)*100)),a=e/100,o=`
            ...
            <div style="background:#fdfefe; border:1px solid #dce1e6; padding:15px; border-radius:6px; margin-bottom:15px; border-left:4px solid #27ae60; display:flex; justify-content:space-between; align-items:center;">
                <div>
                    ...
                    <div style="font-size:16px; font-weight:bold; color:#2c3e50; margin-bottom:4px;">${E.escapeHTML(r.alunoNome)}</div>
                    <div style="font-size:13px; color:#555;">📄 ${E.escapeHTML(r.descricao)}</div>
                </div>
            ...
            </div>`,i.innerText=e===`queue`&&!c?`CONFIRMAR E PRÓXIMO ⏭️`:`CONFIRMAR PAGAMENTO ✅`}document.getElementById(`modal-titulo`).innerText=s;let l=E.UI.input,u=(e,t,n,r=``)=>`
        ...
        </div>`;document.getElementById(`modal-form-content`).innerHTML=p,i.setAttribute(`onclick`,`App.confirmarBaixa()`)},E.aplicarJurosBaixa=()=>{let e=parseFloat(document.getElementById(`baixa-total-original`).value),t=parseFloat(document.getElementById(`baixa-juros`).value)||0;t<0&&(t=0,document.getElementById(`baixa-juros`).value=0);let n=e+t/100*e;document.getElementById(`baixa-display-total`).innerText=`R$ ${n.toLocaleString(`pt-BR`,{minimumFractionDigits:2})}`,document.getElementById(`baixa-total`).value=n.toFixed(2),document.getElementById(`baixa-qtd`).value===`1`?document.getElementById(`baixa-valor-1`).value=n.toFixed(2):E.calcValorBaixa()},E.mudarQtdFormasBaixa=()=>{let e=document.getElementById(`baixa-qtd`).value,t=document.getElementById(`forma-2-container`),n=document.getElementById(`baixa-valor-1`),r=parseFloat(document.getElementById(`baixa-total`).value);e===`2`?(t.style.display=`grid`,n.value=(r/2).toFixed(2),E.calcValorBaixa()):(t.style.display=`none`,n.value=r.toFixed(2))},E.calcValorBaixa=()=>{if(document.getElementById(`baixa-qtd`).value===`2`){let e=Math.round(parseFloat(document.getElementById(`baixa-total`).value)*100)-(Math.round(parseFloat(document.getElementById(`baixa-valor-1`).value)*100)||0);e<0&&(e=0),document.getElementById(`baixa-valor-2`).value=(e/100).toFixed(2)}},E.confirmarBaixa=async()=>{let e=document.getElementById(`baixa-data`).value,t=document.getElementById(`baixa-qtd`).value,n=document.getElementById(`baixa-forma-1`).value,r=document.getElementById(`baixa-valor-1`).value,i=t===`2`?document.getElementById(`baixa-forma-2`).value:null,a=t===`2`?document.getElementById(`baixa-valor-2`).value:null;if(!e)return E.showToast(`Informe a data de pagamento.`,`error`);let o=document.querySelector(`.btn-confirm`),s=o.innerText;o.innerText=`A guardar... ⏳`,o.disabled=!0;let{modo:c,itens:l,index:u}=E.filaBaixa;try{let o=[];if(c===`batch`){let s=parseFloat(document.getElementById(`baixa-total-original`).value)||0;for(let c of l){let l=s>0?parseFloat(c.valor)/s:0,u=s>0?(parseFloat(r)*l).toFixed(2):`0.00`,d=t===`2`&&s>0?(parseFloat(a)*l).toFixed(2):null,f=(parseFloat(u)+(parseFloat(d)||0)).toFixed(2),p={...c,status:`Pago`,dataPagamento:e,formaPagamento:n,valorPago1:u,formaPagamento2:i,valorPago2:d,valor:f};o.push(E.api(`/financeiro/${c.id}`,`PUT`,p))}}else{let s=l[u],c=(parseFloat(r)+(parseFloat(a)||0)).toFixed(2),d={...s,status:`Pago`,dataPagamento:e,formaPagamento:n,valorPago1:r,formaPagamento2:i,valorPago2:t===`2`?a:null,valor:c};o.push(E.api(`/financeiro/${s.id}`,`PUT`,d))}if(await Promise.all(o),c===`queue`&&u<l.length-1){E.showToast(`Pagamento ${u+1} registado. Avançando...`,`success`),E.filaBaixa.index++,E.montarTelaBaixa();return}E.showToast(`Operação no caixa concluída com sucesso! 💼`,`success`),E.fecharModal(),document.getElementById(`app-content`).innerHTML=`<p style="text-align:center; color:#666; padding:20px;">Atualizando financeiro... ⏳</p>`,await E.renderizarFinanceiroPro()}catch{E.showToast(`Erro ao processar baixa.`,`error`)}finally{o&&(o.innerText=s,o.disabled=!1)}},E.gerarCarnes=async()=>{let e=document.getElementById(`fin-aluno`).value,t=document.getElementById(`fin-valor`).value,n=parseInt(document.getElementById(`fin-parcelas`).value),r=document.getElementById(`fin-vencimento`).value,i=document.getElementById(`fin-tipo`).value;if(!e||!t||!n||!r)return E.showToast(`Preencha todos os campos do gerador.`,`error`);if(parseFloat(t)<=0)return E.showToast(`O valor da mensalidade deve ser maior que zero.`,`warning`);let a=document.getElementById(`fin-aluno`).options[document.getElementById(`fin-aluno`).selectedIndex].text,o=Date.now().toString(),s=new Date().toLocaleDateString(`pt-BR`),c=document.getElementById(`btn-gerar-carne`),l=c.innerText;c.innerText=`Gerando ${n} parcelas... ⏳`,c.disabled=!0,document.body.style.cursor=`wait`;try{let c=[],l=new Date(r+`T00:00:00`),u=l.getDate();for(let r=1;r<=n;r++){let d=new Date(l.getTime());d.setMonth(l.getMonth()+(r-1)),d.getDate()!==u&&d.setDate(0);let f=d.toISOString().split(`T`)[0],p=`Mensalidade ${r}/${n}`;i===`extra`&&(p=`Parcela Extra (Extensão de Curso) - ${r}/${n}`);let m={id:o+`_`+r,idCarne:o,dataGeracao:s,idAluno:e,alunoNome:a,valor:t,vencimento:f,status:`Pendente`,descricao:p,tipo:`Receita`};c.push(E.api(`/financeiro`,`POST`,m))}await Promise.all(c),E.showToast(`Carnê gerado com sucesso!`,`success`),E.abrirCarneExistente(o)}catch{E.showToast(`Erro ao gerar parcelas.`,`error`)}finally{c.innerText=l,c.disabled=!1,document.body.style.cursor=`default`}},E.toggleCheck=e=>{document.querySelectorAll(`.fin-check`).forEach(t=>t.checked=e.checked)},E.acaoLote=e=>{let t=document.querySelectorAll(`.fin-check:checked`);if(t.length===0)return E.showToast(`Selecione pelo menos um lançamento.`,`warning`);let n=document.getElementById(`modal-overlay`);n&&(n.style.display=`flex`);let r=document.getElementById(`modal-titulo`),i=document.getElementById(`modal-form-content`),a=document.querySelector(`.btn-confirm`),o=e===`excluir`,s=o?`#c0392b`:`#f39c12`,c=o?`🗑️`:`↩️`,l=o?`Excluir Lançamentos`:`Desfazer Pagamentos`,u=o?`excluir permanentemente`:`alterar para PENDENTE`;r&&(r.innerText=l);let d=o?`<div style="background:#fdf2f2; border:1px solid #fadbd8; border-left:4px solid #c0392b; padding:12px; border-radius:6px; color:#c0392b; font-size:13px; text-align:left; margin-top:20px;"><b>⚠️ ATENÇÃO:</b> Esta ação é irreversível. Os registos serão removidos da base de dados e do histórico do aluno.</div>`:`<div style="background:#fdf2e9; border:1px solid #fdebd0; border-left:4px solid #f39c12; padding:12px; border-radius:6px; color:#d35400; font-size:13px; text-align:left; margin-top:20px;"><b>ℹ️ NOTA:</b> O status passará de "Pago" para "Pendente" no sistema.</div>`,f=`
        <div style="text-align:center; padding:10px 10px 20px 10px;">
        ...
        <style>@keyframes scaleIn { from { transform: scale(0); opacity: 0; } to { transform: scale(1); opacity: 1; } }</style>
    `;if(i&&(i.innerHTML=f),a){a.innerText=o?`SIM, EXCLUIR 🗑️`:`CONFIRMAR ↩️`,a.style.background=s;let n=a.cloneNode(!0);a.parentNode.replaceChild(n,a),n.onclick=()=>E.executarAcaoLoteConfirmada(e,t,n,s)}},E.executarAcaoLoteConfirmada=async(e,t,n,r)=>{let i=n.innerText;n.innerText=`A processar... ⏳`,n.disabled=!0,n.style.opacity=`0.8`,document.body.style.cursor=`wait`;try{let n=Array.from(t).map(async t=>{let n=t.value;if(e===`excluir`)return E.api(`/financeiro/${n}`,`DELETE`);{let t=E.financeiroCache.find(e=>e.id==n);if(t)return E.api(`/financeiro/${n}`,`PUT`,{...t,status:e===`baixar`?`Pago`:`Pendente`})}});await Promise.all(n),E.showToast(`Ação concluída com sucesso!`,`success`),E.fecharModal(),document.getElementById(`app-content`).innerHTML=`<p style="text-align:center; color:#666; padding:20px;">Atualizando financeiro... ⏳</p>`,typeof E.renderizarFinanceiroPro==`function`&&document.getElementById(`titulo-pagina`).innerText.includes(`Financeiro`)?await E.renderizarFinanceiroPro():typeof E.filtrarTabelaReativa==`function`?await E.renderizarLista(`financeiro`):await E.renderizarFinanceiroPro()}catch{E.showToast(`Erro ao processar lote.`,`error`),n.innerText=i,n.disabled=!1,n.style.opacity=`1`}finally{document.body.style.cursor=`default`,setTimeout(()=>{n&&(n.style.background=``)},500)}},E.abrirCarneExistente=async e=>{let t=document.getElementById(`app-content`);t.innerHTML=`<p style="text-align:center; padding:20px;">Gerando Carnê Profissional...</p>`;try{let[n,r,i]=await Promise.all([E.api(`/financeiro`),E.api(`/alunos`),E.api(`/escola`)]),a=n.filter(t=>t.idCarne===e).sort((e,t)=>new Date(e.vencimento)-new Date(t.vencimento));if(a.length===0)return E.showToast(`Carnê não encontrado.`,`error`);let o=r.find(e=>e.id===a[0].idAluno)||{nome:`Aluno`,cpf:`Não informado`};i.foto&&`${i.foto}`,(i.nome||`INSTITUIÇÃO`).substring(0,20),(o.nome||`Aluno`).split(` `)[0];let s=i.banco||`Não Configurado`,c=i.chavePix||`Não Configurada`;t.innerHTML=`
            ...
            <div class="carne-wrapper">
                <div class="carne-canhoto">
                    <div style="border-bottom: 1px solid #ccc; padding-bottom: 5px; margin-bottom: 5px; display: flex; align-items: center; gap: 8px; text-align: left;">
                        ...
                        <div style="display: flex; flex-direction: column; justify-content: center; min-width: 0;">
                            <div style="font-size: 8px; color: #555; line-height: 1.2; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><b>CNPJ:</b> ${E.escapeHTML(i.cnpj||`Não informado`)}</div>
                            <div style="font-size: 8px; color: #555; line-height: 1.2; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><b>Banco:</b> ${E.escapeHTML(s)}</div>
                        </div>
                    </div>
                    <div style="font-size: 10px; margin-bottom: 3px; color: #34495e;"><b>Nº:</b> ${r}</div>
                    <div style="font-size: 10px; margin-bottom: 3px;"><b>Parcela:</b> ${E.escapeHTML(e.descricao)}</div>
                    ...
                    <div style="margin-top: auto; font-size: 9px; border-top: 1px solid #ccc; padding-top: 5px;"><b>Sacado:</b> ${E.escapeHTML(o.nome)}</div>
                </div>
                <div class="carne-recibo">
                    <div style="display: flex; justify-content: space-between; border-bottom: 2px solid #333; padding-bottom: 4px; margin-bottom: 6px;">
                        <div><div style="font-weight: bold; font-size: 12px;">${E.escapeHTML(i.nome||`INSTITUIÇÃO`)}</div><div style="font-size: 9px;">Banco: ${E.escapeHTML(s)}</div></div>
                    ...
                    <div style="font-size: 10px; margin-bottom: 5px;"><b>Ref:</b> ${E.escapeHTML(e.descricao)} | <b>Pagador:</b> ${E.escapeHTML(o.nome)}</div>
        ...
        <style>
            ...
            <div class="print-sheet" style="background:white; padding:30px; border-radius:8px;">
                <div style="display:flex; align-items:center; justify-content:space-between; border-bottom:2px solid #eee; padding-bottom:15px; margin-bottom:30px;">
                    <div style="display:flex; align-items:center; gap:15px;">
                        ${f}
                        <div><h2 style="margin:0;">${E.escapeHTML(r.nome||``)}</h2><div style="font-size:12px;">CNPJ: ${E.escapeHTML(r.cnpj||``)}</div></div>
                    </div>
            ...
            </div>`}catch(e){console.error(e),E.showToast(`Erro ao calcular inadimplência.`,`error`)}},E.abrirEdicaoFinanceiro=async e=>{E.idEdicaoFinanceiro=e;let t=document.getElementById(`modal-overlay`);t&&(t.style.display=`flex`);let n=document.getElementById(`modal-titulo`),r=document.getElementById(`modal-form-content`);n&&(n.innerText=`Editar Lançamento`),r&&(r.innerHTML=`<p style="padding:20px; text-align:center; color:#666;">Carregando dados da parcela... ⏳</p>`);try{let t=await E.api(`/financeiro/${e}`);E.parcelaEdicaoAtual=t;let n=t.status===`Pago`,i=n?`Data Efetiva do Pagamento`:`Nova Data de Vencimento`,a=n&&t.dataPagamento||t.vencimento;r.innerHTML=`
        ...
        `;let o=document.querySelector(`.btn-confirm`);o&&(o.setAttribute(`onclick`,`App.salvarEdicaoFinanceiro()`),o.innerHTML=`💾 Salvar Alterações`)}catch(e){console.error(`Erro ao carregar edição:`,e),r&&(r.innerHTML=`<p style="color:red; text-align:center;">Erro ao carregar dados. Tente novamente.</p>`)}},E.salvarEdicaoFinanceiro=async()=>{let e=document.getElementById(`edit-fin-data`).value,t=document.getElementById(`edit-fin-valor`).value;if(!e||!t)return E.showToast(`Por favor, preencha a data e o valor.`,`warning`);let n=t.toString().trim();n.includes(`,`)&&n.includes(`.`)?n=n.replace(/\./g,``).replace(`,`,`.`):n.includes(`,`)&&(n=n.replace(`,`,`.`)),n=parseFloat(n)||0;let r=document.querySelector(`.btn-confirm`),i=r?r.innerHTML:`Salvar`;r&&(r.innerHTML=`⏳ A guardar...`,r.disabled=!0),document.body.style.cursor=`wait`;try{let t=E.parcelaEdicaoAtual.status===`Pago`,r={...E.parcelaEdicaoAtual,valor:n};t?(r.dataPagamento=e,r.valorPago1=n,r.valorPago2=0):r.vencimento=e,await E.api(`/financeiro/${E.idEdicaoFinanceiro}`,`PUT`,r),E.showToast(`Alteração financeira guardada com sucesso! 💼`,`success`),E.fecharModal(),typeof E.renderizarFinanceiroPro==`function`&&document.getElementById(`titulo-pagina`).innerText.includes(`Financeiro`)?E.renderizarFinanceiroPro():typeof E.filtrarTabelaReativa==`function`&&E.renderizarLista(`financeiro`)}catch(e){console.error(`Erro ao guardar edição:`,e),E.showToast(`Ocorreu um erro ao atualizar.`,`error`)}finally{r&&(r.innerHTML=i,r.disabled=!1),document.body.style.cursor=`default`}},E.abrirModalEdicaoLote=()=>{let e=document.querySelectorAll(`.fin-check:checked`);if(e.length===0)return E.showToast(`Selecione pelo menos um lançamento para editar.`,`warning`);let t=document.getElementById(`modal-overlay`);t&&(t.style.display=`flex`);let n=document.getElementById(`modal-titulo`),r=document.getElementById(`modal-form-content`);n&&(n.innerText=`Edição em Massa (${e.length} itens)`),r&&(r.innerHTML=`
    ...
    `);let i=document.querySelector(`.btn-confirm`);i&&(i.setAttribute(`onclick`,`App.salvarEdicaoLote()`),i.innerHTML=`💾 Aplicar a Todos`,i.style.background=`#f39c12`,i.style.display=`inline-block`)},E.salvarEdicaoLote=async()=>{let e=document.getElementById(`lote-edit-data`).value,t=document.getElementById(`lote-edit-valor`).value,n=document.getElementById(`lote-edit-descricao`).value.trim(),r=document.getElementById(`lote-edit-cascata`)?.checked;if(!e&&!t&&!n)return E.showToast(`Preencha pelo menos um campo para alterar em massa.`,`warning`);let i=null;if(t){let e=t.toString().trim();if(e.includes(`,`)&&e.includes(`.`)?e=e.replace(/\./g,``).replace(`,`,`.`):e.includes(`,`)&&(e=e.replace(`,`,`.`)),i=parseFloat(e),isNaN(i)||i<0)return E.showToast(`Valor preenchido é inválido.`,`warning`)}let a=document.querySelectorAll(`.fin-check:checked`),o=Array.from(a).map(e=>e.value),s=o.map(e=>E.financeiroCache.find(t=>t.id==e)).filter(Boolean);s.sort((e,t)=>new Date(e.vencimento)-new Date(t.vencimento));let c=document.querySelector(`.btn-confirm`),l=c?c.innerHTML:`Aplicar`;c&&(c.innerHTML=`⏳ A processar...`,c.disabled=!0,c.style.opacity=`0.8`),document.body.style.cursor=`wait`;try{let t=s.map((t,a)=>{let o=t.status===`Pago`,s={...t};if(i!==null&&(s.valor=i,o&&(s.valorPago1=i,s.valorPago2=0)),n&&(s.descricao=n),e){let t=e;if(r&&!o&&a>0){let n=new Date(e+`T00:00:00`),r=n.getDate();n.setMonth(n.getMonth()+a),n.getDate()!==r&&n.setDate(0),t=n.toISOString().split(`T`)[0]}o?s.dataPagamento=e:s.vencimento=t}return E.api(`/financeiro/${t.id}`,`PUT`,s)});await Promise.all(t),E.showToast(`Edição em cascata aplicada em ${o.length} lançamentos! 💼`,`success`),E.fecharModal(),document.getElementById(`app-content`).innerHTML=`<p style="text-align:center; color:#666; padding:20px;">Atualizando financeiro... ⏳</p>`,typeof E.renderizarFinanceiroPro==`function`&&document.getElementById(`titulo-pagina`)&&document.getElementById(`titulo-pagina`).innerText.includes(`Financeiro`)?await E.renderizarFinanceiroPro():typeof E.filtrarTabelaReativa==`function`?await E.renderizarLista(`financeiro`):typeof E.renderizarFinanceiroPro==`function`?await E.renderizarFinanceiroPro():await E.renderizarHistoricoFinanceiro()}catch(e){console.error(`Erro na edição em lote:`,e),E.showToast(`Ocorreu um erro ao atualizar em lote.`,`error`)}finally{c&&(c.innerHTML=l,c.disabled=!1,c.style.background=``,c.style.opacity=`1`),document.body.style.cursor=`default`}},E.renderizarHistoricoFinanceiro=async()=>{E.setTitulo(`Histórico de Lançamentos`);let e=document.getElementById(`app-content`);e.innerHTML=`<p style="text-align:center; color:#666; padding:20px;">Carregando histórico financeiro... ⏳</p>`;try{let[t,n]=await Promise.all([E.api(`/financeiro`),E.api(`/alunos`)]),r=n.filter(e=>!e.status||e.status===`Ativo`).map(e=>e.id),i=t.filter(e=>!(e.status===`Pendente`&&!r.includes(e.idAluno)));E.financeiroCache=i.sort((e,t)=>e.status===t.status?new Date(e.vencimento)-new Date(t.vencimento):e.status===`Pendente`?-1:1);let a=E.UI.botao,o=new Set,s=new Date().getFullYear();o.add(s),i.forEach(e=>{e.vencimento&&o.add(parseInt(e.vencimento.split(`-`)[0]))});let c=`<option value="" selected>Todos os Anos</option>`+Array.from(o).sort((e,t)=>t-e).map(e=>`<option value="${e}">${e}</option>`).join(``),l=`<option value="" selected>Todos os Meses</option>`+[`Janeiro`,`Fevereiro`,`Março`,`Abril`,`Maio`,`Junho`,`Julho`,`Agosto`,`Setembro`,`Outubro`,`Novembro`,`Dezembro`].map((e,t)=>`<option value="${(t+1).toString().padStart(2,`0`)}">${e}</option>`).join(``),u=`
        ...
        `}catch{e.innerHTML=`Erro ao carregar dados financeiros.`}},typeof E.renderizarLista==`function`){let e=E.renderizarLista;E.renderizarLista=t=>t===`financeiro`?E.renderizarHistoricoFinanceiro():e(t)}E.cobrarWhatsApp=async(e,t)=>{try{E.showToast(`A preparar mensagem...`,`info`);let[n,r]=await Promise.all([E.api(`/alunos`),E.api(`/escola`)]),i=n.find(t=>t.id===e);if(!i)return E.showToast(`Erro: Aluno não encontrado.`,`error`);let a=(i.whatsapp||i.celular||i.telefone||i.contato||``).replace(/\D/g,``);if(a.length<10)return E.showToast(`O aluno não tem um número válido registado.`,`warning`);(a.length===10||a.length===11)&&(a=`55`+a);let o=`Olá, *${i.nome?i.nome.split(` `)[0]:`Aluno`}*! Tudo bem? ✨
...
Qualquer dúvida, estamos à inteira disposição. Tenha um excelente dia! 🌟`,s=`https://api.whatsapp.com/send?phone=${a}&text=${encodeURIComponent(o)}`;window.open(s,`_blank`)}catch(e){console.error(`Erro ao gerar link do WhatsApp:`,e),E.showToast(`Erro ao processar a mensagem.`,`error`)}},window.App=window.App||{};var D=window.App,O={Evento:{bg:`#2ecc71`,text:`#fff`},Feriado:{bg:`#e74c3c`,text:`#fff`},Prova:{bg:`#3498db`,text:`#fff`},Reunião:{bg:`#f39c12`,text:`#fff`}},k=(e,t,n=`text`,r=``,i=``)=>`
    ...
    `,o.appendChild(s),document.body.appendChild(o),setTimeout(()=>{o.style.opacity=`1`,s.style.transform=`scale(1)`},10);let c=()=>{o.style.opacity=`0`,s.style.transform=`scale(0.9)`,setTimeout(()=>document.body.removeChild(o),200)};document.getElementById(`btn-no-${a}`).onclick=c,document.getElementById(`btn-yes-${a}`).onclick=()=>{c(),i()}},D.filtrarTabela=(e,t)=>{let n=document.getElementById(e).value.trim().toLowerCase(),r=document.querySelectorAll(`#${t} tbody tr`);!r||r.length===0||r.forEach(e=>{if(e.innerText.includes(`Nenhum`)||e.innerText.includes(`Nenhuma`))return;let t=e.innerText.toLowerCase();e.style.display=t.includes(n)?``:`none`})},D.toggleCheckMassa=(e,t)=>{document.querySelectorAll(`.`+t).forEach(t=>t.checked=e.checked)},D.excluirLotePedagogico=(e,t,n)=>{let r=document.querySelectorAll(`.`+t+`:checked`);if(r.length===0)return D.showToast(`Selecione pelo menos um item para excluir.`,`warning`);D.confirmar(`Excluir em Massa`,`Deseja realmente excluir <b>${r.length}</b> iten(s) selecionado(s)? Esta ação é irreversível.`,`Excluir Tudo`,`#e74c3c`,async()=>{document.body.style.cursor=`wait`;try{let t=Array.from(r).map(t=>D.api(`${e}/${t.value}`,`DELETE`));await Promise.all(t),D.showToast(`${r.length} iten(s) excluído(s) com sucesso!`,`success`);let i=document.getElementById(`app-content`);i&&(i.innerHTML=`<p style="text-align:center; color:#666; padding:20px;">Atualizando dados... ⏳</p>`),await n()}catch{D.showToast(`Erro ao excluir itens em massa.`,`error`)}finally{document.body.style.cursor=`default`}})},D.renderizarPlanejamentoPro=()=>{D.setTitulo(`Planejamento`);let e=document.getElementById(`app-content`),t=e=>`cursor:pointer; background:white; border:2px solid #eee; padding:30px; border-radius:15px; width:220px; transition:0.3s; box-shadow:0 5px 15px rgba(0,0,0,0.05);`,n=e=>`this.style.borderColor='${e}'; this.style.transform='translateY(-5px)'`,r=`this.style.borderColor='#eee'; this.style.transform='translateY(0)'`;e.innerHTML=`
        <div class="card" style="text-align:center; padding:50px;">
            ...
            <div style="background:#f9f9f9; padding:20px; border-radius:8px; border:1px solid #eee;">
                ${A(`Aluno:`,`plan-aluno`,`<option value="">-- Selecione --</option>`+(await D.api(`/alunos`)).filter(e=>!e.status||e.status===`Ativo`).map(e=>`<option value="${e.id}" data-curso="${D.escapeHTML(e.curso||`Geral`)}">${D.escapeHTML(e.nome)}</option>`).join(``),`style="margin-bottom:15px;"`)}
        ...
        `;e.innerHTML=D.UI.card(`📄 Emitir Boletim Escolar`,``,t,`800px`)+`<div id="boletim-area" style="margin-top:30px;"></div>`}catch{e.innerHTML=`Erro.`}},D.gerarBoletimTela=async()=>{let e=document.getElementById(`bol-aluno`).value;if(!e)return D.showToast(`Selecione um aluno.`,`error`);let t=document.getElementById(`boletim-area`);t.innerHTML=`<p style="text-align:center;">A gerar boletim...</p>`;let n=parseFloat(localStorage.getItem(D.getTenantKey?D.getTenantKey(`media_aprovacao`):`media_aprovacao`))||6,r=localStorage.getItem(D.getTenantKey?D.getTenantKey(`regime_letivo`):`regime_letivo`)||`Bimestral`,i=6,a=`BIMESTRE`;r===`Trimestral`?(i=4,a=`TRIMESTRE`):r===`Semestral`?(i=2,a=`SEMESTRE`):r===`Anual`&&(i=1,a=`PERÍODO ÚNICO`);try{let[r,o,s,c,l]=await Promise.all([D.api(`/alunos/${e}`),D.api(`/avaliacoes?_t=${Date.now()}`),D.api(`/chamadas?_t=${Date.now()}`),D.api(`/escola`),D.api(`/planejamentos?_t=${Date.now()}`)]),u=l.find(t=>t.idAluno===e&&t.status!==`Arquivado`),d=s.filter(t=>t.idAluno===e&&(t.status===`Presença`||t.status===`Reposição`)).sort((e,t)=>new Date(e.data)-new Date(t.data)),f=`__/__/____`,p=`__/__/____`,m=0;d.forEach(e=>{if(e.duracao&&e.duracao.includes(`:`)){let[t,n]=e.duracao.split(`:`).map(Number);m+=t*60+(n||0)}});let h=Math.floor(m/60),g=m%60,_=g>0?`${h}h ${g}m`:`${h}H`;u&&u.aulas&&u.aulas.length>0?(f=D.escapeHTML(u.aulas[0].data),p=D.escapeHTML(u.aulas[u.aulas.length-1].data)):d.length>0?(f=d[0].data.split(`-`).reverse().join(`/`),p=d[d.length-1].data.split(`-`).reverse().join(`/`)):f=new Date().toLocaleDateString(`pt-BR`);let v=D.escapeHTML(r.curso||(u?u.curso:`Geral`)),y=D.escapeHTML(r.turma||`Não informada`),b=o.filter(t=>t.idAluno===e&&t.comporBoletim!==!1),x={};b.forEach(e=>{let t=e.disciplina||`Geral`;x[t]||(x[t]={nome:t,notas:[],total:0,periodosLancados:new Set}),x[t].notas.push(e),x[t].total+=parseFloat(e.nota)||0;let n=e.periodo||e.bimestre;n&&x[t].periodosLancados.add(n)});let S=``;Object.keys(x).length===0?S=`<tr><td colspan="4" style="text-align:center; padding:15px; color:#999;">Sem notas oficiais lançadas para este aluno.</td></tr>`:Object.keys(x).forEach(e=>{let t=x[e],r=n*(t.periodosLancados.size>0?t.periodosLancados.size:1),a=n*i,o=t.total>=r,s=o?`#27ae60`:`#c0392b`,c=o?`<span style="color:${s}; font-weight:bold; font-size:14px;">NO PADRÃO</span>`:`<span style="color:${s}; font-weight:bold; font-size:14px;">RECUPERAÇÃO</span>`,l=t.notas.map(e=>`<span style="font-size:11px;">${D.escapeHTML(e.periodo||e.bimestre)} - ${D.escapeHTML(e.tipo)}: <b>${D.escapeHTML(e.nota)}</b></span>`).join(`<br>`);S+=`
            ...
            <div class="print-sheet" style="background: white; max-width: 210mm; margin: 0 auto; padding: 40px; box-shadow: 0 5px 15px rgba(0,0,0,0.1); border-radius: 8px;">
                <div class="doc-header" style="display:flex; justify-content:space-between; border-bottom:2px solid #333; padding-bottom:15px; margin-bottom:20px;">
                    <div style="display:flex; align-items:center; gap:20px;">${C}<div><h2 style="margin:0; text-transform:uppercase;">${D.escapeHTML(c.nome||`INSTITUIÇÃO`)}</h2><div style="font-size:12px;">CNPJ: ${D.escapeHTML(c.cnpj||``)}</div></div></div>
        ...
        `,v=`
            <div style="display:flex; gap:15px; flex-wrap:wrap; align-items:flex-end; margin-bottom:15px; background:#f9f9f9; padding:15px; border-radius:8px; border:1px solid #eee;">
                ${A(`Filtrar por Turma:`,`nota-turma`,p)}
                <span style="padding-bottom:10px; font-weight:bold; color:#999; text-transform:uppercase; font-size:12px;">Ou</span>
                ${A(`Buscar Aluno Único:`,`nota-aluno`,m)}
            </div>
            <div style="display:flex; gap:15px; flex-wrap:wrap; align-items:flex-end; margin-bottom:15px;">
                ${A(`Disciplina/Curso:`,`nota-disc`,h)}
                ${A(`Tipo de Avaliação:`,`nota-tipo`,`<option value="Teste">Teste Formativo</option><option value="Prova">Prova Oficial</option><option value="Pesquisa">Pesquisa</option><option value="Trabalho">Trabalho</option><option value="Outro">Outro (Especificar)</option>`,`onchange="App.toggleTipoOutroNota()"`)}
                    ...
                    <tbody>
                        ...
                        ${d.map(e=>{let t=parseFloat(e.valorMax)||parseFloat(n),r=parseFloat(e.nota)/t>=i?`#27ae60`:`#c0392b`,a=e.comporBoletim===!1?`<span style="background:#f39c12; color:white; padding:3px 6px; border-radius:12px; font-size:10px; font-weight:bold; margin-left:5px;">TESTE</span>`:`<span style="background:#2980b9; color:white; padding:3px 6px; border-radius:12px; font-size:10px; font-weight:bold; margin-left:5px;">BOLETIM</span>`;return`
                            <tr style="border-bottom:1px solid #eee;">
                                ...
                                <td style="padding:12px;">${D.escapeHTML(e.tipo)} ${a}</td>
        ...
        `}catch{o.innerHTML=`<p style="color:red; text-align:center;">Erro ao carregar a pauta.</p>`}},D.salvarNotasLote=async()=>{let e=document.getElementById(`nota-disc`).value,t=document.getElementById(`nota-tipo`).value;t===`Outro`&&(t=document.getElementById(`nota-outro-desc`).value||`Outro`);let n=document.getElementById(`nota-data`).value,r=document.getElementById(`nota-max`).value,i=document.getElementById(`nota-periodo`).value,a=document.getElementById(`nota-vai-boletim`),o=a?a.checked:!0,s=document.querySelectorAll(`.linha-nota`);if(s.length===0)return;if(n>new Date().toISOString().split(`T`)[0])return D.showToast(`Bloqueado: Não é possível gravar notas com datas futuras.`,`error`);let c=document.querySelector(`button[onclick="App.salvarNotasLote()"]`),l=c.innerText;c.innerText=`A arquivar... ⏳`,c.disabled=!0,document.body.style.cursor=`wait`;try{let a=[],c=await D.api(`/avaliacoes?_t=${Date.now()}`);s.forEach(s=>{let l=s.getAttribute(`data-id`),u=s.getAttribute(`data-nome`),d=s.getAttribute(`data-id-avaliacao`),f=s.querySelector(`.valor-nota`).value;if(f===``)return;let p=null;p=d?c.find(e=>e.id===d):c.find(r=>r.idAluno===l&&r.data===n&&r.disciplina===e&&r.tipo===t);let m={idAluno:l,nomeAluno:u,disciplina:e,tipo:t,data:n,valorMax:r,nota:f,periodo:i,bimestre:i,dataLancamento:new Date().toISOString().split(`T`)[0],comporBoletim:o};p?a.push(D.api(`/avaliacoes/${p.id}`,`PUT`,{...p,nota:f,valorMax:r,data:n,disciplina:e,tipo:t,periodo:i,bimestre:i,comporBoletim:o})):(m.id=typeof crypto.randomUUID==`function`?crypto.randomUUID():Date.now().toString(36)+Math.random().toString(36).substr(2),a.push(D.api(`/avaliacoes`,`POST`,m)))}),await Promise.all(a),D.showToast(`Avaliação arquivada com sucesso!`,`success`),D.cancelarEdicaoNota();let l=document.getElementById(`app-content`);l&&(l.innerHTML=`<p style="text-align:center; color:#666; padding:20px;">Atualizando avaliações... ⏳</p>`),await D.renderizarAvaliacoesPro()}catch{D.showToast(`Erro ao salvar as notas.`,`error`)}finally{c&&(c.innerText=l,c.disabled=!1),document.body.style.cursor=`default`}},D.excluirAvaliacao=e=>{D.confirmar(`Excluir Nota`,`Deseja mesmo excluir esta avaliação? Isto irá afetar o boletim do aluno.`,`Excluir`,`#e74c3c`,async()=>{await D.api(`/avaliacoes/${e}`,`DELETE`);let t=document.getElementById(`app-content`);t&&(t.innerHTML=`<p style="text-align:center; color:#666; padding:20px;">Atualizando avaliações... ⏳</p>`),await D.renderizarAvaliacoesPro()})},D.cachePedagogico={chamadas:null,alunos:null,turmas:null,planejamentos:null},D.datasLancamentoChamada=[],D.filaEdicaoChamada=[],D.renderizarChamadaPro=async()=>{D.setTitulo(`Controle de Presença`);let e=document.getElementById(`app-content`);e.innerHTML=`<p style="text-align:center; padding:20px; color:#666;">A carregar dados rapidamente... ⚡</p>`,D.datasLancamentoChamada=[new Date().toISOString().split(`T`)[0]],D.filaEdicaoChamada=[];try{let[t,n,r,i]=await Promise.all([D.api(`/alunos`),D.api(`/turmas`),D.api(`/chamadas?_t=${Date.now()}`),D.api(`/planejamentos?_t=${Date.now()}`)]);D.cachePedagogico.alunos=t,D.cachePedagogico.turmas=n,D.cachePedagogico.chamadas=Array.isArray(r)?r:[],D.cachePedagogico.planejamentos=i;let a=D.cachePedagogico.planejamentos.filter(e=>e.status!==`Arquivado`).map(e=>e.idAluno),o=[...D.cachePedagogico.chamadas].sort((e,t)=>new Date(t.data)-new Date(e.data)),s=D.cachePedagogico.alunos.filter(e=>(!e.status||e.status===`Ativo`)&&a.includes(e.id)),c=`<option value="">-- Turma Completa --</option>`+D.cachePedagogico.turmas.map(e=>`<option value="${D.escapeHTML(e.nome)}">${D.escapeHTML(e.nome)}</option>`).join(``),l=`<option value="">-- Aluno Específico --</option>`+s.map(e=>`<option value="${e.id}">${D.escapeHTML(e.nome)}</option>`).join(``),u=new Date().toISOString().split(`T`)[0],d=`
            <div style="display:flex; gap:15px; flex-wrap:wrap; align-items:flex-end; margin-bottom:15px; background:#f9f9f9; padding:15px; border-radius:8px; border:1px solid #eee;">
                ${A(`Filtrar por Turma:`,`chamada-turma`,c)}
                <span style="padding-bottom:10px; font-weight:bold; color:#999; text-transform:uppercase; font-size:12px;">Ou</span>
                ${A(`Buscar Aluno Único:`,`chamada-aluno`,l)}
            </div>
            ...
            <div class="table-responsive-wrapper">
                <table id="tabela-historico-chamadas" style="width:100%; border-collapse:collapse; font-size:13px;">
                    ...
                    <tbody>
                        ...
                        ${o.map(e=>{let t=`#333`;e.status===`Presença`?t=`green`:e.status===`Falta`?t=`red`:e.status===`Reposição`&&(t=`#2980b9`);let n=D.escapeHTML(e.status);return(e.status===`Falta`||e.status===`Falta Justificada`)&&e.motivo&&(n+=`<br><span style="font-size:10px; color:#7f8c8d;">Motivo: ${D.escapeHTML(e.motivo)}</span>`),`
                            <tr style="border-bottom:1px solid #eee;">
                                ...
                                <td style="padding:12px; color:#555;">${D.escapeHTML(e.duracao)}</td>
                                <td style="padding:12px; text-align:right;">
        ...
        `;e.innerHTML=D.UI.card(`📝 Matriz de Frequência`,``,d,`100%`)+`<div id="area-lista-chamada" style="margin-top:20px;"></div><div style="margin-top:20px;">`+D.UI.card(`Histórico Completo de Lançamentos`,``,f,`100%`)+`</div>`,D.atualizarFilaDatasUI()}catch{e.innerHTML=`Erro ao carregar módulo de chamada.`}},D.adicionarDataFila=()=>{let e=document.getElementById(`input-nova-data`).value,t=new Date().toISOString().split(`T`)[0];if(!e)return D.showToast(`Selecione uma data válida.`,`warning`);if(e>t)return D.showToast(`Não é permitido adicionar datas futuras.`,`warning`);if(D.datasLancamentoChamada.includes(e))return D.showToast(`Esta data já está na lista.`,`info`);D.datasLancamentoChamada.push(e),D.datasLancamentoChamada.sort(),D.atualizarFilaDatasUI()},D.removerDataFila=e=>{D.datasLancamentoChamada=D.datasLancamentoChamada.filter(t=>t!==e),D.atualizarFilaDatasUI()},D.atualizarFilaDatasUI=()=>{let e=document.getElementById(`fila-datas-ui`);if(e){if(D.datasLancamentoChamada.length===0){e.innerHTML=`<span style="font-size:12px; color:#e74c3c; font-style:italic;">Adicione pelo menos uma data para gerar a matriz.</span>`;return}e.innerHTML=D.datasLancamentoChamada.map(e=>`
    ...
    `).join(``)}},D.editarLoteChamada=e=>{let t=document.querySelectorAll(`.`+e+`:checked`);if(t.length===0)return D.showToast(`Selecione pelo menos um registo na tabela para editar.`,`warning`);D.filaEdicaoChamada=[];let n=D.cachePedagogico.chamadas||[];t.forEach(e=>{let t=e.value,r=n.find(e=>String(e.id)===String(t));r&&D.filaEdicaoChamada.push({idAluno:r.idAluno,data:r.data,duracao:r.duracao})}),D.filaEdicaoChamada.length>0&&(D.showToast(`Assistente ativado: A iniciar edição de ${D.filaEdicaoChamada.length} registo(s)...`,`info`),D.processarFilaEdicaoChamada())},D.processarFilaEdicaoChamada=()=>{if(D.filaEdicaoChamada.length>0){let e=D.filaEdicaoChamada.shift();D.editarLancamentoChamada(e.idAluno,e.data,e.duracao)}else D.cancelarEdicaoChamada()},D.editarLancamentoChamada=(e,t,n)=>{document.getElementById(`chamada-aluno`).value=e,document.getElementById(`chamada-turma`).value=``,document.getElementById(`chamada-duracao`).value=n,D.datasLancamentoChamada=[t],D.atualizarFilaDatasUI(),document.getElementById(`btn-cancel-chamada`).style.display=`inline-block`,D.carregarListaChamada(),document.querySelector(`.card`).scrollIntoView({behavior:`smooth`})},D.cancelarEdicaoChamada=()=>{D.filaEdicaoChamada=[],document.getElementById(`chamada-aluno`).value=``,document.getElementById(`btn-cancel-chamada`).style.display=`none`,document.getElementById(`area-lista-chamada`).innerHTML=``,D.datasLancamentoChamada=[new Date().toISOString().split(`T`)[0]],D.atualizarFilaDatasUI(),D.showToast(`Modo de edição finalizado/cancelado.`,`info`)},D.atualizarStatusCelula=e=>{let t=e.value;t===`Falta`?e.style.color=`#e74c3c`:t===`Reposição`?e.style.color=`#f39c12`:t===`Presença`?e.style.color=`#27ae60`:e.style.color=`#333`;let n=e.nextElementSibling;n&&n.classList.contains(`motivo-chamada`)&&(t===`Falta`||t===`Falta Justificada`?(n.style.display=`block`,n.focus()):(n.style.display=`none`,n.value=``))},D.marcarTodosChamadaGlobal=e=>{let t=document.querySelectorAll(`.status-chamada`);t.length!==0&&(t.forEach(t=>{t.value=e,D.atualizarStatusCelula(t)}),D.showToast(`Lote aplicado na matriz inteira: ${e}!`,`info`))},D.carregarListaChamada=async()=>{let e=document.getElementById(`chamada-turma`).value,t=document.getElementById(`chamada-aluno`).value;if(!e&&!t)return D.showToast(`Selecione uma Turma OU um Aluno específico.`,`warning`);if(D.datasLancamentoChamada.length===0)return D.showToast(`Adicione pelo menos uma data na fila.`,`warning`);let n=document.getElementById(`area-lista-chamada`);n.innerHTML=`<p style="text-align:center; padding:20px;">A preparar Matriz de Classe... ⚡</p>`;try{let r=D.cachePedagogico.alunos,i=D.cachePedagogico.chamadas,a=D.cachePedagogico.planejamentos.filter(e=>e.status!==`Arquivado`).map(e=>e.idAluno),o=t?r.filter(e=>e.id===t):r.filter(t=>t.turma===e);if(o=o.filter(e=>(!e.status||e.status===`Ativo`)&&a.includes(e.id)),o.length===0){n.innerHTML=`<div class="card"><p style="text-align:center; color:#999; margin:0;">Nenhum aluno com Planejamento Ativo foi encontrado para este filtro.</p></div>`;return}let s=`<tr><th style="padding:15px; text-align:left; background:#f8f9fa; border-right:1px solid #ddd; min-width:150px;">NOME DO ALUNO</th>`;D.datasLancamentoChamada.forEach(e=>{s+=`<th style="padding:15px; text-align:center; min-width:160px;">${e.split(`-`).reverse().join(`/`)}</th>`}),s+=`</tr>`;let c=``;o.forEach(e=>{c+=`<tr style="border-bottom:1px solid #eee;" class="linha-aluno-matriz" data-id="${e.id}" data-nome="${D.escapeHTML(e.nome)}">`,c+=`<td style="padding:12px; font-weight:500; background:#fff; border-right:1px solid #ddd; min-width:150px;">${D.escapeHTML(e.nome)}</td>`,D.datasLancamentoChamada.forEach(t=>{let n=i.find(n=>String(n.idAluno)===String(e.id)&&n.data===t),r=n?n.status:`Presença`,a=n&&n.motivo?n.motivo:``,o=n?`data-id-chamada="${n.id}"`:``,s=r===`Falta`||r===`Falta Justificada`?`block`:`none`;c+=`
                <td style="padding:8px; vertical-align:top;">
                    ...
                    <input type="text" class="motivo-chamada" placeholder="Descreva o motivo..." value="${D.escapeHTML(a)}" style="display:${s}; width:100%; margin-top:5px; padding:6px; border-radius:4px; border:1px dashed #e74c3c; font-size:11px; outline:none;">
                </td>`}),c+=`</tr>`}),n.innerHTML=(D.filaEdicaoChamada.length>0?`<div style="background:#3498db; color:white; padding:12px; text-align:center; font-weight:bold; border-radius:5px; margin-bottom:15px; animation: pop 0.3s; box-shadow: 0 4px 6px rgba(52, 152, 219, 0.2);">
                ✨ ASSISTENTE DE EDIÇÃO: Faltam ${D.filaEdicaoChamada.length} iten(s) na fila. Ao salvar, o próximo carregará automaticamente!
            </div>`:``)+`
            <div class="card" style="padding:0; overflow:hidden; border:2px solid #27ae60;">
                <div style="padding:15px; background:#eafaf1; border-bottom:1px solid #d5f5e3; font-size:13px; color:#27ae60; font-weight:bold;">
                    Grelha de Frequência em Matriz (${D.datasLancamentoChamada.length} dia(s) selecionado(s))
                </div>
        ...
        `}catch{n.innerHTML=`<p style="color:red; text-align:center;">Erro ao processar a matriz.</p>`}},D.salvarChamadaLote=async()=>{let e=document.getElementById(`chamada-duracao`).value||`01:00`,t=document.querySelectorAll(`.linha-aluno-matriz`);if(t.length===0)return;let n=document.querySelector(`button[onclick="App.salvarChamadaLote()"]`),r=n.innerText;n.innerText=`A arquivar matriz em lote... ⚡`,n.disabled=!0,document.body.style.cursor=`wait`;try{let i=D.cachePedagogico.planejamentos,a=D.cachePedagogico.chamadas,o=[],s=new Set,c=[],l=[...a];if(t.forEach(e=>{let t=e.getAttribute(`data-id`),n=e.getAttribute(`data-nome`);i.some(e=>e.idAluno===t&&e.status!==`Arquivado`)||o.push(n)}),o.length>0){D.showToast(`Bloqueado: Crie um Planejamento para: ${o.join(`, `)}`,`error`),n&&(n.innerText=r,n.disabled=!1),document.body.style.cursor=`default`;return}t.forEach(t=>{let n=t.getAttribute(`data-id`),r=t.getAttribute(`data-nome`);t.querySelectorAll(`.status-chamada`).forEach(t=>{let i=t.value;if(i===`N/A`)return;let o=t.nextElementSibling,u=(i===`Falta`||i===`Falta Justificada`)&&o?o.value.trim():``,d=t.getAttribute(`data-data`),f=t.getAttribute(`data-id-chamada`);s.add(n);let p=null;p=f?a.find(e=>String(e.id)===String(f)):a.find(e=>String(e.idAluno)===String(n)&&e.data===d);let m={idAluno:n,nomeAluno:r,data:d,status:i,duracao:e,motivo:u};if(p){let t={...p,data:d,status:i,duracao:e,motivo:u};c.push(D.api(`/chamadas/${p.id}`,`PUT`,t));let n=l.findIndex(e=>String(e.id)===String(p.id));n!==-1&&(l[n]=t)}else m.id=typeof crypto.randomUUID==`function`?crypto.randomUUID():Date.now().toString(36)+Math.random().toString(36).substr(2),c.push(D.api(`/chamadas`,`POST`,m)),l.push(m)})}),await Promise.all(c);let u=``;try{let e=[];s.forEach(t=>{let n=i.find(e=>e.idAluno===t&&e.status!==`Arquivado`);n&&typeof D.processarAutoAjustePlano==`function`&&(n=D.processarAutoAjustePlano(n,l),e.push(D.api(`/planejamentos/${n.id}`,`PUT`,n)))}),e.length>0&&(await Promise.all(e),u=` e Planos Auto-Ajustados!`)}catch(e){console.log(`Aviso: Falha no auto-ajuste.`,e)}if(D.filaEdicaoChamada&&D.filaEdicaoChamada.length>0)D.showToast(`Salvo! A carregar o próximo... (Faltam ${D.filaEdicaoChamada.length})`,`success`),D.cachePedagogico.chamadas=l,D.processarFilaEdicaoChamada(),n&&(n.innerText=`💾 SALVAR MATRIZ COMPLETA`,n.disabled=!1),document.body.style.cursor=`default`;else{D.showToast(`Processamento concluído com sucesso${u}!`,`success`),D.cancelarEdicaoChamada();let e=document.getElementById(`app-content`);e&&(e.innerHTML=`<p style="text-align:center; color:#666; padding:20px;">A atualizar a tabela de histórico... ⏳</p>`),await D.renderizarChamadaPro()}}catch{D.showToast(`Erro ao guardar a matriz de chamadas.`,`error`),n&&(n.innerText=r,n.disabled=!1),document.body.style.cursor=`default`}},D.excluirLancamentoChamada=e=>{D.confirmar(`Excluir Frequência`,`Tem a certeza que deseja excluir esta chamada do sistema?`,`Excluir`,`#e74c3c`,async()=>{await D.api(`/chamadas/${e}`,`DELETE`);let t=document.getElementById(`app-content`);t&&(t.innerHTML=`<p style="text-align:center; color:#666; padding:20px;">Atualizando frequência... ⏳</p>`),await D.renderizarChamadaPro()})},D.renderizarCalendarioPro=async()=>{D.setTitulo(`Calendário`);let e=document.getElementById(`app-content`);e.innerHTML=`A carregar calendário...`,D.calendarState||={month:new Date().getMonth(),year:new Date().getFullYear()};try{let t=await D.api(`/eventos?_t=${Date.now()}`),n=[`Janeiro`,`Fevereiro`,`Março`,`Abril`,`Maio`,`Junho`,`Julho`,`Agosto`,`Setembro`,`Outubro`,`Novembro`,`Dezembro`][D.calendarState.month],r=`
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        ...
        `,i=`
            ...
            <div style="display: flex; flex-wrap: wrap; gap: 15px; align-items: flex-end;">
                ...
                ${A(`Tipo:`,`evt-tipo`,`<option value="Evento">🟢 Evento</option><option value="Feriado">🔴 Feriado</option><option value="Prova">🔵 Prova</option><option value="Reunião">🟠 Reunião</option>`)}
        ...
        <tr style="border-bottom:1px solid #eee;">
            ...
            <td style="padding:10px;">${D.escapeHTML(e.inicio||`-`)}</td>
            <td style="padding:10px; font-weight:bold; color:${(O[e.tipo]||O.Evento).bg}">${D.escapeHTML(e.tipo)}</td>
            <td style="padding:10px;">${D.escapeHTML(e.descricao)}</td>
            <td style="padding:10px; text-align:right;">
...
`;j.renderizarSelecaoRelatorio=async()=>{let e=document.getElementById(`app-content`);e.innerHTML=`<p style="text-align:center; padding:20px; color:#666;">A carregar períodos disponíveis... ⏳</p>`;try{let t=await j.api(`/financeiro`),n=new Set,r=new Date().getFullYear();n.add(r),n.add(r+1),t.forEach(e=>{if(e.vencimento){let t=parseInt(e.vencimento.split(`-`)[0]);isNaN(t)||n.add(t)}if(e.dataPagamento){let t=parseInt(e.dataPagamento.split(`-`)[0]);isNaN(t)||n.add(t)}});let i=Array.from(n).sort((e,t)=>t-e).map(e=>`<option value="${e}" ${e===r?`selected`:``}>${e}</option>`).join(``),a=[`Janeiro`,`Fevereiro`,`Março`,`Abril`,`Maio`,`Junho`,`Julho`,`Agosto`,`Setembro`,`Outubro`,`Novembro`,`Dezembro`].map((e,t)=>`<option value="${t+1}" ${t===new Date().getMonth()?`selected`:``}>${e}</option>`).join(``),o=`
            ...
            <div style="display:flex; gap:15px; flex-wrap:wrap; margin-bottom:25px;">
                ${N(`Selecione o Ano Base:`,`rel-ano`,i,`style="background:white; padding:12px; font-size:16px;"`)}
                ${N(`🛡️ Filtro de Exibição:`,`filtro-auditoria`,`
        ...
        `,`style="background:#fdf2f2; border:2px solid #f5b7b1; padding:12px; font-size:14px; font-weight:bold; color:#c0392b;"`)}
            ...
            <div style="display:flex; gap:10px; align-items:flex-end; flex-wrap:wrap;">
                ${N(`Mês:`,`rel-mes`,a,`style="background:white; padding:12px; min-width:200px;"`)}
        ...
        <div style="text-align:center;">
            ...
            <div style="display:flex; gap:15px; margin-bottom:25px; text-align:left; flex-wrap:wrap;">
                ${N(`Mês Vigente:`,`dossie-mes`,[`Janeiro`,`Fevereiro`,`Março`,`Abril`,`Maio`,`Junho`,`Julho`,`Agosto`,`Setembro`,`Outubro`,`Novembro`,`Dezembro`].map((e,t)=>`<option value="${t+1}" ${t+1===n?`selected`:``}>${e}</option>`).join(``),`style="padding:12px;"`)}
                ${M(`Ano:`,`dossie-ano`,`number`,t,`style="padding:12px; text-align:center;"`)}
            </div>
    ...
    `;e.innerHTML=j.UI.card(``,``,r,`500px`)},j.gerarDossie=async()=>{let e=document.getElementById(`dossie-ano`).value,t=parseInt(document.getElementById(`dossie-mes`).value),n=[`Janeiro`,`Fevereiro`,`Março`,`Abril`,`Maio`,`Junho`,`Julho`,`Agosto`,`Setembro`,`Outubro`,`Novembro`,`Dezembro`],r=n[t-1],i=document.getElementById(`app-content`);i.innerHTML=`<p style="text-align:center; padding:20px; font-size:14px; color:#2980b9;"><b>A gerar Dossiê Corporativo...</b><br>Sincronizando layout e paginação de impressão ⏳</p>`,document.body.style.cursor=`wait`;try{let[a,o,s,c,l,u]=await Promise.all([j.api(`/alunos`).catch(()=>[]),j.api(`/turmas`).catch(()=>[]),j.api(`/cursos`).catch(()=>[]),j.api(`/financeiro`).catch(()=>[]),j.api(`/escola`).catch(()=>({nome:`Instituição`,cnpj:``})),j.api(`/planejamentos`).catch(()=>[])]),d=e=>parseFloat(e||0).toLocaleString(`pt-BR`,{style:`currency`,currency:`BRL`}),f=e=>e.descricao&&e.descricao.toLowerCase().includes(`venda`)||e.idCarne&&e.idCarne.includes(`VENDA`),p=new Set,m=new Set;a.forEach(e=>{let t=(e.status||`ativo`).toLowerCase();!t.includes(`exclu`)&&!t.includes(`cancel`)&&!t.includes(`tranc`)&&(p.add(e.id),e.nome&&m.add(e.nome.toLowerCase().trim()))});let h=e=>!!(e.idAluno&&p.has(e.idAluno)||e.alunoNome&&m.has(e.alunoNome.toLowerCase().trim())),g=c.filter(t=>t.vencimento&&t.vencimento.startsWith(e)&&t.tipo===`Receita`),_=g.filter(e=>!f(e)&&h(e)).reduce((e,t)=>e+(parseFloat(t.valor)||0),0),v=g.filter(e=>e.status===`Pago`).reduce((e,t)=>e+(parseFloat(t.valorPago1||t.valor)+parseFloat(t.valorPago2||0)),0),y=g.filter(e=>e.status!==`Pago`).reduce((e,t)=>e+(parseFloat(t.valor)||0),0),b=g.filter(e=>parseInt(e.vencimento.split(`-`)[1])===t),x=b.filter(e=>!f(e)&&h(e)).reduce((e,t)=>e+(parseFloat(t.valor)||0),0),S=b.filter(e=>e.status===`Pago`).reduce((e,t)=>e+(parseFloat(t.valorPago1||t.valor)+parseFloat(t.valorPago2||0)),0),C=b.filter(e=>e.status!==`Pago`).reduce((e,t)=>e+(parseFloat(t.valor)||0),0),w=``,T=0,E=[];for(let n=0;n<12;n++){let r=t-n,i=parseInt(e);r<=0&&(r+=12,--i),E.push({mes:r,ano:i})}E.reverse(),E.forEach(e=>{let t=c.filter(t=>t.tipo===`Receita`&&t.status===`Pago`&&t.vencimento&&parseInt(t.vencimento.split(`-`)[1])===e.mes&&parseInt(t.vencimento.split(`-`)[0])===e.ano),r=t.filter(e=>!f(e)).reduce((e,t)=>e+(parseFloat(t.valorPago1||t.valor)+parseFloat(t.valorPago2||0)),0),i=t.filter(e=>f(e)).reduce((e,t)=>e+(parseFloat(t.valorPago1||t.valor)+parseFloat(t.valorPago2||0)),0),a=r+i;T+=a,w+=`<tr style="border-bottom:1px solid #f1f5f9;">
            ...
            <div class="print-sheet dossier-wrap">
                        ...
                        <div style="display:flex; align-items:center; gap:6px; justify-content:space-between; flex:1;">
                            ...
                            <div style="flex:1;">
                                <table class="fin-table" style="font-size:8px; line-height:1.2;">
                                    <tr><td style="padding:2px 4px;"><span style="color:#16a34a; font-weight:bold;">● Ativos</span></td><td style="text-align:right; font-weight:bold;">${D.Ativo.total} <span style="font-weight:normal; color:#888;">(${Math.round(D.Ativo.total/M*100)}%)</span></td></tr>
                                    <tr><td style="padding:2px 4px;"><span style="color:#d97706; font-weight:bold;">● Tranc.</span></td><td style="text-align:right; font-weight:bold;">${D.Trancado.total} <span style="font-weight:normal; color:#888;">(${Math.round(D.Trancado.total/M*100)}%)</span></td></tr>
                                    <tr><td style="padding:2px 4px;"><span style="color:#ea580c; font-weight:bold;">● Canc.</span></td><td style="text-align:right; font-weight:bold;">${D.Cancelado.total} <span style="font-weight:normal; color:#888;">(${Math.round(D.Cancelado.total/M*100)}%)</span></td></tr>
                                    <tr><td style="padding:2px 4px;"><span style="color:#dc2626; font-weight:bold;">● Excl.</span></td><td style="text-align:right; font-weight:bold;">${D.Excluído.total} <span style="font-weight:normal; color:#888;">(${Math.round(D.Excluído.total/M*100)}%)</span></td></tr>
                                </table>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-card">
                        ...
                        <div style="display:flex; align-items:center; justify-content:space-between; gap:6px; flex:1;">
                            ...
                            <div style="border-left:1px solid #e2e8f0; padding-left:6px; text-align:right; flex:1; justify-content:center; display:flex; flex-direction:column; gap:2px;">
                                ...
                                <div style="font-size:11px; font-weight:900; color:#3b82f6; line-height:1.1;">${A.online} <span style="font-size:7.5px; color:#94a3b8; font-weight:bold;">(${Math.round(A.online/M*100)}%)</span></div>
                                <div style="font-size:11px; font-weight:900; color:#8b5cf6; line-height:1.1;">${A.presencial} <span style="font-size:7.5px; color:#94a3b8; font-weight:bold;">(${Math.round(A.presencial/M*100)}%)</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="box-card" style="margin-bottom:10px;">
                    ...
                    <div style="display:flex; flex-wrap:wrap; gap:5px;">
                        ${Object.keys(O).map(e=>`<div style="background:#f8fafc; border:1px solid #e2e8f0; padding:3px 6px; border-radius:4px; font-size:9px; color:#334155;"><b>${e}</b>: ${O[e]} <span style="color:#777;">(${Math.round(O[e]/M*100)}%)</span></div>`).join(``)}
                    </div>
                </div>
            ...
            <div style="display:flex; gap:10px; align-items:flex-end; flex-wrap:wrap;">
                ${N(`Selecione o Aluno:`,`ficha-aluno`,`<option value="">-- Selecione o Aluno --</option>`+(await j.api(`/alunos`)).filter(e=>!e.status||e.status===`Ativo`).map(e=>`<option value="${e.id}">${j.escapeHTML(e.nome)}</option>`).join(``))}
...
<div style="font-size:10px; color:#999;">Emissão: ${i}</div>
        ...
        `}catch{j.showToast(`Erro ao gerar o certificado.`,`error`)}finally{c.innerText=l,c.disabled=!1,document.body.style.cursor=`default`}};var F=`modulepreload`,I=function(e){return`/`+e},L={},R=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=I(t,n),t in L)return;L[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:F,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},z=`false`,B=`false`,V=z===`true`,H=B===`true`;function U(e={}){let{immediate:t=!1,onNeedReload:n,onNeedRefresh:r,onOfflineReady:i,onRegistered:a,onRegisteredSW:o,onRegisterError:s}=e,c,l,u,d=async(e=!0)=>{await l,V||u?.()};async function f(){if(`serviceWorker`in navigator){if(c=await R(async()=>{let{Workbox:e}=await import(`./workbox-window.prod.es5-Di3ct3up.js`);return{Workbox:e}},[]).then(({Workbox:e})=>new e(`/sw.js`,{scope:`/`,type:`classic`})).catch(e=>{s?.(e)}),!c)return;if(u=()=>{c?.messageSkipWaiting()},!H)if(V)c.addEventListener(`activated`,e=>{(e.isUpdate||e.isExternal)&&(n?n():window.location.reload())}),c.addEventListener(`installed`,e=>{e.isUpdate||i?.()});else{let e=!1,t=()=>{e=!0,c?.addEventListener(`controlling`,e=>{e.isUpdate&&(n?n():window.location.reload())}),r?.()};c.addEventListener(`installed`,n=>{n.isUpdate===void 0?n.isExternal===void 0?!e&&i?.():n.isExternal?t():!e&&i?.():n.isUpdate||i?.()}),c.addEventListener(`waiting`,t)}c.register({immediate:t}).then(e=>{o?o(`/sw.js`,e):a?.(e)}).catch(e=>{s?.(e)})}}return l=f(),d}Object.assign(window.App,u),Object.assign(window.App,T);var W=U({onNeedRefresh(){console.log(`Nova versão detetada! A exibir notificação de update...`);let e=document.getElementById(`update-banner`);e?(e.style.display=`block`,e.style.animation=`slideIn 0.3s ease forwards`,window.atualizarApp=()=>{let t=e.querySelector(`button`);t&&(t.innerText=`A instalar... ⏳`,t.disabled=!0),W(!0)}):W(!0)},onOfflineReady(){console.log(`App pronta para trabalhar offline!`)}});