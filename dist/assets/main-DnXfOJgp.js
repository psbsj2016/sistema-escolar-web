...
`;A.renderizarSelecaoRelatorio=async()=>{let e=document.getElementById(`app-content`);e.innerHTML=`<p style="text-align:center; padding:20px; color:#666;">A carregar períodos disponíveis... ⏳</p>`;try{let t=await A.api(`/financeiro`),n=new Set,r=new Date().getFullYear();n.add(r),n.add(r+1),t.forEach(e=>{if(e.vencimento){let t=parseInt(e.vencimento.split(`-`)[0]);isNaN(t)||n.add(t)}if(e.dataPagamento){let t=parseInt(e.dataPagamento.split(`-`)[0]);isNaN(t)||n.add(t)}});let i=Array.from(n).sort((e,t)=>t-e).map(e=>`<option value="${e}" ${e===r?`selected`:``}>${e}</option>`).join(``),a=[`Janeiro`,`Fevereiro`,`Março`,`Abril`,`Maio`,`Junho`,`Julho`,`Agosto`,`Setembro`,`Outubro`,`Novembro`,`Dezembro`].map((e,t)=>`<option value="${t+1}" ${t===new Date().getMonth()?`selected`:``}>${e}</option>`).join(``),o=`
            ...
            <div style="display:flex; gap:15px; flex-wrap:wrap; margin-bottom:25px;">
                ${M(`Selecione o Ano Base:`,`rel-ano`,i,`style="background:white; padding:12px; font-size:16px;"`)}
                ${M(`🛡️ Filtro de Exibição:`,`filtro-auditoria`,`
        ...
        `;e.innerHTML=A.UI.card(``,``,o,`100%`)}catch(t){console.error(`Erro ao carregar anos para relatório:`,t),e.innerHTML=`<p style="color:red; text-align:center;">Erro ao ligar ao servidor para ler o histórico. Tente novamente.</p>`}},A.gerarRelatorioAnual=async()=>{let e=document.getElementById(`rel-ano`).value,t=document.getElementById(`filtro-auditoria`)?document.getElementById(`filtro-auditoria`).value:`geral`,n=document.getElementById(`app-content`);n.innerHTML=`<p style="text-align:center;">A gerar relatório anual...</p>`;try{let[r,i,a]=await Promise.all([A.api(`/financeiro`),A.api(`/escola`)||{nome:`ESCOLA`,cnpj:``},A.api(`/alunos`)||[]]),o=i.foto?`<img src="${i.foto}" style="height:50px; object-fit:contain;">`:``,s={},c={};a.forEach(e=>{let t=e.status?e.status.toLowerCase():`ativo`;s[e.id]=t,e.nome&&(c[e.nome.toLowerCase().trim()]=t)});let l=r.filter(t=>t.vencimento&&t.vencimento.startsWith(e));l=l.filter(e=>{let n=`desconhecido`;e.idAluno&&s[e.idAluno]?n=s[e.idAluno]:e.alunoNome&&c[e.alunoNome.toLowerCase().trim()]&&(n=c[e.alunoNome.toLowerCase().trim()]);let r=n===`excluído`||n===`desconhecido`,i=e.status===`Pago`;return t===`pagos`?i&&!r:t===`pendentes`?!i&&!r:t===`excluidos`?r:!0}),l.sort((e,t)=>new Date(e.vencimento)-new Date(t.vencimento));let u=e=>parseFloat(e.valorPago1||e.valor||0)+parseFloat(e.valorPago2||0),d=l.reduce((e,t)=>e+(parseFloat(t.valor)||0),0),f=l.filter(e=>e.status===`Pago`).reduce((e,t)=>e+u(t),0),p=l.filter(e=>e.status!==`Pago`).reduce((e,t)=>e+(parseFloat(t.valor)||0),0),m=e=>e.toLocaleString(`pt-BR`,{style:`currency`,currency:`BRL`});n.innerHTML=`
            ...
            <div class="print-sheet">
                <div class="doc-header" style="display:flex; justify-content:space-between; align-items:center; border-bottom:2px solid #333; padding-bottom:15px; margin-bottom:20px;">
                    <div style="display:flex; gap:15px; align-items:center;">
                        ${o}
                        <div><h2 style="margin:0; text-transform:uppercase; color:#2c3e50; font-size:18px;">${A.escapeHTML(i.nome)}</h2><div style="font-size:12px; color:#666;">CNPJ: ${A.escapeHTML(i.cnpj)}<br>Relatório Analítico Anual</div></div>
                    </div>
                    <div style="text-align:right;">
            ...
            <div class="print-sheet">
                <div class="doc-header" style="display:flex; justify-content:space-between; align-items:center; border-bottom:2px solid #333; padding-bottom:15px; margin-bottom:30px;">
                    <div style="display:flex; gap:15px; align-items:center;">
                        ${c}
                        <div><h3 style="margin:0; text-transform:uppercase; color:#2c3e50; font-size:18px;">${A.escapeHTML(o.nome)}</h3><div style="font-size:11px; color:#666;">CNPJ: ${A.escapeHTML(o.cnpj)}</div></div>
                    </div>
                    <div style="text-align:right;">
                ...
                <div class="table-responsive">
                    <table style="width:100%; border-collapse:collapse; font-size:11px; color:#555; min-width:500px;">
                        ...
                        <tbody>
                            ...
                            ${d.map(e=>{let t=e.status===`Pago`,n=t?`PAGO`:`PENDENTE`;return t&&e.formaPagamento&&(n+=`<br><span style="font-size:9px; color:#666; display:block; line-height:1.2; margin-top:2px;">${A.escapeHTML(e.formaPagamento)}${e.formaPagamento2?` / ${A.escapeHTML(e.formaPagamento2)}`:``}<br>Pago em: ${A.escapeHTML(e.dataPagamento?e.dataPagamento.split(`-`).reverse().join(`/`):``)}</span>`),`<tr style="border-bottom:1px solid #eee;"><td style="padding:10px; white-space:nowrap;">${A.escapeHTML(e.vencimento.split(`-`).reverse().join(`/`))}</td><td style="padding:10px;">${A.escapeHTML(e.alunoNome||`Não informado`)}</td><td style="padding:10px;">${A.escapeHTML(e.descricao)}</td><td style="padding:10px; text-align:center; font-weight:bold; color:${t?`green`:`red`};">${n}</td><td style="padding:10px; text-align:right; white-space:nowrap;">${g(t?f(e):parseFloat(e.valor)||0)}</td></tr>`}).join(``)}
                        </tbody>
                    </table>
                </div>
    ...
    `;e.innerHTML=A.UI.card(``,``,r,`500px`)},A.gerarDossie=async()=>{let e=document.getElementById(`dossie-ano`).value,t=parseInt(document.getElementById(`dossie-mes`).value),n=[`Janeiro`,`Fevereiro`,`Março`,`Abril`,`Maio`,`Junho`,`Julho`,`Agosto`,`Setembro`,`Outubro`,`Novembro`,`Dezembro`],r=n[t-1],i=document.getElementById(`app-content`);i.innerHTML=`<p style="text-align:center; padding:20px; font-size:14px; color:#2980b9;"><b>A gerar Dossiê Corporativo...</b><br>Sincronizando layout e paginação de impressão ⏳</p>`,document.body.style.cursor=`wait`;try{let[a,o,s,c,l,u]=await Promise.all([A.api(`/alunos`).catch(()=>[]),A.api(`/turmas`).catch(()=>[]),A.api(`/cursos`).catch(()=>[]),A.api(`/financeiro`).catch(()=>[]),A.api(`/escola`).catch(()=>({nome:`Instituição`,cnpj:``})),A.api(`/planejamentos`).catch(()=>[])]),d=e=>parseFloat(e||0).toLocaleString(`pt-BR`,{style:`currency`,currency:`BRL`}),f=e=>e.descricao&&e.descricao.toLowerCase().includes(`venda`)||e.idCarne&&e.idCarne.includes(`VENDA`),p=new Set,m=new Set;a.forEach(e=>{let t=(e.status||`ativo`).toLowerCase();!t.includes(`exclu`)&&!t.includes(`cancel`)&&!t.includes(`tranc`)&&(p.add(e.id),e.nome&&m.add(e.nome.toLowerCase().trim()))});let h=e=>!!(e.idAluno&&p.has(e.idAluno)||e.alunoNome&&m.has(e.alunoNome.toLowerCase().trim())),g=c.filter(t=>t.vencimento&&t.vencimento.startsWith(e)&&t.tipo===`Receita`),_=g.filter(e=>!f(e)&&h(e)).reduce((e,t)=>e+(parseFloat(t.valor)||0),0),v=g.filter(e=>e.status===`Pago`).reduce((e,t)=>e+(parseFloat(t.valorPago1||t.valor)+parseFloat(t.valorPago2||0)),0),y=g.filter(e=>e.status!==`Pago`).reduce((e,t)=>e+(parseFloat(t.valor)||0),0),b=g.filter(e=>parseInt(e.vencimento.split(`-`)[1])===t),x=b.filter(e=>!f(e)&&h(e)).reduce((e,t)=>e+(parseFloat(t.valor)||0),0),S=b.filter(e=>e.status===`Pago`).reduce((e,t)=>e+(parseFloat(t.valorPago1||t.valor)+parseFloat(t.valorPago2||0)),0),C=b.filter(e=>e.status!==`Pago`).reduce((e,t)=>e+(parseFloat(t.valor)||0),0),w=``,T=0,E=[];for(let n=0;n<12;n++){let r=t-n,i=parseInt(e);r<=0&&(r+=12,--i),E.push({mes:r,ano:i})}E.reverse(),E.forEach(e=>{let t=c.filter(t=>t.tipo===`Receita`&&t.status===`Pago`&&t.vencimento&&parseInt(t.vencimento.split(`-`)[1])===e.mes&&parseInt(t.vencimento.split(`-`)[0])===e.ano),r=t.filter(e=>!f(e)).reduce((e,t)=>e+(parseFloat(t.valorPago1||t.valor)+parseFloat(t.valorPago2||0)),0),i=t.filter(e=>f(e)).reduce((e,t)=>e+(parseFloat(t.valorPago1||t.valor)+parseFloat(t.valorPago2||0)),0),a=r+i;T+=a,w+=`<tr style="border-bottom:1px solid #f1f5f9;">
            ...
            </tr>`});let D={Ativo:{masc:0,fem:0,total:0},Trancado:{masc:0,fem:0,total:0},Cancelado:{masc:0,fem:0,total:0},Excluído:{masc:0,fem:0,total:0}},O={},k={online:0,presencial:0},j={online:0,presencial:0};a.forEach(n=>{let r=`Ativo`,i=(n.status||``).toLowerCase();i.includes(`exclu`)?r=`Excluído`:i.includes(`cancel`)?r=`Cancelado`:i.includes(`tranc`)&&(r=`Trancado`),D[r].total++,n.sexo===`Masculino`?D[r].masc++:n.sexo===`Feminino`&&D[r].fem++;let a=(n.pais||n.nacionalidade||`Brasil`).trim().toUpperCase();a===``&&(a=`BRASIL`),O[a]=(O[a]||0)+1;let o=(n.modalidade||n.tipoMatricula||`Presencial`).toLowerCase().includes(`online`)?`online`:`presencial`;if(j[o]++,n.dataCadastro||n.dataMatricula){let r=new Date(n.dataCadastro||n.dataMatricula);r.getFullYear()===parseInt(e)&&r.getMonth()+1===t&&k[o]++}else k[o]++});let M=a.length||1,P={};o.forEach(e=>P[e.nome]=0);let F={};s.forEach(e=>F[e.nome]=0),a.forEach(e=>{e.turma&&P[e.turma]!==void 0&&P[e.turma]++,e.curso&&F[e.curso]!==void 0&&F[e.curso]++});let I=u.filter(e=>!e.status||e.status.toLowerCase()!==`arquivado`).length,L=u.filter(e=>e.status&&e.status.toLowerCase()===`arquivado`).length,R=(e,t)=>{let n=Object.keys(e).filter(t=>e[t]>0);return n.length===0?`<div style="font-size:10px; color:#94a3b8;">Nenhum registo ativo.</div>`:`<div style="display:flex; flex-wrap:wrap; gap:5px;">`+n.map(n=>`<div style="background:#f1f5f9; border:1px solid #e2e8f0; padding:3px 6px; border-radius:4px; display:flex; gap:6px; align-items:center; font-size:9.5px; page-break-inside: avoid;">
                    <span style="color:#334155; font-weight:600;">${A.escapeHTML(n)}</span>
            ...
            <div class="print-sheet dossier-wrap">
                ...
                <div style="display:flex; justify-content:space-between; align-items:flex-end; border-bottom: 2px solid #0f172a; padding-bottom: 8px;">
                    <div style="display:flex; align-items:center; gap:10px;">
                        ...
                        <div>
                            <h2 style="margin:0; text-transform:uppercase; color:#0f172a; font-size:15px; font-weight:900;">${A.escapeHTML(l.nome)}</h2>
                            <div style="font-size:9px; color:#64748b;">CNPJ: ${A.escapeHTML(l.cnpj)}</div>
                        </div>
                    </div>
                    <div style="text-align:right;">
                    ...
                    <div class="box-card">
                        ...
                        <div style="display:flex; align-items:center; justify-content:space-between; gap:6px; flex:1;">
                            ...
                            <div style="border-left:1px solid #e2e8f0; padding-left:6px; text-align:right; flex:1; justify-content:center; display:flex; flex-direction:column; gap:2px;">
                                ...
                                <div style="font-size:11px; font-weight:900; color:#3b82f6; line-height:1.1;">${j.online} <span style="font-size:7.5px; color:#94a3b8; font-weight:bold;">(${Math.round(j.online/M*100)}%)</span></div>
                                <div style="font-size:11px; font-weight:900; color:#8b5cf6; line-height:1.1;">${j.presencial} <span style="font-size:7.5px; color:#94a3b8; font-weight:bold;">(${Math.round(j.presencial/M*100)}%)</span></div>
                            </div>
                        </div>
                    </div>
                </div>
