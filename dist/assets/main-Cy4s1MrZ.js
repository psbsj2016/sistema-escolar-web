            ...
            <div class="print-sheet dossier-wrap">
                        ...
                        <div style="display:flex; align-items:center; gap:8px; justify-content:space-between; flex:1;">
                            ...
                            <div style="flex:1;">
                                <table class="fin-table" style="font-size:8px; line-height:1.2;">
                                    <tr><td style="padding:2px 4px;"><span style="color:#16a34a; font-weight:bold;">● Ativos</span></td><td style="text-align:right; font-weight:bold;">${D.Ativo.total}</td></tr>
                                    <tr><td style="padding:2px 4px;"><span style="color:#d97706; font-weight:bold;">● Tranc.</span></td><td style="text-align:right; font-weight:bold;">${D.Trancado.total}</td></tr>
                                    <tr><td style="padding:2px 4px;"><span style="color:#ea580c; font-weight:bold;">● Canc.</span></td><td style="text-align:right; font-weight:bold;">${D.Cancelado.total}</td></tr>
                                    <tr><td style="padding:2px 4px;"><span style="color:#dc2626; font-weight:bold;">● Excl.</span></td><td style="text-align:right; font-weight:bold;">${D.Excluído.total}</td></tr>
                                </table>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-card">
                        ...
                        <div style="display:flex; align-items:center; justify-content:space-between; gap:6px; flex:1;">
                            ...
                            <div style="border-left:1px solid #e2e8f0; padding-left:8px; text-align:right; flex:1; justify-content:center; display:flex; flex-direction:column; gap:2px;">
                                ...
                                <div style="font-size:11px; font-weight:900; color:#3b82f6; line-height:1.1;">${j.online} <span style="font-size:7.5px; color:#94a3b8; font-weight:bold;">ON</span></div>
                                <div style="font-size:11px; font-weight:900; color:#8b5cf6; line-height:1.1;">${j.presencial} <span style="font-size:7.5px; color:#94a3b8; font-weight:bold;">PRES</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="box-card" style="margin-bottom:10px;">
                    ...
                    <div style="display:flex; flex-wrap:wrap; gap:5px;">
                        ${Object.keys(O).map(e=>`<div style="background:#f8fafc; border:1px solid #e2e8f0; padding:3px 6px; border-radius:4px; font-size:9px; color:#334155;"><b>${e}</b>: ${O[e]}</div>`).join(``)}
                    </div>
                </div>
                    ...
                    <div class="box-card">
                        ...
                        <div style="display:flex; gap:8px; flex:1; align-items:center;">
                            <div style="flex:1; background:#f0fdf4; border:1px solid #bbf7d0; padding:12px 6px; border-radius:6px; text-align:center;">
                                ...
                                <div style="font-size:22px; font-weight:900; color:#15803d; margin-top:2px;">${F}</div>
                            </div>
