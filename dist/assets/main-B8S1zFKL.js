...
`;A.renderizarSelecaoRelatorio=async()=>{let e=document.getElementById(`app-content`);e.innerHTML=`<p style="text-align:center; padding:20px; color:#666;">A carregar períodos disponíveis... ⏳</p>`;try{let t=await A.api(`/financeiro`),n=new Set,r=new Date().getFullYear();n.add(r),n.add(r+1),t.forEach(e=>{if(e.vencimento){let t=parseInt(e.vencimento.split(`-`)[0]);isNaN(t)||n.add(t)}if(e.dataPagamento){let t=parseInt(e.dataPagamento.split(`-`)[0]);isNaN(t)||n.add(t)}});let i=Array.from(n).sort((e,t)=>t-e).map(e=>`<option value="${e}" ${e===r?`selected`:``}>${e}</option>`).join(``),a=[`Janeiro`,`Fevereiro`,`Março`,`Abril`,`Maio`,`Junho`,`Julho`,`Agosto`,`Setembro`,`Outubro`,`Novembro`,`Dezembro`].map((e,t)=>`<option value="${t+1}" ${t===new Date().getMonth()?`selected`:``}>${e}</option>`).join(``),o=`
    ...
    `;e.innerHTML=A.UI.card(``,``,r,`500px`)},A.gerarDossie=async()=>{let e=document.getElementById(`dossie-ano`).value,t=parseInt(document.getElementById(`dossie-mes`).value),n=[`Janeiro`,`Fevereiro`,`Março`,`Abril`,`Maio`,`Junho`,`Julho`,`Agosto`,`Setembro`,`Outubro`,`Novembro`,`Dezembro`],r=n[t-1],i=t-1,a=parseInt(e);i===0&&(i=12,--a);let o=n[i-1],s=document.getElementById(`app-content`);s.innerHTML=`<p style="text-align:center; padding:20px;">Processando Inteligência de Negócios... ⏳</p>`,document.body.style.cursor=`wait`;try{let[n,c,l,u,d]=await Promise.all([A.api(`/alunos`),A.api(`/turmas`),A.api(`/cursos`),A.api(`/financeiro`),A.api(`/escola`)]),f=new Date,p=e=>parseFloat(e||0).toLocaleString(`pt-BR`,{style:`currency`,currency:`BRL`}),m=e=>parseFloat(e.valorPago1||e.valor)+parseFloat(e.valorPago2||0),h=e=>e.descricao&&e.descricao.toLowerCase().includes(`venda`)||e.idCarne&&e.idCarne.includes(`VENDA`),g=u.filter(t=>t.vencimento&&t.vencimento.startsWith(e)&&t.tipo===`Receita`),_=g.filter(e=>parseInt(e.vencimento.split(`-`)[1])===t),v=g.filter(e=>e.status===`Pago`).reduce((e,t)=>e+m(t),0),y=g.filter(e=>!h(e)).reduce((e,t)=>e+(parseFloat(t.valor)||0),0),b=_.filter(e=>!h(e)).reduce((e,t)=>e+(parseFloat(t.valor)||0),0),x=u.filter(e=>e.status===`Pendente`&&e.tipo===`Receita`&&new Date(e.vencimento+`T00:00:00`)<f).reduce((e,t)=>e+(parseFloat(t.valor)||0),0),S=_.filter(e=>e.status===`Pago`&&!h(e)).reduce((e,t)=>e+m(t),0),C=_.filter(e=>e.status===`Pago`&&h(e)).reduce((e,t)=>e+m(t),0),w=S+C,T={},E={};_.filter(e=>e.status===`Pago`).forEach(e=>{let t=h(e)?E:T,n=e.formaPagamento||`Outros`,r=e.formaPagamento2;t[n]=(t[n]||0)+parseFloat(e.valorPago1||e.valor),r&&(t[r]=(t[r]||0)+parseFloat(e.valorPago2||0))});let D=``,O=0;for(let e=1;e<=t;e++){let t=g.filter(t=>parseInt(t.vencimento.split(`-`)[1])===e&&t.status===`Pago`),n=t.filter(e=>!h(e)).reduce((e,t)=>e+m(t),0),r=t.filter(e=>h(e)).reduce((e,t)=>e+m(t),0),i=n+r;O+=i,D+=`<tr><td>${[`Jan`,`Fev`,`Mar`,`Abr`,`Mai`,`Jun`,`Jul`,`Ago`,`Set`,`Out`,`Nov`,`Dez`][e-1]}</td><td style="text-align:right; color:#2980b9; white-space:nowrap;">${p(n)}</td><td style="text-align:right; color:#8e44ad; white-space:nowrap;">${p(r)}</td><td style="text-align:right; font-weight:bold; white-space:nowrap;">${p(i)}</td></tr>`}let k={};c.forEach(e=>k[e.nome]=0);let j={};l.forEach(e=>j[e.nome]=0);let M={ativo:{total:0,masc:0,fem:0,color:`#27ae60`,label:`🟢 Ativos`},trancado:{total:0,masc:0,fem:0,color:`#f39c12`,label:`⏸️ Trancados`},cancelado:{total:0,masc:0,fem:0,color:`#d35400`,label:`🛑 Cancelados`},excluido:{total:0,masc:0,fem:0,color:`#c0392b`,label:`🗑️ Excluídos`}},P={};n.forEach(e=>{e.turma&&k[e.turma]!==void 0&&k[e.turma]++,e.curso&&j[e.curso]!==void 0&&j[e.curso]++;let t=(e.status||`ativo`).toLowerCase().trim();t=t.includes(`exclu`)?`excluido`:t.includes(`cancel`)?`cancelado`:t.includes(`tranc`)?`trancado`:`ativo`,M[t]&&(M[t].total++,e.sexo===`Masculino`?M[t].masc++:e.sexo===`Feminino`&&M[t].fem++);let n=(e.pais||e.nacionalidade||`Brasil`).trim().toUpperCase();n===``&&(n=`BRASIL`),P[n]=(P[n]||0)+1});let F=`<div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap:15px; margin-bottom: 25px;">`;Object.keys(M).forEach(e=>{let t=M[e],n=t.total>0?(t.masc/t.total*100).toFixed(0):0,r=t.total>0?(t.fem/t.total*100).toFixed(0):0;F+=`
                <div style="background:#fff; border:1px solid #eee; border-top:4px solid ${t.color}; border-radius:8px; padding:15px; box-shadow:0 2px 5px rgba(0,0,0,0.02);">
                    <div style="font-size:12px; font-weight:bold; color:#7f8c8d; text-transform:uppercase; margin-bottom:10px;">${t.label}</div>
                    <div style="font-size:28px; font-weight:900; color:${t.color}; margin-bottom:15px; line-height:1;">${t.total}</div>
                    ...
                    <div style="display:flex; justify-content:space-between; align-items:center; background:#f9f9f9; padding:8px; border-radius:5px; margin-bottom:5px;">
                        ...
                        <div style="font-weight:bold; color:#3498db; font-size:14px;">${t.masc} <span style="font-size:10px; color:#999; font-weight:normal;">(${n}%)</span></div>
                    </div>
                    <div style="display:flex; justify-content:space-between; align-items:center; background:#f9f9f9; padding:8px; border-radius:5px;">
                        ...
                        <div style="font-weight:bold; color:#e74c3c; font-size:14px;">${t.fem} <span style="font-size:10px; color:#999; font-weight:normal;">(${r}%)</span></div>
                    </div>
                </div>
            `}),F+=`</div>`;let I=u.filter(n=>{if(n.status!==`Pendente`||n.tipo!==`Receita`||!n.vencimento)return!1;let r=new Date(n.vencimento+`T00:00:00`);return r.getFullYear()===parseInt(e)&&r.getMonth()+1===t}).reduce((e,t)=>e+(parseFloat(t.valor)||0),0),L=u.filter(e=>{if(e.status!==`Pendente`||e.tipo!==`Receita`||!e.vencimento)return!1;let t=new Date(e.vencimento+`T00:00:00`);return t.getFullYear()===a&&t.getMonth()+1===i}).reduce((e,t)=>e+(parseFloat(t.valor)||0),0);s.innerHTML=`
            ${N}
            <style>
            ...
            <div class="print-sheet">
                <div class="doc-header" style="display:flex; justify-content:space-between; align-items:center; border-bottom: 2px solid #2c3e50; padding-bottom: 15px; margin-bottom:20px; flex-wrap:wrap; gap:15px;">
                    <div style="display:flex; align-items:center; gap:20px;">
                        ${d.foto?`<img src="${d.foto}" style="height:50px; object-fit:contain;">`:``} <div><h2 style="margin:0; text-transform:uppercase; color:#2c3e50; font-size:18px;">${A.escapeHTML(d.nome)}</h2><div style="font-size:12px; color:#666;">CNPJ: ${A.escapeHTML(d.cnpj)}</div></div>
                    </div>
                    <div style="text-align:right;">
                        <div style="font-weight:bold; font-size:16px;">DOSSIÊ DE GESTÃO - ${r}/${e}</div>
                        <div style="font-size:11px; color:#666;">Emissão: ${f.toLocaleDateString(`pt-BR`)}</div>
                    </div>
                </div>
                ...
                <div style="display:flex; gap:10px; flex-wrap:wrap; margin-bottom:20px;">
                    <div class="d-kpi" style="border-bottom:3px solid #34495e;">
                        ...
                        <div class="d-kpi-val" style="color:#34495e;">${p(y)}</div>
                    </div>
                    <div class="d-kpi" style="border-bottom:3px solid #f39c12;">
                        <div class="d-kpi-tit">Esperado no Mês Vigente<br>(Mensalidades)</div>
                        <div class="d-kpi-val" style="color:#f39c12;">${p(b)}</div>
                    </div>
                    <div class="d-kpi" style="border-bottom:3px solid #27ae60;">
                        <div class="d-kpi-tit">Entrada Bruta Ano<br>(Mensalidades + Vendas)</div>
                        <div class="d-kpi-val" style="color:#27ae60;">${p(v)}</div>
                    </div>
                    <div class="d-kpi" style="border-bottom:3px solid #3498db;">
                        <div class="d-kpi-tit">Entrada Mês Vigente<br>(Mensalidades + Vendas)</div>
                        <div class="d-kpi-val" style="color:#3498db;">${p(w)}</div>
                    </div>
                    <div class="d-kpi" style="border-bottom:3px solid #e74c3c;">
                        <div class="d-kpi-tit">Total Inadimplência<br>(Histórico Geral)</div>
                        <div class="d-kpi-val" style="color:#e74c3c;">${p(x)}</div>
                    </div>
                </div>

                <div class="d-box">
                    <h3 style="margin-top:0; color:#2c3e50; border-bottom:1px solid #eee; padding-bottom:10px; font-size:15px;">📊 Resultados Financeiros: ${r} / ${e}</h3>
                    <div class="flex-container">
                        <div class="flex-item">
                            <table class="d-table">
                                <tr><td><strong>Entradas em Mensalidades:</strong></td><td style="text-align:right; font-size:16px; color:#2980b9; font-weight:bold; white-space:nowrap;">${p(S)}</td></tr>
                                <tr><td><strong>Entradas em Vendas:</strong></td><td style="text-align:right; font-size:16px; color:#8e44ad; font-weight:bold; white-space:nowrap;">${p(C)}</td></tr>
                                <tr style="background:#f9f9f9;"><td><strong>TOTAL ARRECADADO NO MÊS:</strong></td><td style="text-align:right; font-size:18px; color:#27ae60; font-weight:bold; white-space:nowrap;">${p(w)}</td></tr>
                            </table>
                        </div>
                ...
                <div class="d-box" style="background:#fdf2f2; border:2px solid #f5b7b1;">
                    ...
                    <div style="display:flex; justify-content:space-around; align-items:center; flex-wrap:wrap; gap:20px;">
                        <div style="text-align:center; flex:1; min-width:200px; padding:15px; background:white; border-radius:8px; border:1px dashed #f1948a;">
                            <div style="font-size:12px; color:#e74c3c; font-weight:bold; text-transform:uppercase; margin-bottom:5px;">Mês Anterior (${o}/${a})</div>
                            <div style="font-size:24px; font-weight:bold; color:#e74c3c; opacity: 0.8;">${p(L)}</div>
                        </div>
                        ...
                        <div style="text-align:center; flex:1; min-width:200px; padding:15px; background:#fff5f5; border-radius:8px; border:2px solid #e74c3c; box-shadow: 0 4px 10px rgba(231,76,60,0.15);">
                            <div style="font-size:14px; color:#c0392b; font-weight:bold; text-transform:uppercase; margin-bottom:5px;">Mês Vigente (${r}/${e})</div>
                            <div style="font-size:36px; font-weight:900; color:#c0392b;">${p(I)}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-box">
                    ...
                    <div class="table-responsive">
                        <table class="d-table" style="min-width:400px;">
                            ...
                            <tbody>${D}</tbody>
                            <tfoot><tr style="background:#e8f6f3; font-weight:bold; font-size:13px;"><td colspan="3" style="text-align:right;">TOTAL BRUTO (JAN ATÉ ${r.toUpperCase()}):</td><td style="text-align:right; color:#27ae60; white-space:nowrap;">${p(O)}</td></tr></tfoot>
                        </table>
                    </div>
                </div>
                ...
                <div class="d-box">
                    <div class="flex-container">
                        <div class="flex-item">
                            <h3 style="margin-top:0; color:#2c3e50; border-bottom:1px solid #eee; padding-bottom:10px; font-size:15px;">📚 Cursos (${l.length})</h3>
                            <div>${l.length?l.map(e=>`<div class="list-card"><span>${A.escapeHTML(e.nome)}</span><span class="badge-curso">${j[e.nome]||0} alunos</span></div>`).join(``):`<div style="color:#999; font-size:12px;">Nenhum curso.</div>`}</div>
                        </div>
                        <div class="flex-item">
                            <h3 style="margin-top:0; color:#2c3e50; border-bottom:1px solid #eee; padding-bottom:10px; font-size:15px;">🏫 Turmas (${c.length})</h3>
                            <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(140px, 1fr)); gap:10px;">${c.length?c.map(e=>`<div class="list-card" style="margin-bottom:0;"><span>${A.escapeHTML(e.nome)}</span><span class="badge-turma">${k[e.nome]||0} alunos</span></div>`).join(``):`<div style="color:#999; font-size:12px;">Nenhuma turma.</div>`}</div>
                        </div>
                    </div>
                </div>

            </div>`,setTimeout(()=>{let e={responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},cutout:`65%`},t=[`#3498db`,`#9b59b6`,`#f1c40f`,`#2ecc71`,`#e67e22`,`#95a5a6`];Object.keys(T).length>0&&document.getElementById(`grafMensalidade`)&&new Chart(document.getElementById(`grafMensalidade`),{type:`doughnut`,data:{labels:Object.keys(T),datasets:[{data:Object.values(T),backgroundColor:t,borderWidth:0}]},options:e}),Object.keys(E).length>0&&document.getElementById(`grafVenda`)&&new Chart(document.getElementById(`grafVenda`),{type:`doughnut`,data:{labels:Object.keys(E),datasets:[{data:Object.values(E),backgroundColor:t,borderWidth:0}]},options:e}),Object.keys(P).length>0&&document.getElementById(`grafPais`)&&new Chart(document.getElementById(`grafPais`),{type:`bar`,data:{labels:Object.keys(P),datasets:[{label:`Qtd. de Alunos`,data:Object.values(P),backgroundColor:[`#3498db`,`#2ecc71`,`#f1c40f`,`#e74c3c`,`#9b59b6`,`#34495e`],borderRadius:5}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{y:{beginAtZero:!0,ticks:{stepSize:1,precision:0}}}}})},300)}catch{A.showToast(`Erro ao gerar dossiê.`,`error`)}finally{document.body.style.cursor=`default`}},A.gerarFichaSetup=async()=>{A.setTitulo(`Ficha de Matrícula`);let e=document.getElementById(`app-content`);e.innerHTML=`<p style="text-align:center;">Carregando...</p>`;try{let t=`
            <div style="display:flex; gap:10px; align-items:flex-end; flex-wrap:wrap;">
