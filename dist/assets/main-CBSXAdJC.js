            ...
            <div class="print-sheet dossier-wrap">
                ...
                <div style="display:flex; justify-content:space-between; align-items:flex-end; border-bottom: 2px solid #0f172a; padding-bottom: 8px;">
                    <div style="display:flex; align-items:center; gap:10px;">
                        ...
                        <div>
                            <h2 style="margin:0; text-transform:uppercase; font-size:15px; font-weight:900;">${A.escapeHTML(l.nome)}</h2>
                    ...
                    <table class="fin-table">
                        ...
                        <tfoot>
                            <tr style="background:#f8fafc; border-top:2px solid #cbd5e1;">
                                ...
                                <td style="text-align:right; font-weight:900; font-size:12px; color:#16a34a; padding:8px;">${d(T)}</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
                        ...
                        <div style="display:flex; align-items:center; gap:15px;">
                            ...
                            <div style="flex:1;">
                                <table class="fin-table" style="font-size:8.5px;">
                                    <tr><td><span style="color:#16a34a; font-weight:bold;">● Ativos</span></td><td style="text-align:right; font-weight:bold;">${D.Ativo.total}</td></tr>
                                    <tr><td><span style="color:#d97706; font-weight:bold;">● Trancados</span></td><td style="text-align:right; font-weight:bold;">${D.Trancado.total}</td></tr>
                                    <tr><td><span style="color:#ea580c; font-weight:bold;">● Cancelados</span></td><td style="text-align:right; font-weight:bold;">${D.Cancelado.total}</td></tr>
                                    <tr><td><span style="color:#dc2626; font-weight:bold;">● Excluídos</span></td><td style="text-align:right; font-weight:bold;">${D.Excluído.total}</td></tr>
                                </table>
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid-2">
                    ...
                    <div class="box-card" style="display:flex; flex-direction:column;">
                        ...
                        <div style="display:flex; align-items:center; justify-content:space-around; flex:1;">
                            <div style="text-align:center;">
                                <div style="font-size:9px; font-weight:bold; color:#64748b; margin-bottom:5px;">NO MÊS (${r})</div>
                            ...
                            <div style="border-left:1px solid #e2e8f0; padding-left:15px; text-align:center;">
                                ...
                                <div style="font-size:18px; font-weight:900; color:#3b82f6;">${j.online} <span style="font-size:9px; color:#94a3b8; font-weight:bold;">ONLINE</span></div>
                                <div style="font-size:18px; font-weight:900; color:#8b5cf6;">${j.presencial} <span style="font-size:9px; color:#94a3b8; font-weight:bold;">PRESEN.</span></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-card">
                        ...
                        <div style="display:flex; flex-wrap:wrap; gap:5px;">
                            ${Object.keys(O).map(e=>`<div style="background:#f8fafc; border:1px solid #e2e8f0; padding:4px 8px; border-radius:4px; font-size:9px; color:#334155;"><b>${e}</b>: ${O[e]}</div>`).join(``)}
                        </div>
                    </div>
                </div>
                    ...
                    <div class="box-card">
                        ...
                        <div style="display:flex; gap:10px;">
                            <div style="flex:1; background:#f0fdf4; border:1px solid #bbf7d0; padding:15px; border-radius:6px; text-align:center;">
                                ...
                                <div style="font-size:24px; font-weight:900; color:#15803d; margin-top:5px;">${F}</div>
                            </div>
                            <div style="flex:1; background:#f8fafc; border:1px solid #e2e8f0; padding:15px; border-radius:6px; text-align:center;">
                                ...
                                <div style="font-size:24px; font-weight:900; color:#64748b; margin-top:5px;">${I}</div>
                            </div>
                        </div>
                    </div>
                </div>

            </div>`,setTimeout(()=>{let e={responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}}};document.getElementById(`chartStatus`)&&new Chart(document.getElementById(`chartStatus`),{type:`doughnut`,data:{labels:[`Ativos`,`Trancados`,`Cancelados`,`Excluídos`],datasets:[{data:[D.Ativo.total,D.Trancado.total,D.Cancelado.total,D.Excluído.total],backgroundColor:[`#16a34a`,`#d97706`,`#ea580c`,`#dc2626`],borderWidth:0}]},options:{...e,cutout:`65%`}}),document.getElementById(`chartGender`)&&new Chart(document.getElementById(`chartGender`),{type:`bar`,data:{labels:[`Ativos`,`Trancados`,`Cancel.`,`Excluídos`],datasets:[{label:`Masculino`,data:[D.Ativo.masc,D.Trancado.masc,D.Cancelado.masc,D.Excluído.masc],backgroundColor:`#3b82f6`,borderRadius:2},{label:`Feminino`,data:[D.Ativo.fem,D.Trancado.fem,D.Cancelado.fem,D.Excluído.fem],backgroundColor:`#ec4899`,borderRadius:2}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:`top`,labels:{boxWidth:8,font:{size:8}}}},scales:{x:{grid:{display:!1},ticks:{font:{size:8}}},y:{beginAtZero:!0,border:{display:!1},ticks:{stepSize:1,font:{size:8}}}}}}),document.getElementById(`chartCaptacaoMes`)&&(k.online>0||k.presencial>0)?new Chart(document.getElementById(`chartCaptacaoMes`),{type:`pie`,data:{labels:[`Online`,`Presencial`],datasets:[{data:[k.online,k.presencial],backgroundColor:[`#3b82f6`,`#8b5cf6`],borderWidth:1,borderColor:`#fff`}]},options:e}):document.getElementById(`chartCaptacaoMes`)&&(document.getElementById(`chartCaptacaoMes`).parentElement.innerHTML=`<div style="font-size:9px; color:#999; margin-top:20px;">Sem matrículas<br>neste mês.</div>`)},300)}catch(e){A.showToast(`Erro ao gerar dossiê corporativo.`,`error`),console.error(e)}finally{document.body.style.cursor=`default`}},A.gerarFichaSetup=async()=>{A.setTitulo(`Ficha de Matrícula`);let e=document.getElementById(`app-content`);e.innerHTML=`<p style="text-align:center;">Carregando...</p>`;try{let t=`
            <div style="display:flex; gap:10px; align-items:flex-end; flex-wrap:wrap;">
