...
<div style="font-size:10px; color:#999;">Emissão: ${i}</div>
        ...
        `,_=``,v=``,y=``;t===`contrato`?(_=`
            ...
            `,v=`
                <div style="text-align: right; margin-top: 60px; font-size:14px; font-family: Arial, sans-serif;">${f}</div>
            ...
            `,v=`
                <div style="text-align: right; font-size: 14px; margin-bottom: 80px; margin-top: 60px; font-family: Arial, sans-serif;">
                    ${f}
                </div>
