import{t as e}from"./pwa-updater-DsfEqi9Q.js";import"./config-DJ1KJpAl.js";var t=Object.defineProperty,n=(e,n)=>{let r={};for(var i in e)t(r,i,{get:e[i],enumerable:!0});return n||t(r,Symbol.toStringTag,{value:`Module`}),r};window.CONFIG=window.CONFIG||{},window.App=window.App||{},window.Admin=window.Admin||{};var r=window.CONFIG,i=window.App;r.API_URL,window.LISTA_FUNCIONALIDADES=[{id:`novo_aluno`,nome:`Novo Aluno`,icon:`👨‍🎓`,acao:`App.abrirModalCadastro('aluno')`,roles:[`Gestor`,`Secretaria`]},{id:`fin_carne`,nome:`Gerar Carnê`,icon:`💸`,acao:`App.renderizarTela('mensalidades')`,roles:[`Gestor`,`Secretaria`]},{id:`ped_chamada`,nome:`Fazer Chamada`,icon:`📋`,acao:`App.renderizarTela('chamada')`,roles:[`Gestor`,`Secretaria`,`Professor`]},{id:`ped_notas`,nome:`Lançar Nota`,icon:`📝`,acao:`App.renderizarTela('avaliacoes')`,roles:[`Gestor`,`Secretaria`,`Professor`]},{id:`ped_plan`,nome:`Planejamento`,icon:`📅`,acao:`App.renderizarTela('planejamento')`,roles:[`Gestor`,`Secretaria`,`Professor`]},{id:`ped_bol`,nome:`Boletins`,icon:`🖨️`,acao:`App.renderizarTela('boletins')`,roles:[`Gestor`,`Secretaria`,`Professor`]},{id:`fin_inad`,nome:`Inadimplência`,icon:`⚠️`,acao:`App.renderizarTela('inadimplencia')`,roles:[`Gestor`,`Secretaria`]},{id:`fin_rel`,nome:`Rel. Financeiro`,icon:`📊`,acao:`App.renderizarRelatorio('financeiro')`,roles:[`Gestor`,`Secretaria`]},{id:`doc_ficha`,nome:`Ficha Matrícula`,icon:`📄`,acao:`App.renderizarRelatorio('ficha')`,roles:[`Gestor`,`Secretaria`]},{id:`doc_dossie`,nome:`Dossiê Executivo`,icon:`📁`,acao:`App.renderizarRelatorio('dossie')`,roles:[`Gestor`]},{id:`doc_gerador`,nome:`Documentos`,icon:`📄`,acao:`App.renderizarRelatorio('documentos')`,roles:[`Gestor`,`Secretaria`]},{id:`gerir_workspace`,nome:`Workspace`,icon:`🎓`,acao:`App.renderizarWorkspaceAdmin()`,roles:[`Gestor`,`Secretaria`]}],Object.assign(i,{usuario:null,entidadeAtual:null,idEdicao:null,idEdicaoUsuario:null,listaCache:[],adicionarFilaOffline:(e,t,n,r)=>{let a=JSON.parse(localStorage.getItem(`escola_fila_offline`))||[];a.push({rota:e,metodo:t,payload:n,tipoAcao:r,timestamp:Date.now()}),localStorage.setItem(`escola_fila_offline`,JSON.stringify(a)),i.showToast(`📶 Salvo offline: ${r}. Sincronizará automaticamente.`,`info`)},processarFilaOffline:async()=>{let e=JSON.parse(localStorage.getItem(`escola_fila_offline`))||[];if(e.length===0)return;i.showToast(`🔄 A sincronizar ${e.length} dados pendentes com o servidor...`,`info`);let t=[];for(let n of e)try{let e=await i.api(n.rota,n.metodo,n.payload);e&&e.success?console.log(`✅ Sincronizado: ${n.tipoAcao}`):console.warn(`⚠️ Sincronizado com aviso: ${n.tipoAcao}`,e)}catch{t.push(n)}localStorage.setItem(`escola_fila_offline`,JSON.stringify(t)),t.length===0?i.showToast(`✨ Todas as ações offline foram sincronizadas!`,`success`):i.showToast(`⚠️ Ainda faltam sincronizar ${t.length} ações.`,`warning`)},sanitizeHTML:e=>e?typeof DOMPurify>`u`?(console.warn(`DOMPurify não carregado. Usando escapeHTML como fallback.`),i.escapeHTML(e)):DOMPurify.sanitize(e,{USE_PROFILES:{html:!0},ALLOWED_TAGS:[`p`,`br`,`strong`,`b`,`em`,`i`,`u`,`h1`,`h2`,`h3`,`h4`,`ul`,`ol`,`li`,`div`,`span`,`table`,`thead`,`tbody`,`tr`,`td`,`th`,`blockquote`],ALLOWED_ATTR:[`style`,`class`]}):``,motorTempoRealLigado:!1,calendarState:{month:new Date().getMonth(),year:new Date().getFullYear()},escapeHTML:e=>e==null?``:String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`),unescapeHTML:e=>e==null?``:String(e).replace(/&amp;/g,`&`).replace(/&lt;/g,`<`).replace(/&gt;/g,`>`).replace(/&quot;/g,`"`).replace(/&#039;/g,`'`),criarElemento:(e,t=[],n={},r=``)=>{let i=document.createElement(e);t.length>0&&i.classList.add(...t);for(let e in n)if(e.startsWith(`on`)&&typeof n[e]==`function`){let t=e.substring(2).toLowerCase();i.addEventListener(t,n[e])}else i.setAttribute(e,n[e]);return r!==``&&(i.textContent=r),i},getTenantKey:e=>`${e}_${i.usuario&&i.usuario.id?i.usuario.id:`convidado`}`,getPlanoAtual:()=>localStorage.getItem(i.getTenantKey(`escola_plano`))||`Teste`,getDeviceId:()=>{let e=localStorage.getItem(`ptt_device_id`);return e||(e=`dev_`+window.crypto.randomUUID(),localStorage.setItem(`ptt_device_id`,e)),e},aplicarPermissoesDeUsuario:()=>{if(!i.usuario)return;let e=i.usuario.tipo||`Gestor`;document.querySelectorAll(`.sidebar button, .sidebar .menu-item`).forEach(t=>{let n=t.getAttribute(`onclick`)||``,r=!0;e===`Professor`?(n.includes(`mensalidade`)||n.includes(`financeiro`)||n.includes(`inadimplencia`)||n.includes(`relatorio`)||n.includes(`configuracoes`)||n.includes(`aparencia`)||n.includes(`backup`)||n.includes(`plano`)||n.includes(`conta`))&&(r=!1):e===`Secretaria`&&(n.includes(`configuracoes`)||n.includes(`aparencia`)||n.includes(`backup`)||n.includes(`plano`)||n.includes(`dossie`)||n.includes(`conta`))&&(r=!1),t.style.display=r?``:`none`})},verificarBloqueioGeral:e=>{if(!e)return!1;let t=e.plano||`Teste`;if(t===`Bloqueado`)return!0;let n=new Date;if(t===`Teste`){let t=e.dataCriacao?new Date(e.dataCriacao):n;return Math.floor(Math.abs(n-t)/(1e3*60*60*24))>=7}if(e.dataExpiracao)return n>=new Date(e.dataExpiracao);{let r=e.dataCriacao?new Date(e.dataCriacao):n,i=Math.floor(Math.abs(n-r)/(1e3*60*60*24));if(t!==`Premium`&&i>=30)return!0}return!1},verificarLimites:async e=>{let t=i.getPlanoAtual();if(t===`Premium`||t===`Teste`)return!0;try{if(e===`aluno`){let e=await i.api(`/alunos`),n=t===`Essencial`?20:t===`Profissional`?80:0;if(e.length>=n)return i.showToast(`⚠️ Limite de ${n} alunos atingido no plano ${t}. Faça o upgrade para continuar a crescer!`,`warning`),setTimeout(()=>i.renderizarMeuPlano(),2e3),!1}else if(e===`usuario`){let e=await i.api(`/usuarios`),n=t===`Essencial`?2:t===`Profissional`?4:0;if(e.length>=n)return i.showToast(`⚠️ Limite de ${n} acessos atingido no plano ${t}. Faça o upgrade para adicionar mais equipe!`,`warning`),setTimeout(()=>i.renderizarMeuPlano(),2e3),!1}return!0}catch{return!1}},verificarPermissao:e=>{let t=i.getPlanoAtual();return t===`Premium`||t===`Teste`?!0:e===`whatsapp`&&t===`Essencial`?(i.showToast(`💎 Funcionalidade disponível a partir do Plano Profissional. Faça o upgrade!`,`warning`),setTimeout(()=>i.renderizarMeuPlano(),1500),!1):e===`dossie`&&t!==`Premium`?(i.showToast(`💎 Exclusivo do Plano Premium. Faça o upgrade para aceder ao Dossiê Executivo!`,`warning`),setTimeout(()=>i.renderizarMeuPlano(),1500),!1):!0},api:async(e,t=`GET`,n=null,r=!1)=>{let a={method:t,headers:{"Content-Type":`application/json`},credentials:`include`,cache:`no-store`};n&&(a.body=JSON.stringify(n));let o=e.replace(/^\/api/,``),s=o.startsWith(`/`)?o:`/${o}`,c=`/api${s}`;if((window.location.hostname===`localhost`||window.location.hostname===`127.0.0.1`)&&window.location.port!==`5173`&&(c=`http://localhost:3000${s}`),!navigator.onLine)if([`POST`,`PUT`,`DELETE`].includes(t.toUpperCase())){let r=`Ação de Sistema`;return e.includes(`chamada`)?r=`Registo de Presença`:e.includes(`avaliacoes`)||e.includes(`notas`)?r=`Lançamento de Notas`:e.includes(`alunos`)?r=`Registo de Aluno`:(e.includes(`mensalidades`)||e.includes(`financeiro`))&&(r=`Registo Financeiro`),typeof i.adicionarFilaOffline==`function`&&i.adicionarFilaOffline(e,t,n,r),{success:!0,offline:!0,message:`Salvo no telemóvel aguardando internet.`}}else return r||i.showToast(`Sem conexão para carregar dados novos.`,`warning`),{error:`Sem internet.`,offline:!0};try{let e=await fetch(c,a);if(!e.ok){let t=(await e.json().catch(()=>({}))).error||`Erro no servidor (${e.status})`;return!r&&document.visibilityState===`visible`&&i.showToast(t,`error`),{error:t}}let n=await e.json();return t!==`GET`&&i.usuario&&typeof i.verificarNotificacoes==`function`&&setTimeout(i.verificarNotificacoes,800),n}catch(e){if(console.error(`❌ Falha na API [${t} ${c}]:`,e.message),document.visibilityState===`hidden`||r)return t===`GET`?[]:{error:`Rejeitado silenciosamente em background`};let n=e.message===`Failed to fetch`||e.message.includes(`NetworkError`)?`Sem ligação ao servidor Backend (Porta 3000 desligada?)`:e.message;return i.showToast(n,`error`),t===`GET`?[]:{error:n}}},setTitulo:e=>{let t=document.getElementById(`titulo-pagina`);t&&(t.innerText=e)},toggleSub:e=>{document.querySelectorAll(`.submenu`).forEach(t=>{t.id!==e&&(t.style.display=`none`)});let t=document.getElementById(e);t&&(t.style.display=t.style.display===`block`?`none`:`block`)},fecharModal:()=>{document.getElementById(`modal-overlay`).style.display=`none`;let e=document.querySelector(`.btn-confirm`);e&&(e.style.display=`inline-flex`,e.setAttribute(`onclick`,`App.salvarCadastro()`),e.innerHTML=`💾 Salvar Registro`)},abrirTelaCadastroInst:()=>{document.getElementById(`modal-cadastro-inst`).style.display=`flex`,i.voltarEtapa1()},fecharModalInst:()=>{document.getElementById(`modal-cadastro-inst`).style.display=`none`},voltarEtapa1:()=>{document.getElementById(`etapa-1-email`).style.display=`block`,document.getElementById(`etapa-2-validacao`).style.display=`none`,document.getElementById(`etapa-3-sucesso`).style.display=`none`},enviarCodigoInst:async()=>{console.log(`🔥 Clique recebido no botão de Cadastro!`);let e=document.getElementById(`novo-inst-email`).value,t=document.querySelector(`#etapa-1-email button`);if(!e||!e.includes(`@`))return i.showToast(`Digite um e-mail válido.`,`error`);let n=t.innerText;t.innerText=`Enviando... ⏳`,t.disabled=!0;try{let t=await i.api(`/auth/enviar-codigo`,`POST`,{email:e});t&&t.success?(i.showToast(`Código enviado!`,`success`),document.getElementById(`etapa-1-email`).style.display=`none`,document.getElementById(`etapa-2-validacao`).style.display=`block`):i.showToast(`Erro ao enviar e-mail.`,`error`)}catch{i.showToast(`Erro de servidor.`,`error`)}finally{t.innerText=n,t.disabled=!1}},validarCadastroInst:async()=>{let e=document.getElementById(`novo-inst-email`).value,t=document.getElementById(`novo-inst-codigo`).value.trim(),n=document.getElementById(`novo-inst-pin`).value.trim(),r=document.querySelector(`#etapa-2-validacao button`);if(!t||!n)return i.showToast(`Preencha Código e PIN.`,`error`);let a=r.innerText;r.innerText=`A Validar... ⏳`,r.disabled=!0;try{let r=await i.api(`/auth/validar-cadastro`,`POST`,{email:e,codigo:t,pin:n});r&&r.success?(document.getElementById(`etapa-2-validacao`).style.display=`none`,document.getElementById(`etapa-3-sucesso`).style.display=`block`,typeof confetti==`function`&&confetti(),typeof gtag==`function`&&gtag(`event`,`generate_lead`,{currency:`BRL`,value:0,tipo_conta:`App Gestão PTT`})):i.showToast(r.error||`Dados incorretos.`,`error`)}catch{i.showToast(`Erro de servidor.`,`error`)}finally{r.innerText=a,r.disabled=!1}},renderizarTela:async(e,t=!1)=>{if(!i.usuario&&e!==`login`){i.showToast(`Sessão expirada. Faça login novamente.`,`error`),i.logout();return}document.querySelector(`.sidebar`)&&document.querySelector(`.sidebar`).classList.remove(`active`),document.querySelector(`.mobile-overlay`)&&document.querySelector(`.mobile-overlay`).classList.remove(`active`);let n=i.usuario?i.usuario.tipo:`Gestor`,r=[`mensalidades`,`financeiro`,`inadimplencia`,`configuracoes`,`aparencia`,`backup`,`plano`,`dossie`,`documentos`,`ficha`,`conta`],a=[`configuracoes`,`aparencia`,`backup`,`plano`,`dossie`,`conta`];if(n===`Professor`&&r.includes(e))return i.showToast(`🚫 Acesso restrito. Perfil de Professor não tem permissão para esta área.`,`error`),i.renderizarInicio();if(n===`Secretaria`&&a.includes(e))return i.showToast(`🚫 Acesso restrito. Perfil de Secretaria não tem permissão para esta área.`,`error`),i.renderizarInicio();!t&&e!==`login`&&e!==`inicio`?window.history.pushState({tela:e},``,`#${e}`):!t&&e===`inicio`&&window.history.pushState({tela:`inicio`},``,window.location.pathname),typeof gtag==`function`&&gtag(`event`,`page_view`,{page_title:`Tela: `+e,page_location:window.location.href+`#`+e,page_path:`/`+e}),e===`chamada`?(i.setTitulo(`Chamada`),i.renderizarChamadaPro()):e===`avaliacoes`||e===`notas`?(i.setTitulo(`Notas`),i.renderizarAvaliacoesPro()):e===`calendario`?(i.setTitulo(`Calendário`),i.renderizarCalendarioPro()):e===`planejamento`?(i.setTitulo(`Planejamento`),i.renderizarPlanejamentoPro()):e===`boletins`?(i.setTitulo(`Boletim`),i.renderizarBoletimVisual()):e===`mensalidades`||e===`financeiro`?(i.setTitulo(`Financeiro`),i.renderizarFinanceiroPro()):e===`inadimplencia`?(i.setTitulo(`Inadimplência`),i.renderizarInadimplencia()):e===`configuracoes`?(i.setTitulo(`Configurações`),i.renderizarConfiguracoes()):e===`aparencia`?i.renderizarConfiguracoesAparencia():e===`backup`?i.renderizarBackup():e===`plano`?i.renderizarMeuPlano():i.renderizarInicio()},renderizarConfig:e=>{e===`perfil`?i.renderizarTela(`configuracoes`):e===`aparencia`?i.renderizarTela(`aparencia`):e===`conta`?i.renderizarMinhaConta():e===`backup`&&i.renderizarTela(`backup`)},renderizarRelatorio:e=>{e===`dossie`&&!i.verificarPermissao(`dossie`)||typeof i.renderizarRelatorioModulo==`function`&&i.renderizarRelatorioModulo(e)},renderizarMeuPlano:()=>{i.setTitulo(`Gerenciar Assinatura`);let e=document.getElementById(`app-content`),t=i.getPlanoAtual(),n=0,r=JSON.parse(localStorage.getItem(i.getTenantKey(`escola_perfil`)))||{},a=new Date().getTime();if(t===`Teste`){let e=r.dataCriacao?new Date(r.dataCriacao).getTime():a,t=Math.abs(a-e);n=7-Math.floor(t/(1e3*60*60*24))}else if(r.dataExpiracao){let e=new Date(r.dataExpiracao).getTime()-a;n=Math.ceil(e/(1e3*60*60*24))}else if(r.dataCriacao){let e=Math.abs(a-new Date(r.dataCriacao).getTime());n=30-Math.floor(e/(1e3*60*60*24))}n<0&&(n=0);let o=t===`Premium`?`#f39c12`:t===`Profissional`?`#3498db`:`#27ae60`;e.innerHTML=`
        ...
        `},sairDaTelaDeBloqueio:()=>{D.logout()},ativarPinLogin:async e=>{e&&e.preventDefault();let t=document.getElementById(`input-pin-login`);if(!t)return;let n=t.value.trim().toUpperCase();if(!n)return D.showToast(`Por favor, insira o PIN recebido no e-mail.`,`warning`);let r=e.target,i=r.innerText;r&&(r.innerText=`A validar... ⏳`,r.disabled=!0);try{let e=await D.api(`/escola/validar-pin`,`POST`,{pin:n}),t=e&&e.success?e.plano:null;if(!t)if(n.includes(`PRE`))t=`Premium`;else if(n.includes(`ESS`))t=`Essencial`;else if(n.includes(`PRO`))t=`Profissional`;else{D.showToast(e.error||`PIN inválido ou formato incorreto.`,`error`),r&&(r.innerText=i,r.disabled=!1);return}let a=await D.api(`/escola`)||{},o=new Date;o.setDate(o.getDate()+30),await D.api(`/escola`,`PUT`,{...a,plano:t,pinUsado:n,dataExpiracao:o.toISOString()}),localStorage.setItem(D.getTenantKey(`escola_plano`),t);let s=JSON.parse(localStorage.getItem(D.getTenantKey(`escola_perfil`)))||{};s.plano=t,s.dataExpiracao=o.toISOString(),localStorage.setItem(D.getTenantKey(`escola_perfil`),JSON.stringify(s)),typeof D.atualizarUIHeader==`function`&&D.atualizarUIHeader(s),D.showToast(`🎉 PIN validado! Sistema desbloqueado por mais 30 dias.`,`success`);let c=document.getElementById(`box-bloqueio-conta`);c&&(c.style.display=`none`),D.entrarNoSistema()}catch{D.showToast(`Erro ao comunicar com a base de dados.`,`error`)}finally{r&&(r.innerText=i,r.disabled=!1)}},init:async()=>{localStorage.removeItem(`escola_tema`),localStorage.removeItem(`escola_atalhos`),localStorage.removeItem(`escola_perfil`);let e=new URLSearchParams(window.location.search).get(`reset`);if(e){document.documentElement.removeAttribute(`style`),document.getElementById(`tela-login`).style.display=`flex`,document.getElementById(`tela-sistema`).style.display=`none`,setTimeout(()=>{D.abrirModalNovaSenha(e)},300);return}let t=localStorage.getItem(`usuario_logado`);if(localStorage.getItem(`escola_bio_id`)&&window.PublicKeyCredential){document.getElementById(`tela-login`).style.display=`none`,document.getElementById(`tela-sistema`).style.display=`none`,D.exibirTelaTouchBiometria(),setTimeout(()=>{D.entrarComBiometria(!0)},500);return}if(t){D.usuario=JSON.parse(t),typeof D.aplicarTemaSalvo==`function`&&D.aplicarTemaSalvo();let e=D.getTenantKey(`escola_atalhos`);localStorage.getItem(e)||localStorage.setItem(e,JSON.stringify([`novo_aluno`,`fin_carne`,`ped_chamada`,`ped_notas`,`ped_plan`,`ped_bol`])),document.getElementById(`tela-login`)?.style.setProperty(`display`,`none`),document.getElementById(`tela-sistema`)?.style.setProperty(`display`,`flex`);let n=document.getElementById(`user-name`);n&&D.usuario&&(n.innerText=D.usuario.nome||D.usuario.login),typeof D.aplicarPermissoesDeUsuario==`function`&&D.aplicarPermissoesDeUsuario(),typeof D.setupMobileMenu==`function`&&D.setupMobileMenu();let r=window.location.hash.replace(`#`,``);r&&r!==`login`?setTimeout(()=>{typeof D.renderizarTela==`function`&&D.renderizarTela(r,!0)},10):typeof D.renderizarInicio==`function`&&D.renderizarInicio(),setTimeout(async()=>{let e=await D.api(`/escola`,`GET`,null,!0);if(!e||e.error){if(e?.error===`Sessão não encontrada.`||e?.error===`Sessão expirada.`){D.showToast(`Sessão expirada por segurança. Faça login novamente.`,`warning`),await D.logout();return}}else localStorage.setItem(D.getTenantKey(`escola_plano`),e.plano),localStorage.setItem(D.getTenantKey(`escola_perfil`),JSON.stringify(e)),typeof D.atualizarUIHeader==`function`&&D.atualizarUIHeader(e),typeof D.verificarBloqueioGeral==`function`&&D.verificarBloqueioGeral(e)&&(document.documentElement.removeAttribute(`style`),D.mostrarTelaBloqueioLogin(e))},1e3)}else document.documentElement.removeAttribute(`style`),document.getElementById(`tela-login`).style.display=`flex`,document.getElementById(`tela-sistema`).style.display=`none`;let n=document.getElementById(`data-hoje`);n&&(n.innerText=new Date().toLocaleDateString(`pt-BR`));let r=document.getElementById(`login-pass`);if(r&&r.addEventListener(`keypress`,function(e){e.key===`Enter`&&D.fazerLogin()}),!D.motorTempoRealLigado){let e=()=>{let e=document.getElementById(`tela-sistema`);D.usuario&&e&&e.style.display!==`none`&&document.visibilityState===`visible`&&(typeof D.verificarNovidadesSilenciosamente==`function`&&D.verificarNovidadesSilenciosamente(),typeof D.carregarDadosEscola==`function`&&D.carregarDadosEscola(!0))};setTimeout(e,2e3),setInterval(e,1e4),D.motorTempoRealLigado=!0}},fazerLogin:async()=>{let e=document.getElementById(`login-user`).value.trim(),t=document.getElementById(`login-pass`).value.trim();if(!e||!t)return D.showToast(`Preencha utilizador e senha`,`warning`);let n=document.querySelector(`#tela-login button[type="submit"]`),r=n.innerText;n.innerText=`Acessando... ⏳`,n.disabled=!0;try{let n=D.getDeviceId?D.getDeviceId():`dev_web`,r=await D.api(`/auth/login`,`POST`,{login:e,senha:t,deviceId:n});if(r&&r.success){D.usuario=r.usuario,localStorage.setItem(`usuario_logado`,JSON.stringify(r.usuario)),typeof gtag==`function`&&gtag(`event`,`login`,{method:`Sistema PTT`}),typeof D.aplicarTemaSalvo==`function`&&D.aplicarTemaSalvo();let e=D.getTenantKey(`escola_atalhos`);localStorage.getItem(e)||localStorage.setItem(e,JSON.stringify([`novo_aluno`,`fin_carne`,`ped_chamada`,`ped_notas`,`ped_plan`,`ped_bol`]));let t=await D.api(`/escola`);if(!t||t.error){if(t?.error===`Sessão não encontrada.`||t?.error===`Sessão expirada.`){await D.logout();return}t=JSON.parse(localStorage.getItem(D.getTenantKey(`escola_perfil`)))||{}}typeof D.verificarBloqueioGeral==`function`&&D.verificarBloqueioGeral(t)?D.mostrarTelaBloqueioLogin(t):(Notification.permission===`granted`&&D.configurarNotificacoesPush(),D.showToast(`Bem-vindo ao sistema!`,`success`),D.entrarNoSistema())}else D.showToast(r.error||`Login ou senha incorretos`,`error`)}catch{D.showToast(`Erro ao conectar no servidor`,`error`)}finally{n.innerText=r,n.disabled=!1}},entrarNoSistema:async()=>{document.getElementById(`tela-login`)?.style.setProperty(`display`,`none`),document.getElementById(`tela-sistema`)?.style.setProperty(`display`,`flex`);let e=document.getElementById(`user-name`);e&&D.usuario&&(e.innerText=D.usuario.nome||D.usuario.login),typeof D.aplicarPermissoesDeUsuario==`function`&&D.aplicarPermissoesDeUsuario(),typeof D.setupMobileMenu==`function`&&D.setupMobileMenu(),typeof D.carregarDadosEscola==`function`&&await D.carregarDadosEscola(!0);let t=document.getElementById(`tela-sistema`);if(t&&t.style.display!==`none`){let e=window.location.hash.replace(`#`,``);e&&e!==`login`?setTimeout(()=>{typeof D.renderizarTela==`function`&&D.renderizarTela(e,!0)},100):typeof D.renderizarInicio==`function`&&D.renderizarInicio()}},logout:async()=>{D.radarAtivo&&clearInterval(D.radarAtivo);try{typeof D.api==`function`?await D.api(`/auth/logout`,`POST`):await fetch(`/api/auth/logout`,{method:`POST`,credentials:`include`})}catch{console.warn(`Logout silencioso.`)}localStorage.clear(),sessionStorage.clear(),D.usuario=null,D.listaCache=[],window.location.href=window.location.pathname},toggleSenhaLogin:()=>{let e=document.getElementById(`login-pass`);e&&(e.type=e.type===`password`?`text`:`password`)},abrirModalRecuperacao:e=>{e&&e.preventDefault();let t=document.getElementById(`modal-recuperacao-senha`);t||(t=document.createElement(`div`),t.id=`modal-recuperacao-senha`,t.style.cssText=`position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.8); display:flex; justify-content:center; align-items:center; z-index:9999;`,t.innerHTML=`
            ...
            `,document.body.appendChild(e)),e.style.display=`flex`,e.onclick=e=>{e.target.tagName!==`BUTTON`&&D.entrarComBiometria()}},cancelarTouchBiometria:e=>{e&&e.stopPropagation();let t=document.getElementById(`bio-touch-screen`);t&&(t.style.display=`none`),document.documentElement.removeAttribute(`style`),document.getElementById(`tela-login`).style.display=`flex`,document.getElementById(`tela-sistema`).style.display=`none`},entrarComBiometria:async(e=!1)=>{let t=localStorage.getItem(`escola_bio_id`);if(t)try{e||D.exibirOverlayBiometria(`Autenticação`,`A aguardar a leitura do sensor...`);let n=await D.api(`/auth/biometria/gerar-login`,`POST`,{login:t});if(n.error)throw Error(n.error);let r=await E(n),i=await D.api(`/auth/biometria/verificar-login`,`POST`,{login:t,respostaBio:r});if(i&&i.success){D.removerOverlayBiometria();let e=document.getElementById(`bio-touch-screen`);e&&(e.style.display=`none`),D.usuario=i.usuario,localStorage.setItem(`usuario_logado`,JSON.stringify(i.usuario)),D.showToast(`🔓 Bem-vindo de volta!`,`success`),D.entrarNoSistema()}else throw Error(`Credenciais recusadas pelo servidor.`)}catch(t){D.removerOverlayBiometria(),console.error(t),e||(t.name===`NotAllowedError`?D.showToast(`Toque na tela ou no sensor para entrar com Biometria.`,`info`):D.showToast(`A leitura falhou. Por favor, use a sua senha.`,`error`))}},exibirOverlayBiometria:(e,t)=>{let n=document.getElementById(`bio-overlay-premium`);n||(n=document.createElement(`div`),n.id=`bio-overlay-premium`,n.style.cssText=`position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.85); backdrop-filter:blur(8px); display:flex; justify-content:center; align-items:center; z-index:100000;`,document.body.appendChild(n)),n.innerHTML=`
