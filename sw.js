...
const ASSETS_TO_CACHE = [
  '/',
    '/index.html',
    '/css/site.css',
    '/js/config.js?v=1777679959',
    '/js/app.js?v=1777679959',
    '/js/modulos/cadastros.js?v=1777679959',
    '/js/modulos/financeiro.js?v=1777679959',
    '/js/modulos/pedagogico.js?v=1777679959',
    '/js/modulos/relatorios.js?v=1777679959'
];
