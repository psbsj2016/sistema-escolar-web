...
const ASSETS_TO_CACHE = [
  '/',
    '/index.html',
    '/css/site.css',
    '/js/config.js?v=1777838212',
    '/js/app.js?v=1777838212',
    '/js/modulos/cadastros.js?v=1777838212',
    '/js/modulos/financeiro.js?v=1777838212',
    '/js/modulos/pedagogico.js?v=1777838212',
    '/js/modulos/relatorios.js?v=1777838212'
];
