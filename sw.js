...
const ASSETS_TO_CACHE = [
  '/',
    '/index.html',
    '/css/site.css',
    '/js/config.js?v=1777763736',
    '/js/app.js?v=1777763736',
    '/js/modulos/cadastros.js?v=1777763736',
    '/js/modulos/financeiro.js?v=1777763736',
    '/js/modulos/pedagogico.js?v=1777763736',
    '/js/modulos/relatorios.js?v=1777763736'
];
