...
const ASSETS_TO_CACHE = [
  '/',
    '/index.html',
    '/css/site.css',
    '/js/config.js?v=1777929128',
    '/js/app.js?v=1777929128',
    '/js/modulos/cadastros.js?v=1777929128',
    '/js/modulos/financeiro.js?v=1777929128',
    '/js/modulos/pedagogico.js?v=1777929128',
    '/js/modulos/relatorios.js?v=1777929128'
];
